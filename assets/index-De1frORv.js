import{a as Hm,r as y,b as Gm,j as n,c as Ha}from"./charts-nivo-DYQ47lf6.js";import{C as Dc,a as qm,L as Ym,P as Vm,b as Mm,B as Km,p as Jm,c as Xm,d as Zm,i as Qm,A as ex,e as tx,f as nx,D as Ga}from"./charts-others-D3x3PcxJ.js";import{C as Bc,b as zc,a as Wc,D as Hc,c as Gc,P as qc,R as Yc,T as Vc,d as Mc,L as Kc}from"./utils-D7KHK4u5.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))o(c);new MutationObserver(c=>{for(const d of c)if(d.type==="childList")for(const u of d.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&o(u)}).observe(document,{childList:!0,subtree:!0});function r(c){const d={};return c.integrity&&(d.integrity=c.integrity),c.referrerPolicy&&(d.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?d.credentials="include":c.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function o(c){if(c.ep)return;c.ep=!0;const d=r(c);fetch(c.href,d)}})();var qa={},gc;function rx(){if(gc)return qa;gc=1;var s=Hm();return qa.createRoot=s.createRoot,qa.hydrateRoot=s.hydrateRoot,qa}var ax=rx();function Jc(s,i){return function(){return s.apply(i,arguments)}}const{toString:ix}=Object.prototype,{getPrototypeOf:Is}=Object,ti=(s=>i=>{const r=ix.call(i);return s[r]||(s[r]=r.slice(8,-1).toLowerCase())})(Object.create(null)),hn=s=>(s=s.toLowerCase(),i=>ti(i)===s),ni=s=>i=>typeof i===s,{isArray:Er}=Array,Jr=ni("undefined");function sx(s){return s!==null&&!Jr(s)&&s.constructor!==null&&!Jr(s.constructor)&&Gt(s.constructor.isBuffer)&&s.constructor.isBuffer(s)}const Xc=hn("ArrayBuffer");function ox(s){let i;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?i=ArrayBuffer.isView(s):i=s&&s.buffer&&Xc(s.buffer),i}const lx=ni("string"),Gt=ni("function"),Zc=ni("number"),ri=s=>s!==null&&typeof s=="object",cx=s=>s===!0||s===!1,Ya=s=>{if(ti(s)!=="object")return!1;const i=Is(s);return(i===null||i===Object.prototype||Object.getPrototypeOf(i)===null)&&!(Symbol.toStringTag in s)&&!(Symbol.iterator in s)},dx=hn("Date"),ux=hn("File"),fx=hn("Blob"),px=hn("FileList"),hx=s=>ri(s)&&Gt(s.pipe),gx=s=>{let i;return s&&(typeof FormData=="function"&&s instanceof FormData||Gt(s.append)&&((i=ti(s))==="formdata"||i==="object"&&Gt(s.toString)&&s.toString()==="[object FormData]"))},mx=hn("URLSearchParams"),[xx,bx,vx,yx]=["ReadableStream","Request","Response","Headers"].map(hn),wx=s=>s.trim?s.trim():s.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function Qr(s,i,{allOwnKeys:r=!1}={}){if(s===null||typeof s>"u")return;let o,c;if(typeof s!="object"&&(s=[s]),Er(s))for(o=0,c=s.length;o<c;o++)i.call(null,s[o],o,s);else{const d=r?Object.getOwnPropertyNames(s):Object.keys(s),u=d.length;let m;for(o=0;o<u;o++)m=d[o],i.call(null,s[m],m,s)}}function Qc(s,i){i=i.toLowerCase();const r=Object.keys(s);let o=r.length,c;for(;o-- >0;)if(c=r[o],i===c.toLowerCase())return c;return null}const or=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,ed=s=>!Jr(s)&&s!==or;function As(){const{caseless:s}=ed(this)&&this||{},i={},r=(o,c)=>{const d=s&&Qc(i,c)||c;Ya(i[d])&&Ya(o)?i[d]=As(i[d],o):Ya(o)?i[d]=As({},o):Er(o)?i[d]=o.slice():i[d]=o};for(let o=0,c=arguments.length;o<c;o++)arguments[o]&&Qr(arguments[o],r);return i}const jx=(s,i,r,{allOwnKeys:o}={})=>(Qr(i,(c,d)=>{r&&Gt(c)?s[d]=Jc(c,r):s[d]=c},{allOwnKeys:o}),s),Sx=s=>(s.charCodeAt(0)===65279&&(s=s.slice(1)),s),Nx=(s,i,r,o)=>{s.prototype=Object.create(i.prototype,o),s.prototype.constructor=s,Object.defineProperty(s,"super",{value:i.prototype}),r&&Object.assign(s.prototype,r)},_x=(s,i,r,o)=>{let c,d,u;const m={};if(i=i||{},s==null)return i;do{for(c=Object.getOwnPropertyNames(s),d=c.length;d-- >0;)u=c[d],(!o||o(u,s,i))&&!m[u]&&(i[u]=s[u],m[u]=!0);s=r!==!1&&Is(s)}while(s&&(!r||r(s,i))&&s!==Object.prototype);return i},Cx=(s,i,r)=>{s=String(s),(r===void 0||r>s.length)&&(r=s.length),r-=i.length;const o=s.indexOf(i,r);return o!==-1&&o===r},Ax=s=>{if(!s)return null;if(Er(s))return s;let i=s.length;if(!Zc(i))return null;const r=new Array(i);for(;i-- >0;)r[i]=s[i];return r},Ex=(s=>i=>s&&i instanceof s)(typeof Uint8Array<"u"&&Is(Uint8Array)),Tx=(s,i)=>{const o=(s&&s[Symbol.iterator]).call(s);let c;for(;(c=o.next())&&!c.done;){const d=c.value;i.call(s,d[0],d[1])}},Rx=(s,i)=>{let r;const o=[];for(;(r=s.exec(i))!==null;)o.push(r);return o},kx=hn("HTMLFormElement"),$x=s=>s.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(r,o,c){return o.toUpperCase()+c}),mc=(({hasOwnProperty:s})=>(i,r)=>s.call(i,r))(Object.prototype),Px=hn("RegExp"),td=(s,i)=>{const r=Object.getOwnPropertyDescriptors(s),o={};Qr(r,(c,d)=>{let u;(u=i(c,d,s))!==!1&&(o[d]=u||c)}),Object.defineProperties(s,o)},Ox=s=>{td(s,(i,r)=>{if(Gt(s)&&["arguments","caller","callee"].indexOf(r)!==-1)return!1;const o=s[r];if(Gt(o)){if(i.enumerable=!1,"writable"in i){i.writable=!1;return}i.set||(i.set=()=>{throw Error("Can not rewrite read-only method '"+r+"'")})}})},Fx=(s,i)=>{const r={},o=c=>{c.forEach(d=>{r[d]=!0})};return Er(s)?o(s):o(String(s).split(i)),r},Ix=()=>{},Lx=(s,i)=>s!=null&&Number.isFinite(s=+s)?s:i,ws="abcdefghijklmnopqrstuvwxyz",xc="0123456789",nd={DIGIT:xc,ALPHA:ws,ALPHA_DIGIT:ws+ws.toUpperCase()+xc},Ux=(s=16,i=nd.ALPHA_DIGIT)=>{let r="";const{length:o}=i;for(;s--;)r+=i[Math.random()*o|0];return r};function Dx(s){return!!(s&&Gt(s.append)&&s[Symbol.toStringTag]==="FormData"&&s[Symbol.iterator])}const Bx=s=>{const i=new Array(10),r=(o,c)=>{if(ri(o)){if(i.indexOf(o)>=0)return;if(!("toJSON"in o)){i[c]=o;const d=Er(o)?[]:{};return Qr(o,(u,m)=>{const g=r(u,c+1);!Jr(g)&&(d[m]=g)}),i[c]=void 0,d}}return o};return r(s,0)},zx=hn("AsyncFunction"),Wx=s=>s&&(ri(s)||Gt(s))&&Gt(s.then)&&Gt(s.catch),rd=((s,i)=>s?setImmediate:i?((r,o)=>(or.addEventListener("message",({source:c,data:d})=>{c===or&&d===r&&o.length&&o.shift()()},!1),c=>{o.push(c),or.postMessage(r,"*")}))(`axios@${Math.random()}`,[]):r=>setTimeout(r))(typeof setImmediate=="function",Gt(or.postMessage)),Hx=typeof queueMicrotask<"u"?queueMicrotask.bind(or):typeof process<"u"&&process.nextTick||rd,F={isArray:Er,isArrayBuffer:Xc,isBuffer:sx,isFormData:gx,isArrayBufferView:ox,isString:lx,isNumber:Zc,isBoolean:cx,isObject:ri,isPlainObject:Ya,isReadableStream:xx,isRequest:bx,isResponse:vx,isHeaders:yx,isUndefined:Jr,isDate:dx,isFile:ux,isBlob:fx,isRegExp:Px,isFunction:Gt,isStream:hx,isURLSearchParams:mx,isTypedArray:Ex,isFileList:px,forEach:Qr,merge:As,extend:jx,trim:wx,stripBOM:Sx,inherits:Nx,toFlatObject:_x,kindOf:ti,kindOfTest:hn,endsWith:Cx,toArray:Ax,forEachEntry:Tx,matchAll:Rx,isHTMLForm:kx,hasOwnProperty:mc,hasOwnProp:mc,reduceDescriptors:td,freezeMethods:Ox,toObjectSet:Fx,toCamelCase:$x,noop:Ix,toFiniteNumber:Lx,findKey:Qc,global:or,isContextDefined:ed,ALPHABET:nd,generateString:Ux,isSpecCompliantForm:Dx,toJSONObject:Bx,isAsyncFn:zx,isThenable:Wx,setImmediate:rd,asap:Hx};function Ee(s,i,r,o,c){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack,this.message=s,this.name="AxiosError",i&&(this.code=i),r&&(this.config=r),o&&(this.request=o),c&&(this.response=c,this.status=c.status?c.status:null)}F.inherits(Ee,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:F.toJSONObject(this.config),code:this.code,status:this.status}}});const ad=Ee.prototype,id={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(s=>{id[s]={value:s}});Object.defineProperties(Ee,id);Object.defineProperty(ad,"isAxiosError",{value:!0});Ee.from=(s,i,r,o,c,d)=>{const u=Object.create(ad);return F.toFlatObject(s,u,function(g){return g!==Error.prototype},m=>m!=="isAxiosError"),Ee.call(u,s.message,i,r,o,c),u.cause=s,u.name=s.name,d&&Object.assign(u,d),u};const Gx=null;function Es(s){return F.isPlainObject(s)||F.isArray(s)}function sd(s){return F.endsWith(s,"[]")?s.slice(0,-2):s}function bc(s,i,r){return s?s.concat(i).map(function(c,d){return c=sd(c),!r&&d?"["+c+"]":c}).join(r?".":""):i}function qx(s){return F.isArray(s)&&!s.some(Es)}const Yx=F.toFlatObject(F,{},null,function(i){return/^is[A-Z]/.test(i)});function ai(s,i,r){if(!F.isObject(s))throw new TypeError("target must be an object");i=i||new FormData,r=F.toFlatObject(r,{metaTokens:!0,dots:!1,indexes:!1},!1,function(k,A){return!F.isUndefined(A[k])});const o=r.metaTokens,c=r.visitor||v,d=r.dots,u=r.indexes,g=(r.Blob||typeof Blob<"u"&&Blob)&&F.isSpecCompliantForm(i);if(!F.isFunction(c))throw new TypeError("visitor must be a function");function j(T){if(T===null)return"";if(F.isDate(T))return T.toISOString();if(!g&&F.isBlob(T))throw new Ee("Blob is not supported. Use a Buffer instead.");return F.isArrayBuffer(T)||F.isTypedArray(T)?g&&typeof Blob=="function"?new Blob([T]):Buffer.from(T):T}function v(T,k,A){let q=T;if(T&&!A&&typeof T=="object"){if(F.endsWith(k,"{}"))k=o?k:k.slice(0,-2),T=JSON.stringify(T);else if(F.isArray(T)&&qx(T)||(F.isFileList(T)||F.endsWith(k,"[]"))&&(q=F.toArray(T)))return k=sd(k),q.forEach(function(R,M){!(F.isUndefined(R)||R===null)&&i.append(u===!0?bc([k],M,d):u===null?k:k+"[]",j(R))}),!1}return Es(T)?!0:(i.append(bc(A,k,d),j(T)),!1)}const w=[],I=Object.assign(Yx,{defaultVisitor:v,convertValue:j,isVisitable:Es});function K(T,k){if(!F.isUndefined(T)){if(w.indexOf(T)!==-1)throw Error("Circular reference detected in "+k.join("."));w.push(T),F.forEach(T,function(q,V){(!(F.isUndefined(q)||q===null)&&c.call(i,q,F.isString(V)?V.trim():V,k,I))===!0&&K(q,k?k.concat(V):[V])}),w.pop()}}if(!F.isObject(s))throw new TypeError("data must be an object");return K(s),i}function vc(s){const i={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(s).replace(/[!'()~]|%20|%00/g,function(o){return i[o]})}function Ls(s,i){this._pairs=[],s&&ai(s,this,i)}const od=Ls.prototype;od.append=function(i,r){this._pairs.push([i,r])};od.toString=function(i){const r=i?function(o){return i.call(this,o,vc)}:vc;return this._pairs.map(function(c){return r(c[0])+"="+r(c[1])},"").join("&")};function Vx(s){return encodeURIComponent(s).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function ld(s,i,r){if(!i)return s;const o=r&&r.encode||Vx;F.isFunction(r)&&(r={serialize:r});const c=r&&r.serialize;let d;if(c?d=c(i,r):d=F.isURLSearchParams(i)?i.toString():new Ls(i,r).toString(o),d){const u=s.indexOf("#");u!==-1&&(s=s.slice(0,u)),s+=(s.indexOf("?")===-1?"?":"&")+d}return s}class yc{constructor(){this.handlers=[]}use(i,r,o){return this.handlers.push({fulfilled:i,rejected:r,synchronous:o?o.synchronous:!1,runWhen:o?o.runWhen:null}),this.handlers.length-1}eject(i){this.handlers[i]&&(this.handlers[i]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(i){F.forEach(this.handlers,function(o){o!==null&&i(o)})}}const cd={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},Mx=typeof URLSearchParams<"u"?URLSearchParams:Ls,Kx=typeof FormData<"u"?FormData:null,Jx=typeof Blob<"u"?Blob:null,Xx={isBrowser:!0,classes:{URLSearchParams:Mx,FormData:Kx,Blob:Jx},protocols:["http","https","file","blob","url","data"]},Us=typeof window<"u"&&typeof document<"u",Ts=typeof navigator=="object"&&navigator||void 0,Zx=Us&&(!Ts||["ReactNative","NativeScript","NS"].indexOf(Ts.product)<0),Qx=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",eb=Us&&window.location.href||"http://localhost",tb=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:Us,hasStandardBrowserEnv:Zx,hasStandardBrowserWebWorkerEnv:Qx,navigator:Ts,origin:eb},Symbol.toStringTag,{value:"Module"})),jt={...tb,...Xx};function nb(s,i){return ai(s,new jt.classes.URLSearchParams,Object.assign({visitor:function(r,o,c,d){return jt.isNode&&F.isBuffer(r)?(this.append(o,r.toString("base64")),!1):d.defaultVisitor.apply(this,arguments)}},i))}function rb(s){return F.matchAll(/\w+|\[(\w*)]/g,s).map(i=>i[0]==="[]"?"":i[1]||i[0])}function ab(s){const i={},r=Object.keys(s);let o;const c=r.length;let d;for(o=0;o<c;o++)d=r[o],i[d]=s[d];return i}function dd(s){function i(r,o,c,d){let u=r[d++];if(u==="__proto__")return!0;const m=Number.isFinite(+u),g=d>=r.length;return u=!u&&F.isArray(c)?c.length:u,g?(F.hasOwnProp(c,u)?c[u]=[c[u],o]:c[u]=o,!m):((!c[u]||!F.isObject(c[u]))&&(c[u]=[]),i(r,o,c[u],d)&&F.isArray(c[u])&&(c[u]=ab(c[u])),!m)}if(F.isFormData(s)&&F.isFunction(s.entries)){const r={};return F.forEachEntry(s,(o,c)=>{i(rb(o),c,r,0)}),r}return null}function ib(s,i,r){if(F.isString(s))try{return(i||JSON.parse)(s),F.trim(s)}catch(o){if(o.name!=="SyntaxError")throw o}return(0,JSON.stringify)(s)}const ea={transitional:cd,adapter:["xhr","http","fetch"],transformRequest:[function(i,r){const o=r.getContentType()||"",c=o.indexOf("application/json")>-1,d=F.isObject(i);if(d&&F.isHTMLForm(i)&&(i=new FormData(i)),F.isFormData(i))return c?JSON.stringify(dd(i)):i;if(F.isArrayBuffer(i)||F.isBuffer(i)||F.isStream(i)||F.isFile(i)||F.isBlob(i)||F.isReadableStream(i))return i;if(F.isArrayBufferView(i))return i.buffer;if(F.isURLSearchParams(i))return r.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),i.toString();let m;if(d){if(o.indexOf("application/x-www-form-urlencoded")>-1)return nb(i,this.formSerializer).toString();if((m=F.isFileList(i))||o.indexOf("multipart/form-data")>-1){const g=this.env&&this.env.FormData;return ai(m?{"files[]":i}:i,g&&new g,this.formSerializer)}}return d||c?(r.setContentType("application/json",!1),ib(i)):i}],transformResponse:[function(i){const r=this.transitional||ea.transitional,o=r&&r.forcedJSONParsing,c=this.responseType==="json";if(F.isResponse(i)||F.isReadableStream(i))return i;if(i&&F.isString(i)&&(o&&!this.responseType||c)){const u=!(r&&r.silentJSONParsing)&&c;try{return JSON.parse(i)}catch(m){if(u)throw m.name==="SyntaxError"?Ee.from(m,Ee.ERR_BAD_RESPONSE,this,null,this.response):m}}return i}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:jt.classes.FormData,Blob:jt.classes.Blob},validateStatus:function(i){return i>=200&&i<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};F.forEach(["delete","get","head","post","put","patch"],s=>{ea.headers[s]={}});const sb=F.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),ob=s=>{const i={};let r,o,c;return s&&s.split(`
`).forEach(function(u){c=u.indexOf(":"),r=u.substring(0,c).trim().toLowerCase(),o=u.substring(c+1).trim(),!(!r||i[r]&&sb[r])&&(r==="set-cookie"?i[r]?i[r].push(o):i[r]=[o]:i[r]=i[r]?i[r]+", "+o:o)}),i},wc=Symbol("internals");function Vr(s){return s&&String(s).trim().toLowerCase()}function Va(s){return s===!1||s==null?s:F.isArray(s)?s.map(Va):String(s)}function lb(s){const i=Object.create(null),r=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let o;for(;o=r.exec(s);)i[o[1]]=o[2];return i}const cb=s=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(s.trim());function js(s,i,r,o,c){if(F.isFunction(o))return o.call(this,i,r);if(c&&(i=r),!!F.isString(i)){if(F.isString(o))return i.indexOf(o)!==-1;if(F.isRegExp(o))return o.test(i)}}function db(s){return s.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(i,r,o)=>r.toUpperCase()+o)}function ub(s,i){const r=F.toCamelCase(" "+i);["get","set","has"].forEach(o=>{Object.defineProperty(s,o+r,{value:function(c,d,u){return this[o].call(this,i,c,d,u)},configurable:!0})})}class $t{constructor(i){i&&this.set(i)}set(i,r,o){const c=this;function d(m,g,j){const v=Vr(g);if(!v)throw new Error("header name must be a non-empty string");const w=F.findKey(c,v);(!w||c[w]===void 0||j===!0||j===void 0&&c[w]!==!1)&&(c[w||g]=Va(m))}const u=(m,g)=>F.forEach(m,(j,v)=>d(j,v,g));if(F.isPlainObject(i)||i instanceof this.constructor)u(i,r);else if(F.isString(i)&&(i=i.trim())&&!cb(i))u(ob(i),r);else if(F.isHeaders(i))for(const[m,g]of i.entries())d(g,m,o);else i!=null&&d(r,i,o);return this}get(i,r){if(i=Vr(i),i){const o=F.findKey(this,i);if(o){const c=this[o];if(!r)return c;if(r===!0)return lb(c);if(F.isFunction(r))return r.call(this,c,o);if(F.isRegExp(r))return r.exec(c);throw new TypeError("parser must be boolean|regexp|function")}}}has(i,r){if(i=Vr(i),i){const o=F.findKey(this,i);return!!(o&&this[o]!==void 0&&(!r||js(this,this[o],o,r)))}return!1}delete(i,r){const o=this;let c=!1;function d(u){if(u=Vr(u),u){const m=F.findKey(o,u);m&&(!r||js(o,o[m],m,r))&&(delete o[m],c=!0)}}return F.isArray(i)?i.forEach(d):d(i),c}clear(i){const r=Object.keys(this);let o=r.length,c=!1;for(;o--;){const d=r[o];(!i||js(this,this[d],d,i,!0))&&(delete this[d],c=!0)}return c}normalize(i){const r=this,o={};return F.forEach(this,(c,d)=>{const u=F.findKey(o,d);if(u){r[u]=Va(c),delete r[d];return}const m=i?db(d):String(d).trim();m!==d&&delete r[d],r[m]=Va(c),o[m]=!0}),this}concat(...i){return this.constructor.concat(this,...i)}toJSON(i){const r=Object.create(null);return F.forEach(this,(o,c)=>{o!=null&&o!==!1&&(r[c]=i&&F.isArray(o)?o.join(", "):o)}),r}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([i,r])=>i+": "+r).join(`
`)}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(i){return i instanceof this?i:new this(i)}static concat(i,...r){const o=new this(i);return r.forEach(c=>o.set(c)),o}static accessor(i){const o=(this[wc]=this[wc]={accessors:{}}).accessors,c=this.prototype;function d(u){const m=Vr(u);o[m]||(ub(c,u),o[m]=!0)}return F.isArray(i)?i.forEach(d):d(i),this}}$t.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);F.reduceDescriptors($t.prototype,({value:s},i)=>{let r=i[0].toUpperCase()+i.slice(1);return{get:()=>s,set(o){this[r]=o}}});F.freezeMethods($t);function Ss(s,i){const r=this||ea,o=i||r,c=$t.from(o.headers);let d=o.data;return F.forEach(s,function(m){d=m.call(r,d,c.normalize(),i?i.status:void 0)}),c.normalize(),d}function ud(s){return!!(s&&s.__CANCEL__)}function Tr(s,i,r){Ee.call(this,s??"canceled",Ee.ERR_CANCELED,i,r),this.name="CanceledError"}F.inherits(Tr,Ee,{__CANCEL__:!0});function fd(s,i,r){const o=r.config.validateStatus;!r.status||!o||o(r.status)?s(r):i(new Ee("Request failed with status code "+r.status,[Ee.ERR_BAD_REQUEST,Ee.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}function fb(s){const i=/^([-+\w]{1,25})(:?\/\/|:)/.exec(s);return i&&i[1]||""}function pb(s,i){s=s||10;const r=new Array(s),o=new Array(s);let c=0,d=0,u;return i=i!==void 0?i:1e3,function(g){const j=Date.now(),v=o[d];u||(u=j),r[c]=g,o[c]=j;let w=d,I=0;for(;w!==c;)I+=r[w++],w=w%s;if(c=(c+1)%s,c===d&&(d=(d+1)%s),j-u<i)return;const K=v&&j-v;return K?Math.round(I*1e3/K):void 0}}function hb(s,i){let r=0,o=1e3/i,c,d;const u=(j,v=Date.now())=>{r=v,c=null,d&&(clearTimeout(d),d=null),s.apply(null,j)};return[(...j)=>{const v=Date.now(),w=v-r;w>=o?u(j,v):(c=j,d||(d=setTimeout(()=>{d=null,u(c)},o-w)))},()=>c&&u(c)]}const Ka=(s,i,r=3)=>{let o=0;const c=pb(50,250);return hb(d=>{const u=d.loaded,m=d.lengthComputable?d.total:void 0,g=u-o,j=c(g),v=u<=m;o=u;const w={loaded:u,total:m,progress:m?u/m:void 0,bytes:g,rate:j||void 0,estimated:j&&m&&v?(m-u)/j:void 0,event:d,lengthComputable:m!=null,[i?"download":"upload"]:!0};s(w)},r)},jc=(s,i)=>{const r=s!=null;return[o=>i[0]({lengthComputable:r,total:s,loaded:o}),i[1]]},Sc=s=>(...i)=>F.asap(()=>s(...i)),gb=jt.hasStandardBrowserEnv?((s,i)=>r=>(r=new URL(r,jt.origin),s.protocol===r.protocol&&s.host===r.host&&(i||s.port===r.port)))(new URL(jt.origin),jt.navigator&&/(msie|trident)/i.test(jt.navigator.userAgent)):()=>!0,mb=jt.hasStandardBrowserEnv?{write(s,i,r,o,c,d){const u=[s+"="+encodeURIComponent(i)];F.isNumber(r)&&u.push("expires="+new Date(r).toGMTString()),F.isString(o)&&u.push("path="+o),F.isString(c)&&u.push("domain="+c),d===!0&&u.push("secure"),document.cookie=u.join("; ")},read(s){const i=document.cookie.match(new RegExp("(^|;\\s*)("+s+")=([^;]*)"));return i?decodeURIComponent(i[3]):null},remove(s){this.write(s,"",Date.now()-864e5)}}:{write(){},read(){return null},remove(){}};function xb(s){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(s)}function bb(s,i){return i?s.replace(/\/?\/$/,"")+"/"+i.replace(/^\/+/,""):s}function pd(s,i){return s&&!xb(i)?bb(s,i):i}const Nc=s=>s instanceof $t?{...s}:s;function dr(s,i){i=i||{};const r={};function o(j,v,w,I){return F.isPlainObject(j)&&F.isPlainObject(v)?F.merge.call({caseless:I},j,v):F.isPlainObject(v)?F.merge({},v):F.isArray(v)?v.slice():v}function c(j,v,w,I){if(F.isUndefined(v)){if(!F.isUndefined(j))return o(void 0,j,w,I)}else return o(j,v,w,I)}function d(j,v){if(!F.isUndefined(v))return o(void 0,v)}function u(j,v){if(F.isUndefined(v)){if(!F.isUndefined(j))return o(void 0,j)}else return o(void 0,v)}function m(j,v,w){if(w in i)return o(j,v);if(w in s)return o(void 0,j)}const g={url:d,method:d,data:d,baseURL:u,transformRequest:u,transformResponse:u,paramsSerializer:u,timeout:u,timeoutMessage:u,withCredentials:u,withXSRFToken:u,adapter:u,responseType:u,xsrfCookieName:u,xsrfHeaderName:u,onUploadProgress:u,onDownloadProgress:u,decompress:u,maxContentLength:u,maxBodyLength:u,beforeRedirect:u,transport:u,httpAgent:u,httpsAgent:u,cancelToken:u,socketPath:u,responseEncoding:u,validateStatus:m,headers:(j,v,w)=>c(Nc(j),Nc(v),w,!0)};return F.forEach(Object.keys(Object.assign({},s,i)),function(v){const w=g[v]||c,I=w(s[v],i[v],v);F.isUndefined(I)&&w!==m||(r[v]=I)}),r}const hd=s=>{const i=dr({},s);let{data:r,withXSRFToken:o,xsrfHeaderName:c,xsrfCookieName:d,headers:u,auth:m}=i;i.headers=u=$t.from(u),i.url=ld(pd(i.baseURL,i.url),s.params,s.paramsSerializer),m&&u.set("Authorization","Basic "+btoa((m.username||"")+":"+(m.password?unescape(encodeURIComponent(m.password)):"")));let g;if(F.isFormData(r)){if(jt.hasStandardBrowserEnv||jt.hasStandardBrowserWebWorkerEnv)u.setContentType(void 0);else if((g=u.getContentType())!==!1){const[j,...v]=g?g.split(";").map(w=>w.trim()).filter(Boolean):[];u.setContentType([j||"multipart/form-data",...v].join("; "))}}if(jt.hasStandardBrowserEnv&&(o&&F.isFunction(o)&&(o=o(i)),o||o!==!1&&gb(i.url))){const j=c&&d&&mb.read(d);j&&u.set(c,j)}return i},vb=typeof XMLHttpRequest<"u",yb=vb&&function(s){return new Promise(function(r,o){const c=hd(s);let d=c.data;const u=$t.from(c.headers).normalize();let{responseType:m,onUploadProgress:g,onDownloadProgress:j}=c,v,w,I,K,T;function k(){K&&K(),T&&T(),c.cancelToken&&c.cancelToken.unsubscribe(v),c.signal&&c.signal.removeEventListener("abort",v)}let A=new XMLHttpRequest;A.open(c.method.toUpperCase(),c.url,!0),A.timeout=c.timeout;function q(){if(!A)return;const R=$t.from("getAllResponseHeaders"in A&&A.getAllResponseHeaders()),ne={data:!m||m==="text"||m==="json"?A.responseText:A.response,status:A.status,statusText:A.statusText,headers:R,config:s,request:A};fd(function(we){r(we),k()},function(we){o(we),k()},ne),A=null}"onloadend"in A?A.onloadend=q:A.onreadystatechange=function(){!A||A.readyState!==4||A.status===0&&!(A.responseURL&&A.responseURL.indexOf("file:")===0)||setTimeout(q)},A.onabort=function(){A&&(o(new Ee("Request aborted",Ee.ECONNABORTED,s,A)),A=null)},A.onerror=function(){o(new Ee("Network Error",Ee.ERR_NETWORK,s,A)),A=null},A.ontimeout=function(){let M=c.timeout?"timeout of "+c.timeout+"ms exceeded":"timeout exceeded";const ne=c.transitional||cd;c.timeoutErrorMessage&&(M=c.timeoutErrorMessage),o(new Ee(M,ne.clarifyTimeoutError?Ee.ETIMEDOUT:Ee.ECONNABORTED,s,A)),A=null},d===void 0&&u.setContentType(null),"setRequestHeader"in A&&F.forEach(u.toJSON(),function(M,ne){A.setRequestHeader(ne,M)}),F.isUndefined(c.withCredentials)||(A.withCredentials=!!c.withCredentials),m&&m!=="json"&&(A.responseType=c.responseType),j&&([I,T]=Ka(j,!0),A.addEventListener("progress",I)),g&&A.upload&&([w,K]=Ka(g),A.upload.addEventListener("progress",w),A.upload.addEventListener("loadend",K)),(c.cancelToken||c.signal)&&(v=R=>{A&&(o(!R||R.type?new Tr(null,s,A):R),A.abort(),A=null)},c.cancelToken&&c.cancelToken.subscribe(v),c.signal&&(c.signal.aborted?v():c.signal.addEventListener("abort",v)));const V=fb(c.url);if(V&&jt.protocols.indexOf(V)===-1){o(new Ee("Unsupported protocol "+V+":",Ee.ERR_BAD_REQUEST,s));return}A.send(d||null)})},wb=(s,i)=>{const{length:r}=s=s?s.filter(Boolean):[];if(i||r){let o=new AbortController,c;const d=function(j){if(!c){c=!0,m();const v=j instanceof Error?j:this.reason;o.abort(v instanceof Ee?v:new Tr(v instanceof Error?v.message:v))}};let u=i&&setTimeout(()=>{u=null,d(new Ee(`timeout ${i} of ms exceeded`,Ee.ETIMEDOUT))},i);const m=()=>{s&&(u&&clearTimeout(u),u=null,s.forEach(j=>{j.unsubscribe?j.unsubscribe(d):j.removeEventListener("abort",d)}),s=null)};s.forEach(j=>j.addEventListener("abort",d));const{signal:g}=o;return g.unsubscribe=()=>F.asap(m),g}},jb=function*(s,i){let r=s.byteLength;if(r<i){yield s;return}let o=0,c;for(;o<r;)c=o+i,yield s.slice(o,c),o=c},Sb=async function*(s,i){for await(const r of Nb(s))yield*jb(r,i)},Nb=async function*(s){if(s[Symbol.asyncIterator]){yield*s;return}const i=s.getReader();try{for(;;){const{done:r,value:o}=await i.read();if(r)break;yield o}}finally{await i.cancel()}},_c=(s,i,r,o)=>{const c=Sb(s,i);let d=0,u,m=g=>{u||(u=!0,o&&o(g))};return new ReadableStream({async pull(g){try{const{done:j,value:v}=await c.next();if(j){m(),g.close();return}let w=v.byteLength;if(r){let I=d+=w;r(I)}g.enqueue(new Uint8Array(v))}catch(j){throw m(j),j}},cancel(g){return m(g),c.return()}},{highWaterMark:2})},ii=typeof fetch=="function"&&typeof Request=="function"&&typeof Response=="function",gd=ii&&typeof ReadableStream=="function",_b=ii&&(typeof TextEncoder=="function"?(s=>i=>s.encode(i))(new TextEncoder):async s=>new Uint8Array(await new Response(s).arrayBuffer())),md=(s,...i)=>{try{return!!s(...i)}catch{return!1}},Cb=gd&&md(()=>{let s=!1;const i=new Request(jt.origin,{body:new ReadableStream,method:"POST",get duplex(){return s=!0,"half"}}).headers.has("Content-Type");return s&&!i}),Cc=64*1024,Rs=gd&&md(()=>F.isReadableStream(new Response("").body)),Ja={stream:Rs&&(s=>s.body)};ii&&(s=>{["text","arrayBuffer","blob","formData","stream"].forEach(i=>{!Ja[i]&&(Ja[i]=F.isFunction(s[i])?r=>r[i]():(r,o)=>{throw new Ee(`Response type '${i}' is not supported`,Ee.ERR_NOT_SUPPORT,o)})})})(new Response);const Ab=async s=>{if(s==null)return 0;if(F.isBlob(s))return s.size;if(F.isSpecCompliantForm(s))return(await new Request(jt.origin,{method:"POST",body:s}).arrayBuffer()).byteLength;if(F.isArrayBufferView(s)||F.isArrayBuffer(s))return s.byteLength;if(F.isURLSearchParams(s)&&(s=s+""),F.isString(s))return(await _b(s)).byteLength},Eb=async(s,i)=>{const r=F.toFiniteNumber(s.getContentLength());return r??Ab(i)},Tb=ii&&(async s=>{let{url:i,method:r,data:o,signal:c,cancelToken:d,timeout:u,onDownloadProgress:m,onUploadProgress:g,responseType:j,headers:v,withCredentials:w="same-origin",fetchOptions:I}=hd(s);j=j?(j+"").toLowerCase():"text";let K=wb([c,d&&d.toAbortSignal()],u),T;const k=K&&K.unsubscribe&&(()=>{K.unsubscribe()});let A;try{if(g&&Cb&&r!=="get"&&r!=="head"&&(A=await Eb(v,o))!==0){let ne=new Request(i,{method:"POST",body:o,duplex:"half"}),pe;if(F.isFormData(o)&&(pe=ne.headers.get("content-type"))&&v.setContentType(pe),ne.body){const[we,be]=jc(A,Ka(Sc(g)));o=_c(ne.body,Cc,we,be)}}F.isString(w)||(w=w?"include":"omit");const q="credentials"in Request.prototype;T=new Request(i,{...I,signal:K,method:r.toUpperCase(),headers:v.normalize().toJSON(),body:o,duplex:"half",credentials:q?w:void 0});let V=await fetch(T);const R=Rs&&(j==="stream"||j==="response");if(Rs&&(m||R&&k)){const ne={};["status","statusText","headers"].forEach(ve=>{ne[ve]=V[ve]});const pe=F.toFiniteNumber(V.headers.get("content-length")),[we,be]=m&&jc(pe,Ka(Sc(m),!0))||[];V=new Response(_c(V.body,Cc,we,()=>{be&&be(),k&&k()}),ne)}j=j||"text";let M=await Ja[F.findKey(Ja,j)||"text"](V,s);return!R&&k&&k(),await new Promise((ne,pe)=>{fd(ne,pe,{data:M,headers:$t.from(V.headers),status:V.status,statusText:V.statusText,config:s,request:T})})}catch(q){throw k&&k(),q&&q.name==="TypeError"&&/fetch/i.test(q.message)?Object.assign(new Ee("Network Error",Ee.ERR_NETWORK,s,T),{cause:q.cause||q}):Ee.from(q,q&&q.code,s,T)}}),ks={http:Gx,xhr:yb,fetch:Tb};F.forEach(ks,(s,i)=>{if(s){try{Object.defineProperty(s,"name",{value:i})}catch{}Object.defineProperty(s,"adapterName",{value:i})}});const Ac=s=>`- ${s}`,Rb=s=>F.isFunction(s)||s===null||s===!1,xd={getAdapter:s=>{s=F.isArray(s)?s:[s];const{length:i}=s;let r,o;const c={};for(let d=0;d<i;d++){r=s[d];let u;if(o=r,!Rb(r)&&(o=ks[(u=String(r)).toLowerCase()],o===void 0))throw new Ee(`Unknown adapter '${u}'`);if(o)break;c[u||"#"+d]=o}if(!o){const d=Object.entries(c).map(([m,g])=>`adapter ${m} `+(g===!1?"is not supported by the environment":"is not available in the build"));let u=i?d.length>1?`since :
`+d.map(Ac).join(`
`):" "+Ac(d[0]):"as no adapter specified";throw new Ee("There is no suitable adapter to dispatch the request "+u,"ERR_NOT_SUPPORT")}return o},adapters:ks};function Ns(s){if(s.cancelToken&&s.cancelToken.throwIfRequested(),s.signal&&s.signal.aborted)throw new Tr(null,s)}function Ec(s){return Ns(s),s.headers=$t.from(s.headers),s.data=Ss.call(s,s.transformRequest),["post","put","patch"].indexOf(s.method)!==-1&&s.headers.setContentType("application/x-www-form-urlencoded",!1),xd.getAdapter(s.adapter||ea.adapter)(s).then(function(o){return Ns(s),o.data=Ss.call(s,s.transformResponse,o),o.headers=$t.from(o.headers),o},function(o){return ud(o)||(Ns(s),o&&o.response&&(o.response.data=Ss.call(s,s.transformResponse,o.response),o.response.headers=$t.from(o.response.headers))),Promise.reject(o)})}const bd="1.7.9",si={};["object","boolean","number","function","string","symbol"].forEach((s,i)=>{si[s]=function(o){return typeof o===s||"a"+(i<1?"n ":" ")+s}});const Tc={};si.transitional=function(i,r,o){function c(d,u){return"[Axios v"+bd+"] Transitional option '"+d+"'"+u+(o?". "+o:"")}return(d,u,m)=>{if(i===!1)throw new Ee(c(u," has been removed"+(r?" in "+r:"")),Ee.ERR_DEPRECATED);return r&&!Tc[u]&&(Tc[u]=!0,console.warn(c(u," has been deprecated since v"+r+" and will be removed in the near future"))),i?i(d,u,m):!0}};si.spelling=function(i){return(r,o)=>(console.warn(`${o} is likely a misspelling of ${i}`),!0)};function kb(s,i,r){if(typeof s!="object")throw new Ee("options must be an object",Ee.ERR_BAD_OPTION_VALUE);const o=Object.keys(s);let c=o.length;for(;c-- >0;){const d=o[c],u=i[d];if(u){const m=s[d],g=m===void 0||u(m,d,s);if(g!==!0)throw new Ee("option "+d+" must be "+g,Ee.ERR_BAD_OPTION_VALUE);continue}if(r!==!0)throw new Ee("Unknown option "+d,Ee.ERR_BAD_OPTION)}}const Ma={assertOptions:kb,validators:si},vn=Ma.validators;class cr{constructor(i){this.defaults=i,this.interceptors={request:new yc,response:new yc}}async request(i,r){try{return await this._request(i,r)}catch(o){if(o instanceof Error){let c={};Error.captureStackTrace?Error.captureStackTrace(c):c=new Error;const d=c.stack?c.stack.replace(/^.+\n/,""):"";try{o.stack?d&&!String(o.stack).endsWith(d.replace(/^.+\n.+\n/,""))&&(o.stack+=`
`+d):o.stack=d}catch{}}throw o}}_request(i,r){typeof i=="string"?(r=r||{},r.url=i):r=i||{},r=dr(this.defaults,r);const{transitional:o,paramsSerializer:c,headers:d}=r;o!==void 0&&Ma.assertOptions(o,{silentJSONParsing:vn.transitional(vn.boolean),forcedJSONParsing:vn.transitional(vn.boolean),clarifyTimeoutError:vn.transitional(vn.boolean)},!1),c!=null&&(F.isFunction(c)?r.paramsSerializer={serialize:c}:Ma.assertOptions(c,{encode:vn.function,serialize:vn.function},!0)),Ma.assertOptions(r,{baseUrl:vn.spelling("baseURL"),withXsrfToken:vn.spelling("withXSRFToken")},!0),r.method=(r.method||this.defaults.method||"get").toLowerCase();let u=d&&F.merge(d.common,d[r.method]);d&&F.forEach(["delete","get","head","post","put","patch","common"],T=>{delete d[T]}),r.headers=$t.concat(u,d);const m=[];let g=!0;this.interceptors.request.forEach(function(k){typeof k.runWhen=="function"&&k.runWhen(r)===!1||(g=g&&k.synchronous,m.unshift(k.fulfilled,k.rejected))});const j=[];this.interceptors.response.forEach(function(k){j.push(k.fulfilled,k.rejected)});let v,w=0,I;if(!g){const T=[Ec.bind(this),void 0];for(T.unshift.apply(T,m),T.push.apply(T,j),I=T.length,v=Promise.resolve(r);w<I;)v=v.then(T[w++],T[w++]);return v}I=m.length;let K=r;for(w=0;w<I;){const T=m[w++],k=m[w++];try{K=T(K)}catch(A){k.call(this,A);break}}try{v=Ec.call(this,K)}catch(T){return Promise.reject(T)}for(w=0,I=j.length;w<I;)v=v.then(j[w++],j[w++]);return v}getUri(i){i=dr(this.defaults,i);const r=pd(i.baseURL,i.url);return ld(r,i.params,i.paramsSerializer)}}F.forEach(["delete","get","head","options"],function(i){cr.prototype[i]=function(r,o){return this.request(dr(o||{},{method:i,url:r,data:(o||{}).data}))}});F.forEach(["post","put","patch"],function(i){function r(o){return function(d,u,m){return this.request(dr(m||{},{method:i,headers:o?{"Content-Type":"multipart/form-data"}:{},url:d,data:u}))}}cr.prototype[i]=r(),cr.prototype[i+"Form"]=r(!0)});class Ds{constructor(i){if(typeof i!="function")throw new TypeError("executor must be a function.");let r;this.promise=new Promise(function(d){r=d});const o=this;this.promise.then(c=>{if(!o._listeners)return;let d=o._listeners.length;for(;d-- >0;)o._listeners[d](c);o._listeners=null}),this.promise.then=c=>{let d;const u=new Promise(m=>{o.subscribe(m),d=m}).then(c);return u.cancel=function(){o.unsubscribe(d)},u},i(function(d,u,m){o.reason||(o.reason=new Tr(d,u,m),r(o.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(i){if(this.reason){i(this.reason);return}this._listeners?this._listeners.push(i):this._listeners=[i]}unsubscribe(i){if(!this._listeners)return;const r=this._listeners.indexOf(i);r!==-1&&this._listeners.splice(r,1)}toAbortSignal(){const i=new AbortController,r=o=>{i.abort(o)};return this.subscribe(r),i.signal.unsubscribe=()=>this.unsubscribe(r),i.signal}static source(){let i;return{token:new Ds(function(c){i=c}),cancel:i}}}function $b(s){return function(r){return s.apply(null,r)}}function Pb(s){return F.isObject(s)&&s.isAxiosError===!0}const $s={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries($s).forEach(([s,i])=>{$s[i]=s});function vd(s){const i=new cr(s),r=Jc(cr.prototype.request,i);return F.extend(r,cr.prototype,i,{allOwnKeys:!0}),F.extend(r,i,null,{allOwnKeys:!0}),r.create=function(c){return vd(dr(s,c))},r}const ge=vd(ea);ge.Axios=cr;ge.CanceledError=Tr;ge.CancelToken=Ds;ge.isCancel=ud;ge.VERSION=bd;ge.toFormData=ai;ge.AxiosError=Ee;ge.Cancel=ge.CanceledError;ge.all=function(i){return Promise.all(i)};ge.spread=$b;ge.isAxiosError=Pb;ge.mergeConfig=dr;ge.AxiosHeaders=$t;ge.formToJSON=s=>dd(F.isHTMLForm(s)?new FormData(s):s);ge.getAdapter=xd.getAdapter;ge.HttpStatusCode=$s;ge.default=ge;/**
 ...
 *
 * @license MIT
 */function Xr(){return Xr=Object.assign?Object.assign.bind():function(s){for(var i=1;i<arguments.length;i++){var r=arguments[i];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(s[o]=r[o])}return s},Xr.apply(this,arguments)}var Yn;(function(s){s.Pop="POP",s.Push="PUSH",s.Replace="REPLACE"})(Yn||(Yn={}));const Rc="popstate";function Ob(s){s===void 0&&(s={});function i(o,c){let{pathname:d,search:u,hash:m}=o.location;return Ps("",{pathname:d,search:u,hash:m},c.state&&c.state.usr||null,c.state&&c.state.key||"default")}function r(o,c){return typeof c=="string"?c:Xa(c)}return Ib(i,r,null,s)}function at(s,i){if(s===!1||s===null||typeof s>"u")throw new Error(i)}function yd(s,i){if(!s){typeof console<"u"&&console.warn(i);try{throw new Error(i)}catch{}}}function Fb(){return Math.random().toString(36).substr(2,8)}function kc(s,i){return{usr:s.state,key:s.key,idx:i}}function Ps(s,i,r,o){return r===void 0&&(r=null),Xr({pathname:typeof s=="string"?s:s.pathname,search:"",hash:""},typeof i=="string"?Rr(i):i,{state:r,key:i&&i.key||o||Fb()})}function Xa(s){let{pathname:i="/",search:r="",hash:o=""}=s;return r&&r!=="?"&&(i+=r.charAt(0)==="?"?r:"?"+r),o&&o!=="#"&&(i+=o.charAt(0)==="#"?o:"#"+o),i}function Rr(s){let i={};if(s){let r=s.indexOf("#");r>=0&&(i.hash=s.substr(r),s=s.substr(0,r));let o=s.indexOf("?");o>=0&&(i.search=s.substr(o),s=s.substr(0,o)),s&&(i.pathname=s)}return i}function Ib(s,i,r,o){o===void 0&&(o={});let{window:c=document.defaultView,v5Compat:d=!1}=o,u=c.history,m=Yn.Pop,g=null,j=v();j==null&&(j=0,u.replaceState(Xr({},u.state,{idx:j}),""));function v(){return(u.state||{idx:null}).idx}function w(){m=Yn.Pop;let A=v(),q=A==null?null:A-j;j=A,g&&g({action:m,location:k.location,delta:q})}function I(A,q){m=Yn.Push;let V=Ps(k.location,A,q);j=v()+1;let R=kc(V,j),M=k.createHref(V);try{u.pushState(R,"",M)}catch(ne){if(ne instanceof DOMException&&ne.name==="DataCloneError")throw ne;c.location.assign(M)}d&&g&&g({action:m,location:k.location,delta:1})}function K(A,q){m=Yn.Replace;let V=Ps(k.location,A,q);j=v();let R=kc(V,j),M=k.createHref(V);u.replaceState(R,"",M),d&&g&&g({action:m,location:k.location,delta:0})}function T(A){let q=c.location.origin!=="null"?c.location.origin:c.location.href,V=typeof A=="string"?A:Xa(A);return V=V.replace(/ $/,"%20"),at(q,"No window.location.(origin|href) available to create URL for href: "+V),new URL(V,q)}let k={get action(){return m},get location(){return s(c,u)},listen(A){if(g)throw new Error("A history only accepts one active listener");return c.addEventListener(Rc,w),g=A,()=>{c.removeEventListener(Rc,w),g=null}},createHref(A){return i(c,A)},createURL:T,encodeLocation(A){let q=T(A);return{pathname:q.pathname,search:q.search,hash:q.hash}},push:I,replace:K,go(A){return u.go(A)}};return k}var $c;(function(s){s.data="data",s.deferred="deferred",s.redirect="redirect",s.error="error"})($c||($c={}));function Lb(s,i,r){return r===void 0&&(r="/"),Ub(s,i,r,!1)}function Ub(s,i,r,o){let c=typeof i=="string"?Rr(i):i,d=Ar(c.pathname||"/",r);if(d==null)return null;let u=wd(s);Db(u);let m=null;for(let g=0;m==null&&g<u.length;++g){let j=Jb(d);m=Mb(u[g],j,o)}return m}function wd(s,i,r,o){i===void 0&&(i=[]),r===void 0&&(r=[]),o===void 0&&(o="");let c=(d,u,m)=>{let g={relativePath:m===void 0?d.path||"":m,caseSensitive:d.caseSensitive===!0,childrenIndex:u,route:d};g.relativePath.startsWith("/")&&(at(g.relativePath.startsWith(o),'Absolute route path "'+g.relativePath+'" nested under path '+('"'+o+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),g.relativePath=g.relativePath.slice(o.length));let j=Vn([o,g.relativePath]),v=r.concat(g);d.children&&d.children.length>0&&(at(d.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+j+'".')),wd(d.children,i,v,j)),!(d.path==null&&!d.index)&&i.push({path:j,score:Yb(j,d.index),routesMeta:v})};return s.forEach((d,u)=>{var m;if(d.path===""||!((m=d.path)!=null&&m.includes("?")))c(d,u);else for(let g of jd(d.path))c(d,u,g)}),i}function jd(s){let i=s.split("/");if(i.length===0)return[];let[r,...o]=i,c=r.endsWith("?"),d=r.replace(/\?$/,"");if(o.length===0)return c?[d,""]:[d];let u=jd(o.join("/")),m=[];return m.push(...u.map(g=>g===""?d:[d,g].join("/"))),c&&m.push(...u),m.map(g=>s.startsWith("/")&&g===""?"/":g)}function Db(s){s.sort((i,r)=>i.score!==r.score?r.score-i.score:Vb(i.routesMeta.map(o=>o.childrenIndex),r.routesMeta.map(o=>o.childrenIndex)))}const Bb=/^:[\w-]+$/,zb=3,Wb=2,Hb=1,Gb=10,qb=-2,Pc=s=>s==="*";function Yb(s,i){let r=s.split("/"),o=r.length;return r.some(Pc)&&(o+=qb),i&&(o+=Wb),r.filter(c=>!Pc(c)).reduce((c,d)=>c+(Bb.test(d)?zb:d===""?Hb:Gb),o)}function Vb(s,i){return s.length===i.length&&s.slice(0,-1).every((o,c)=>o===i[c])?s[s.length-1]-i[i.length-1]:0}function Mb(s,i,r){let{routesMeta:o}=s,c={},d="/",u=[];for(let m=0;m<o.length;++m){let g=o[m],j=m===o.length-1,v=d==="/"?i:i.slice(d.length)||"/",w=Za({path:g.relativePath,caseSensitive:g.caseSensitive,end:j},v),I=g.route;if(!w&&j&&r&&!o[o.length-1].route.index&&(w=Za({path:g.relativePath,caseSensitive:g.caseSensitive,end:!1},v)),!w)return null;Object.assign(c,w.params),u.push({params:c,pathname:Vn([d,w.pathname]),pathnameBase:e1(Vn([d,w.pathnameBase])),route:I}),w.pathnameBase!=="/"&&(d=Vn([d,w.pathnameBase]))}return u}function Za(s,i){typeof s=="string"&&(s={path:s,caseSensitive:!1,end:!0});let[r,o]=Kb(s.path,s.caseSensitive,s.end),c=i.match(r);if(!c)return null;let d=c[0],u=d.replace(/(.)\/+$/,"$1"),m=c.slice(1);return{params:o.reduce((j,v,w)=>{let{paramName:I,isOptional:K}=v;if(I==="*"){let k=m[w]||"";u=d.slice(0,d.length-k.length).replace(/(.)\/+$/,"$1")}const T=m[w];return K&&!T?j[I]=void 0:j[I]=(T||"").replace(/%2F/g,"/"),j},{}),pathname:d,pathnameBase:u,pattern:s}}function Kb(s,i,r){i===void 0&&(i=!1),r===void 0&&(r=!0),yd(s==="*"||!s.endsWith("*")||s.endsWith("/*"),'Route path "'+s+'" will be treated as if it were '+('"'+s.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+s.replace(/\*$/,"/*")+'".'));let o=[],c="^"+s.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(u,m,g)=>(o.push({paramName:m,isOptional:g!=null}),g?"/?([^\\/]+)?":"/([^\\/]+)"));return s.endsWith("*")?(o.push({paramName:"*"}),c+=s==="*"||s==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):r?c+="\\/*$":s!==""&&s!=="/"&&(c+="(?:(?=\\/|$))"),[new RegExp(c,i?void 0:"i"),o]}function Jb(s){try{return s.split("/").map(i=>decodeURIComponent(i).replace(/\//g,"%2F")).join("/")}catch(i){return yd(!1,'The URL path "'+s+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+i+").")),s}}function Ar(s,i){if(i==="/")return s;if(!s.toLowerCase().startsWith(i.toLowerCase()))return null;let r=i.endsWith("/")?i.length-1:i.length,o=s.charAt(r);return o&&o!=="/"?null:s.slice(r)||"/"}function Xb(s,i){i===void 0&&(i="/");let{pathname:r,search:o="",hash:c=""}=typeof s=="string"?Rr(s):s;return{pathname:r?r.startsWith("/")?r:Zb(r,i):i,search:t1(o),hash:n1(c)}}function Zb(s,i){let r=i.replace(/\/+$/,"").split("/");return s.split("/").forEach(c=>{c===".."?r.length>1&&r.pop():c!=="."&&r.push(c)}),r.length>1?r.join("/"):"/"}function _s(s,i,r,o){return"Cannot include a '"+s+"' character in a manually specified "+("`to."+i+"` field ["+JSON.stringify(o)+"].  Please separate it out to the ")+("`to."+r+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Qb(s){return s.filter((i,r)=>r===0||i.route.path&&i.route.path.length>0)}function Bs(s,i){let r=Qb(s);return i?r.map((o,c)=>c===r.length-1?o.pathname:o.pathnameBase):r.map(o=>o.pathnameBase)}function zs(s,i,r,o){o===void 0&&(o=!1);let c;typeof s=="string"?c=Rr(s):(c=Xr({},s),at(!c.pathname||!c.pathname.includes("?"),_s("?","pathname","search",c)),at(!c.pathname||!c.pathname.includes("#"),_s("#","pathname","hash",c)),at(!c.search||!c.search.includes("#"),_s("#","search","hash",c)));let d=s===""||c.pathname==="",u=d?"/":c.pathname,m;if(u==null)m=r;else{let w=i.length-1;if(!o&&u.startsWith("..")){let I=u.split("/");for(;I[0]==="..";)I.shift(),w-=1;c.pathname=I.join("/")}m=w>=0?i[w]:"/"}let g=Xb(c,m),j=u&&u!=="/"&&u.endsWith("/"),v=(d||u===".")&&r.endsWith("/");return!g.pathname.endsWith("/")&&(j||v)&&(g.pathname+="/"),g}const Vn=s=>s.join("/").replace(/\/\/+/g,"/"),e1=s=>s.replace(/\/+$/,"").replace(/^\/*/,"/"),t1=s=>!s||s==="?"?"":s.startsWith("?")?s:"?"+s,n1=s=>!s||s==="#"?"":s.startsWith("#")?s:"#"+s;function r1(s){return s!=null&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.internal=="boolean"&&"data"in s}const Sd=["post","put","patch","delete"];new Set(Sd);const a1=["get",...Sd];new Set(a1);/**
 ...
 *
 * @license MIT
 */function Zr(){return Zr=Object.assign?Object.assign.bind():function(s){for(var i=1;i<arguments.length;i++){var r=arguments[i];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(s[o]=r[o])}return s},Zr.apply(this,arguments)}const oi=y.createContext(null),Nd=y.createContext(null),Pn=y.createContext(null),li=y.createContext(null),Mn=y.createContext({outlet:null,matches:[],isDataRoute:!1}),_d=y.createContext(null);function i1(s,i){let{relative:r}=i===void 0?{}:i;kr()||at(!1);let{basename:o,navigator:c}=y.useContext(Pn),{hash:d,pathname:u,search:m}=ci(s,{relative:r}),g=u;return o!=="/"&&(g=u==="/"?o:Vn([o,u])),c.createHref({pathname:g,search:m,hash:d})}function kr(){return y.useContext(li)!=null}function Kn(){return kr()||at(!1),y.useContext(li).location}function Cd(s){y.useContext(Pn).static||y.useLayoutEffect(s)}function ur(){let{isDataRoute:s}=y.useContext(Mn);return s?b1():s1()}function s1(){kr()||at(!1);let s=y.useContext(oi),{basename:i,future:r,navigator:o}=y.useContext(Pn),{matches:c}=y.useContext(Mn),{pathname:d}=Kn(),u=JSON.stringify(Bs(c,r.v7_relativeSplatPath)),m=y.useRef(!1);return Cd(()=>{m.current=!0}),y.useCallback(function(j,v){if(v===void 0&&(v={}),!m.current)return;if(typeof j=="number"){o.go(j);return}let w=zs(j,JSON.parse(u),d,v.relative==="path");s==null&&i!=="/"&&(w.pathname=w.pathname==="/"?i:Vn([i,w.pathname])),(v.replace?o.replace:o.push)(w,v.state,v)},[i,o,u,d,s])}function ci(s,i){let{relative:r}=i===void 0?{}:i,{future:o}=y.useContext(Pn),{matches:c}=y.useContext(Mn),{pathname:d}=Kn(),u=JSON.stringify(Bs(c,o.v7_relativeSplatPath));return y.useMemo(()=>zs(s,JSON.parse(u),d,r==="path"),[s,u,d,r])}function o1(s,i){return l1(s,i)}function l1(s,i,r,o){kr()||at(!1);let{navigator:c}=y.useContext(Pn),{matches:d}=y.useContext(Mn),u=d[d.length-1],m=u?u.params:{};u&&u.pathname;let g=u?u.pathnameBase:"/";u&&u.route;let j=Kn(),v;if(i){var w;let A=typeof i=="string"?Rr(i):i;g==="/"||(w=A.pathname)!=null&&w.startsWith(g)||at(!1),v=A}else v=j;let I=v.pathname||"/",K=I;if(g!=="/"){let A=g.replace(/^\//,"").split("/");K="/"+I.replace(/^\//,"").split("/").slice(A.length).join("/")}let T=Lb(s,{pathname:K}),k=p1(T&&T.map(A=>Object.assign({},A,{params:Object.assign({},m,A.params),pathname:Vn([g,c.encodeLocation?c.encodeLocation(A.pathname).pathname:A.pathname]),pathnameBase:A.pathnameBase==="/"?g:Vn([g,c.encodeLocation?c.encodeLocation(A.pathnameBase).pathname:A.pathnameBase])})),d,r,o);return i&&k?y.createElement(li.Provider,{value:{location:Zr({pathname:"/",search:"",hash:"",state:null,key:"default"},v),navigationType:Yn.Pop}},k):k}function c1(){let s=x1(),i=r1(s)?s.status+" "+s.statusText:s instanceof Error?s.message:JSON.stringify(s),r=s instanceof Error?s.stack:null,c={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return y.createElement(y.Fragment,null,y.createElement("h2",null,"Unexpected Application Error!"),y.createElement("h3",{style:{fontStyle:"italic"}},i),r?y.createElement("pre",{style:c},r):null,null)}const d1=y.createElement(c1,null);class u1 extends y.Component{constructor(i){super(i),this.state={location:i.location,revalidation:i.revalidation,error:i.error}}static getDerivedStateFromError(i){return{error:i}}static getDerivedStateFromProps(i,r){return r.location!==i.location||r.revalidation!=="idle"&&i.revalidation==="idle"?{error:i.error,location:i.location,revalidation:i.revalidation}:{error:i.error!==void 0?i.error:r.error,location:r.location,revalidation:i.revalidation||r.revalidation}}componentDidCatch(i,r){console.error("React Router caught the following error during render",i,r)}render(){return this.state.error!==void 0?y.createElement(Mn.Provider,{value:this.props.routeContext},y.createElement(_d.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function f1(s){let{routeContext:i,match:r,children:o}=s,c=y.useContext(oi);return c&&c.static&&c.staticContext&&(r.route.errorElement||r.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=r.route.id),y.createElement(Mn.Provider,{value:i},o)}function p1(s,i,r,o){var c;if(i===void 0&&(i=[]),r===void 0&&(r=null),o===void 0&&(o=null),s==null){var d;if(!r)return null;if(r.errors)s=r.matches;else if((d=o)!=null&&d.v7_partialHydration&&i.length===0&&!r.initialized&&r.matches.length>0)s=r.matches;else return null}let u=s,m=(c=r)==null?void 0:c.errors;if(m!=null){let v=u.findIndex(w=>w.route.id&&(m==null?void 0:m[w.route.id])!==void 0);v>=0||at(!1),u=u.slice(0,Math.min(u.length,v+1))}let g=!1,j=-1;if(r&&o&&o.v7_partialHydration)for(let v=0;v<u.length;v++){let w=u[v];if((w.route.HydrateFallback||w.route.hydrateFallbackElement)&&(j=v),w.route.id){let{loaderData:I,errors:K}=r,T=w.route.loader&&I[w.route.id]===void 0&&(!K||K[w.route.id]===void 0);if(w.route.lazy||T){g=!0,j>=0?u=u.slice(0,j+1):u=[u[0]];break}}}return u.reduceRight((v,w,I)=>{let K,T=!1,k=null,A=null;r&&(K=m&&w.route.id?m[w.route.id]:void 0,k=w.route.errorElement||d1,g&&(j<0&&I===0?(T=!0,A=null):j===I&&(T=!0,A=w.route.hydrateFallbackElement||null)));let q=i.concat(u.slice(0,I+1)),V=()=>{let R;return K?R=k:T?R=A:w.route.Component?R=y.createElement(w.route.Component,null):w.route.element?R=w.route.element:R=v,y.createElement(f1,{match:w,routeContext:{outlet:v,matches:q,isDataRoute:r!=null},children:R})};return r&&(w.route.ErrorBoundary||w.route.errorElement||I===0)?y.createElement(u1,{location:r.location,revalidation:r.revalidation,component:k,error:K,children:V(),routeContext:{outlet:null,matches:q,isDataRoute:!0}}):V()},null)}var Ad=function(s){return s.UseBlocker="useBlocker",s.UseRevalidator="useRevalidator",s.UseNavigateStable="useNavigate",s}(Ad||{}),Qa=function(s){return s.UseBlocker="useBlocker",s.UseLoaderData="useLoaderData",s.UseActionData="useActionData",s.UseRouteError="useRouteError",s.UseNavigation="useNavigation",s.UseRouteLoaderData="useRouteLoaderData",s.UseMatches="useMatches",s.UseRevalidator="useRevalidator",s.UseNavigateStable="useNavigate",s.UseRouteId="useRouteId",s}(Qa||{});function h1(s){let i=y.useContext(oi);return i||at(!1),i}function g1(s){let i=y.useContext(Nd);return i||at(!1),i}function m1(s){let i=y.useContext(Mn);return i||at(!1),i}function Ed(s){let i=m1(),r=i.matches[i.matches.length-1];return r.route.id||at(!1),r.route.id}function x1(){var s;let i=y.useContext(_d),r=g1(Qa.UseRouteError),o=Ed(Qa.UseRouteError);return i!==void 0?i:(s=r.errors)==null?void 0:s[o]}function b1(){let{router:s}=h1(Ad.UseNavigateStable),i=Ed(Qa.UseNavigateStable),r=y.useRef(!1);return Cd(()=>{r.current=!0}),y.useCallback(function(c,d){d===void 0&&(d={}),r.current&&(typeof c=="number"?s.navigate(c):s.navigate(c,Zr({fromRouteId:i},d)))},[s,i])}function v1(s){let{to:i,replace:r,state:o,relative:c}=s;kr()||at(!1);let{future:d,static:u}=y.useContext(Pn),{matches:m}=y.useContext(Mn),{pathname:g}=Kn(),j=ur(),v=zs(i,Bs(m,d.v7_relativeSplatPath),g,c==="path"),w=JSON.stringify(v);return y.useEffect(()=>j(JSON.parse(w),{replace:r,state:o,relative:c}),[j,w,c,r,o]),null}function pn(s){at(!1)}function y1(s){let{basename:i="/",children:r=null,location:o,navigationType:c=Yn.Pop,navigator:d,static:u=!1,future:m}=s;kr()&&at(!1);let g=i.replace(/^\/*/,"/"),j=y.useMemo(()=>({basename:g,navigator:d,static:u,future:Zr({v7_relativeSplatPath:!1},m)}),[g,m,d,u]);typeof o=="string"&&(o=Rr(o));let{pathname:v="/",search:w="",hash:I="",state:K=null,key:T="default"}=o,k=y.useMemo(()=>{let A=Ar(v,g);return A==null?null:{location:{pathname:A,search:w,hash:I,state:K,key:T},navigationType:c}},[g,v,w,I,K,T,c]);return k==null?null:y.createElement(Pn.Provider,{value:j},y.createElement(li.Provider,{children:r,value:k}))}function Oc(s){let{children:i,location:r}=s;return o1(Os(i),r)}new Promise(()=>{});function Os(s,i){i===void 0&&(i=[]);let r=[];return y.Children.forEach(s,(o,c)=>{if(!y.isValidElement(o))return;let d=[...i,c];if(o.type===y.Fragment){r.push.apply(r,Os(o.props.children,d));return}o.type!==pn&&at(!1),!o.props.index||!o.props.children||at(!1);let u={id:o.props.id||d.join("-"),caseSensitive:o.props.caseSensitive,element:o.props.element,Component:o.props.Component,index:o.props.index,path:o.props.path,loader:o.props.loader,action:o.props.action,errorElement:o.props.errorElement,ErrorBoundary:o.props.ErrorBoundary,hasErrorBoundary:o.props.ErrorBoundary!=null||o.props.errorElement!=null,shouldRevalidate:o.props.shouldRevalidate,handle:o.props.handle,lazy:o.props.lazy};o.props.children&&(u.children=Os(o.props.children,d)),r.push(u)}),r}/**
 ...
 */function ei(){return ei=Object.assign?Object.assign.bind():function(s){for(var i=1;i<arguments.length;i++){var r=arguments[i];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(s[o]=r[o])}return s},ei.apply(this,arguments)}function Td(s,i){if(s==null)return{};var r={},o=Object.keys(s),c,d;for(d=0;d<o.length;d++)c=o[d],!(i.indexOf(c)>=0)&&(r[c]=s[c]);return r}function w1(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function j1(s,i){return s.button===0&&(!i||i==="_self")&&!w1(s)}const S1=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],N1=["aria-current","caseSensitive","className","end","style","to","unstable_viewTransition","children"],_1="6";try{window.__reactRouterVersion=_1}catch{}const C1=y.createContext({isTransitioning:!1}),A1="startTransition",Fc=Gm[A1];function E1(s){let{basename:i,children:r,future:o,window:c}=s,d=y.useRef();d.current==null&&(d.current=Ob({window:c,v5Compat:!0}));let u=d.current,[m,g]=y.useState({action:u.action,location:u.location}),{v7_startTransition:j}=o||{},v=y.useCallback(w=>{j&&Fc?Fc(()=>g(w)):g(w)},[g,j]);return y.useLayoutEffect(()=>u.listen(v),[u,v]),y.createElement(y1,{basename:i,children:r,location:m.location,navigationType:m.action,navigator:u,future:o})}const T1=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",R1=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,k1=y.forwardRef(function(i,r){let{onClick:o,relative:c,reloadDocument:d,replace:u,state:m,target:g,to:j,preventScrollReset:v,unstable_viewTransition:w}=i,I=Td(i,S1),{basename:K}=y.useContext(Pn),T,k=!1;if(typeof j=="string"&&R1.test(j)&&(T=j,T1))try{let R=new URL(window.location.href),M=j.startsWith("//")?new URL(R.protocol+j):new URL(j),ne=Ar(M.pathname,K);M.origin===R.origin&&ne!=null?j=ne+M.search+M.hash:k=!0}catch{}let A=i1(j,{relative:c}),q=P1(j,{replace:u,state:m,target:g,preventScrollReset:v,relative:c,unstable_viewTransition:w});function V(R){o&&o(R),R.defaultPrevented||q(R)}return y.createElement("a",ei({},I,{href:T||A,onClick:k||d?o:V,ref:r,target:g}))}),$n=y.forwardRef(function(i,r){let{"aria-current":o="page",caseSensitive:c=!1,className:d="",end:u=!1,style:m,to:g,unstable_viewTransition:j,children:v}=i,w=Td(i,N1),I=ci(g,{relative:w.relative}),K=Kn(),T=y.useContext(Nd),{navigator:k,basename:A}=y.useContext(Pn),q=T!=null&&O1(I)&&j===!0,V=k.encodeLocation?k.encodeLocation(I).pathname:I.pathname,R=K.pathname,M=T&&T.navigation&&T.navigation.location?T.navigation.location.pathname:null;c||(R=R.toLowerCase(),M=M?M.toLowerCase():null,V=V.toLowerCase()),M&&A&&(M=Ar(M,A)||M);const ne=V!=="/"&&V.endsWith("/")?V.length-1:V.length;let pe=R===V||!u&&R.startsWith(V)&&R.charAt(ne)==="/",we=M!=null&&(M===V||!u&&M.startsWith(V)&&M.charAt(V.length)==="/"),be={isActive:pe,isPending:we,isTransitioning:q},ve=pe?o:void 0,Oe;typeof d=="function"?Oe=d(be):Oe=[d,pe?"active":null,we?"pending":null,q?"transitioning":null].filter(Boolean).join(" ");let E=typeof m=="function"?m(be):m;return y.createElement(k1,ei({},w,{"aria-current":ve,className:Oe,ref:r,style:E,to:g,unstable_viewTransition:j}),typeof v=="function"?v(be):v)});var Fs;(function(s){s.UseScrollRestoration="useScrollRestoration",s.UseSubmit="useSubmit",s.UseSubmitFetcher="useSubmitFetcher",s.UseFetcher="useFetcher",s.useViewTransitionState="useViewTransitionState"})(Fs||(Fs={}));var Ic;(function(s){s.UseFetcher="useFetcher",s.UseFetchers="useFetchers",s.UseScrollRestoration="useScrollRestoration"})(Ic||(Ic={}));function $1(s){let i=y.useContext(oi);return i||at(!1),i}function P1(s,i){let{target:r,replace:o,state:c,preventScrollReset:d,relative:u,unstable_viewTransition:m}=i===void 0?{}:i,g=ur(),j=Kn(),v=ci(s,{relative:u});return y.useCallback(w=>{if(j1(w,r)){w.preventDefault();let I=o!==void 0?o:Xa(j)===Xa(v);g(s,{replace:I,state:c,preventScrollReset:d,relative:u,unstable_viewTransition:m})}},[j,g,v,o,c,r,s,d,u,m])}function O1(s,i){i===void 0&&(i={});let r=y.useContext(C1);r==null&&at(!1);let{basename:o}=$1(Fs.useViewTransitionState),c=ci(s,{relative:i.relative});if(!r.isTransitioning)return!1;let d=Ar(r.currentLocation.pathname,o)||r.currentLocation.pathname,u=Ar(r.nextLocation.pathname,o)||r.nextLocation.pathname;return Za(c.pathname,u)!=null||Za(c.pathname,d)!=null}class F1{constructor(){this.categoryPatterns={"Food & Dining":["starbucks","mcdonalds","burger king","subway","chipotle","kfc","pizza hut","dominos","taco bell","wendys","restaurant","cafe","diner","bistro","grill","bar","pub","bakery","doordash","uber eats","grubhub","postmates","food","dining"],Transportation:["shell","exxon","chevron","bp","mobil","gas","fuel","station","uber","lyft","taxi","metro","bus","train","parking","toll","automotive","repair","mechanic","oil change"],Shopping:["amazon","walmart","target","costco","best buy","home depot","lowes","macys","nordstrom","tj maxx","marshall","store","shopping","retail","mall","outlet"],Groceries:["kroger","safeway","whole foods","trader joe","publix","aldi","wegmans","harris teeter","food lion","giant","stop shop","grocery","supermarket","market"],Entertainment:["netflix","spotify","apple music","disney","hulu","amazon prime","youtube","cinema","theater","movie","concert","game","steam","playstation","xbox","entertainment"],Utilities:["electric","power","water","gas company","internet","cable","phone","cell","verizon","att","tmobile","comcast","utility"],Healthcare:["pharmacy","cvs","walgreens","rite aid","hospital","clinic","doctor","dentist","medical","health","insurance"],Finance:["bank","atm","fee","interest","loan","credit","investment","transfer","payment","financial"],"Phone Service":["phone","cell","cellular","mobile","verizon","att","at&t","tmobile","t-mobile","sprint","boost","cricket","mint mobile","visible","metro pcs","tracfone","straight talk","ting","spectrum"]},this.userCorrections=this.loadUserCorrections()}categorizeTransaction(i,r=null){if(!i)return{category:"Other",confidence:0};const o=i.toLowerCase().trim(),c=this.checkUserCorrections(o);if(c)return{category:c,confidence:95};const d=this.findPatternMatch(o);return d||this.advancedCategorization(o,r)}checkUserCorrections(i){for(const r of this.userCorrections)if(i.includes(r.merchant.toLowerCase()))return r.category;return null}findPatternMatch(i){const r={};for(const[c,d]of Object.entries(this.categoryPatterns)){let u=0,m=0;for(const g of d)i.includes(g)&&(u+=g.length,m++);m>0&&(r[c]=u/d.length*100)}if(Object.keys(r).length===0)return null;const o=Object.keys(r).reduce((c,d)=>r[c]>r[d]?c:d);return{category:o,confidence:Math.min(Math.round(r[o]*2),90)}}advancedCategorization(i,r){if(r){const o=parseFloat(r);if(o<10&&this.containsWords(i,["coffee","snack","drink"]))return{category:"Food & Dining",confidence:70};if(o>500&&this.containsWords(i,["rent","mortgage","property"]))return{category:"Housing",confidence:75}}return this.containsWords(i,["purchase","buy","shop"])?{category:"Shopping",confidence:60}:this.containsWords(i,["payment","bill","invoice"])?{category:"Bills & Utilities",confidence:65}:{category:"Other",confidence:30}}containsWords(i,r){return r.some(o=>i.includes(o))}learnFromCorrection(i,r,o){const c=this.extractMerchantName(i),d={merchant:c,originalCategory:r,correctedCategory:o,timestamp:new Date().toISOString()};this.userCorrections.push(d),this.saveUserCorrections(),this.categoryPatterns[o].some(u=>c.toLowerCase().includes(u))||this.categoryPatterns[o].push(c.toLowerCase())}extractMerchantName(i){let r=i.replace(/^(purchase|payment|transfer)\s+/i,"").replace(/\s+(#\d+|store|inc|llc|corp).*$/i,"").trim();return r=r.split(/\s+#|\s+\d{3,}/)[0],r}loadUserCorrections(){try{const i=localStorage.getItem("ai_transaction_corrections");return i?JSON.parse(i):[]}catch(i){return console.error("Error loading user corrections:",i),[]}}saveUserCorrections(){try{localStorage.setItem("ai_transaction_corrections",JSON.stringify(this.userCorrections))}catch(i){console.error("Error saving user corrections:",i)}}getStats(){const i=this.userCorrections.length,r={};return this.userCorrections.forEach(o=>{r[o.correctedCategory]=(r[o.correctedCategory]||0)+1}),{totalCorrections:i,categoryDistribution:r,learningAccuracy:i>0?Math.min(85+i*2,95):65}}}const lr=new F1,I1=["Food & Dining","Transportation","Shopping","Groceries","Entertainment","Utilities","Healthcare","Finance","Housing","Bills & Utilities","Education","Travel","Personal Care","Gifts & Donations","Other"];function L1({amount:s,setAmount:i,category:r,setCategory:o,date:c,setDate:d,description:u,setDescription:m,darkMode:g}){const j=ur(),[v,w]=y.useState(!1),[I,K]=y.useState(!1),[T,k]=y.useState({}),[A,q]=y.useState(!1),[V,R]=y.useState(null),[M,ne]=y.useState(!1),[pe,we]=y.useState(!1);y.useEffect(()=>{if(u.trim().length>2){we(!0);const P=setTimeout(()=>{const Z=lr.categorizeTransaction(u,s);R(Z),ne(Z.confidence>60&&Z.category!==r),we(!1)},500);return()=>clearTimeout(P)}else ne(!1),R(null),we(!1)},[u,s,r]);const be=()=>{V&&(o(V.category),ne(!1),lr.learnFromCorrection(u,s,V.category))},ve=()=>{ne(!1)},Oe=P=>{const Z=parseFloat(P.target.value);i(isNaN(Z)?0:Z),T.amount&&k(oe=>({...oe,amount:""}))},E=P=>{d(P.target.value),T.date&&k(Z=>({...Z,date:""}))},Q=()=>{const P={};return r||(P.category="Please select a category"),u.trim()||(P.description="Description is required"),(!s||s<=0)&&(P.amount="Please enter a valid amount"),c||(P.date="Please select a date"),k(P),Object.keys(P).length===0},se=async P=>{if(P.preventDefault(),!Q()){q(!0),setTimeout(()=>q(!1),500);return}w(!0),k({});const Z={category:r,date:new Date(c).toISOString().split("T")[0],description:u,amount:s};try{const oe=await ge.post("http://127.0.0.1:5001/transactions",Z);console.log("Transaction added:",oe.data),V&&V.category!==r&&V.confidence>50&&(lr.learnFromCorrection(u,V.category,r),console.log(`AI learned: "${u}" should be categorized as "${r}" not "${V.category}"`)),K(!0),o(""),d(""),m(""),i(0),R(null),ne(!1),setTimeout(()=>{K(!1),j("/transactions")},2e3)}catch(oe){console.error("Error adding transaction:",oe),k({submit:"Failed to add transaction. Please try again."})}finally{w(!1)}};return n.jsxs("div",{className:"add-transactions-container",children:[n.jsx("style",{jsx:!0,children:`
      ...
      `}),n.jsxs("div",{className:"ai-header",children:[n.jsx("div",{style:{color:"white",fontSize:"1.4rem",fontWeight:"700",margin:"0 0 8px 0",display:"block",width:"100%",textAlign:"center",textShadow:"none",opacity:1},children:"AI Financial Assistant"}),n.jsx("div",{style:{margin:"0",fontSize:"15px",color:"rgba(255, 255, 255, 0.95)",display:"block",width:"100%",textAlign:"center",opacity:1},children:"Powered by intelligent insights and predictive analytics"})]}),n.jsxs("div",{className:"nl-query-section",children:[n.jsx("h5",{style:{color:d?"#e2e8f0":"#2d3748",marginBottom:"15px",fontWeight:"700"},children:"💬 Ask Your AI Assistant"}),n.jsxs("div",{className:"nl-query-container",children:[n.jsx("input",{type:"text",className:"nl-query-input",placeholder:"Ask me anything... 'How much did I spend this month?' or 'What's my investment performance?'",value:k,onChange:E=>A(E.target.value),onKeyPress:ve}),n.jsx("button",{className:"nl-query-btn",onClick:be,children:"🔍 Ask AI"})]}),q&&n.jsxs("div",{className:"nl-response",children:[n.jsx("strong",{children:"🤖 AI Assistant:"})," ",q.answer]})]}),n.jsxs("div",{className:"ai-tabs",children:[n.jsxs("button",{className:`ai-tab ${R==="insights"?"active":""}`,onClick:()=>M("insights"),children:[n.jsx("div",{style:{fontSize:"1.4rem",minWidth:"28px",flexShrink:"0"},children:"💡"}),n.jsxs("div",{style:{flex:"1",textAlign:"left"},children:[n.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"700",marginBottom:"3px"},children:"Insights"}),n.jsxs("div",{style:{fontSize:"0.9rem",opacity:"0.85"},children:[m.length," available"]})]})]}),n.jsxs("button",{className:`ai-tab ${R==="alerts"?"active":""}`,onClick:()=>M("alerts"),children:[n.jsx("div",{style:{fontSize:"1.4rem",minWidth:"28px",flexShrink:"0"},children:"🚨"}),n.jsxs("div",{style:{flex:"1",textAlign:"left"},children:[n.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"700",marginBottom:"3px"},children:"Alerts"}),n.jsxs("div",{style:{fontSize:"0.9rem",opacity:"0.85"},children:[j.length," notifications"]})]})]}),n.jsxs("button",{className:`ai-tab ${R==="recommendations"?"active":""}`,onClick:()=>M("recommendations"),children:[n.jsx("div",{style:{fontSize:"1.4rem",minWidth:"28px",flexShrink:"0"},children:"💡"}),n.jsxs("div",{style:{flex:"1",textAlign:"left"},children:[n.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"700",marginBottom:"3px"},children:"Tips"}),n.jsxs("div",{style:{fontSize:"0.9rem",opacity:"0.85"},children:[w.length," suggestions"]})]})]}),n.jsxs("button",{className:`ai-tab ${R==="predictions"?"active":""}`,onClick:()=>M("predictions"),children:[n.jsx("div",{style:{fontSize:"1.4rem",minWidth:"28px",flexShrink:"0"},children:"🔮"}),n.jsxs("div",{style:{flex:"1",textAlign:"left"},children:[n.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"700",marginBottom:"3px"},children:"Predictions"}),n.jsx("div",{style:{fontSize:"0.9rem",opacity:"0.85"},children:"AI forecasts"})]})]})]}),ne&&n.jsx("div",{className:"loading-spinner",children:n.jsx("div",{className:"spinner"})}),!ne&&n.jsxs(n.Fragment,{children:[R==="insights"&&n.jsx("div",{children:m.length===0?n.jsxs("div",{className:"empty-state",children:[n.jsx("div",{className:"empty-state-icon",children:"💡"}),n.jsx("h5",{children:"No insights yet"}),n.jsx("p",{children:"Add more transactions to get personalized insights!"})]}):m.map((E,Q)=>n.jsxs("div",{className:`insight-card ${E.type}`,children:[n.jsxs("div",{className:"card-header",children:[n.jsx("h6",{className:"card-title",children:E.title}),n.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[n.jsxs("span",{className:"confidence-badge",children:[E.confidence,"% confident"]}),E.priority&&n.jsx("span",{className:`priority-badge priority-${E.priority}`,children:E.priority})]})]}),n.jsx("div",{className:"card-content",children:E.message}),E.actionable&&n.jsx("button",{className:"action-btn",onClick:()=>we(E.action),children:E.action})]},Q))}),R==="alerts"&&n.jsx("div",{children:j.length===0?n.jsxs("div",{className:"empty-state",children:[n.jsx("div",{className:"empty-state-icon",children:"🚨"}),n.jsx("h5",{children:"No alerts"}),n.jsx("p",{children:"You're doing great! No urgent alerts at the moment."})]}):j.map((E,Q)=>n.jsxs("div",{className:`alert-card ${E.type}`,children:[n.jsxs("div",{className:"card-header",children:[n.jsx("h6",{className:"card-title",children:E.title}),n.jsx("small",{style:{color:d?"#a0aec0":"#718096"},children:E.timestamp.toLocaleDateString()})]}),n.jsx("div",{className:"card-content",children:E.message})]},Q))}),R==="recommendations"&&n.jsx("div",{children:w.length===0?n.jsxs("div",{className:"empty-state",children:[n.jsx("div",{className:"empty-state-icon",children:"💡"}),n.jsx("h5",{children:"No recommendations yet"}),n.jsx("p",{children:"Keep using the app to get personalized recommendations!"})]}):w.map((E,Q)=>n.jsxs("div",{className:"recommendation-card",children:[n.jsxs("div",{className:"card-header",children:[n.jsx("h6",{className:"card-title",children:E.title}),n.jsxs("div",{style:{display:"flex",gap:"8px"},children:[n.jsxs("span",{className:`priority-badge priority-${E.impact==="high"?"high":E.impact==="medium"?"medium":"low"}`,children:[E.impact," impact"]}),n.jsxs("span",{className:`priority-badge priority-${E.effort==="high"?"high":E.effort==="medium"?"medium":"low"}`,children:[E.effort," effort"]})]})]}),n.jsx("div",{className:"card-content",children:E.description}),n.jsxs("small",{style:{color:d?"#a0aec0":"#718096"},children:["Category: ",E.category]})]},Q))}),R==="predictions"&&n.jsxs("div",{className:"predictions-grid",children:[n.jsxs("div",{className:"prediction-card",children:[n.jsx("div",{className:"prediction-label",children:"Next Month Spending"}),n.jsxs("div",{className:"prediction-value",children:["$",((Oe=K.nextMonthSpending)==null?void 0:Oe.toFixed(2))||"0.00"]}),n.jsx("small",{style:{color:d?"#a0aec0":"#718096"},children:"Based on your recent patterns"})]}),n.jsxs("div",{className:"prediction-card",children:[n.jsx("div",{className:"prediction-label",children:"Budget Runway"}),n.jsxs("div",{className:"prediction-value",children:[K.budgetRunway||0," months"]}),n.jsx("small",{style:{color:d?"#a0aec0":"#718096"},children:"At current spending rate"})]}),n.jsxs("div",{className:"prediction-card",children:[n.jsx("div",{className:"prediction-label",children:"Savings Trend"}),n.jsx("div",{className:"prediction-value",style:{color:K.nextMonthSpending<r*.8?"#10b981":"#ef4444"},children:K.nextMonthSpending<r*.8?"📈 Good":"📉 Review"}),n.jsx("small",{style:{color:d?"#a0aec0":"#718096"},children:"Based on budget vs spending"})]})]})]})]})};Dc.register(qm,Ym,Vm,Mm,Km,Jm,Xm,Zm,Qm,ex);function q1({transactions:s=[],balance:i=0,totalAmount:r,darkMode:o,formatCurrency:c,goals:d,setGoals:u,formatDate:m,goalsProgress:g,setGoalsProgress:j,totalBudgetAmount:v,parseDate:w,setItems:I,setBalances:K,setCashOnHand:T,setBankAccountBalance:k,setSavings:A,setTransactions:q,setAmounts:V,addedInvestments:R,setAddedInvestments:M}){var It;const ne=ur();y.useState([]);const[pe,we]=y.useState(0),[be,ve]=y.useState(null),[Oe,E]=y.useState(""),[Q,se]=y.useState("line"),[P,Z]=y.useState("all"),[oe,Te]=y.useState(!0),[ke,Ne]=y.useState("all"),[D,le]=y.useState(null),[fe,G]=y.useState(!1),[re,ie]=y.useState(!0),[ue,$e]=y.useState(null),[Ge,ee]=y.useState("cards"),[J,Ae]=y.useState(!0),[ze,Pt]=y.useState(!1),[Ie,dt]=y.useState(null),[Ze,ut]=y.useState("cards"),[lt,On]=y.useState(!0),[Ke,Je]=y.useState(!1);R.reduce((b,L)=>b+parseFloat(L.total_price),0).toFixed(2);const ft=g.reduce((b,L)=>b+parseFloat(L.saved||0),0),mt=v+parseFloat(pe)+i+ft-r,yn=(b,L)=>{const O=new Date;return b.filter(ye=>{const _e=new Date(ye.date);switch(L){case"week":return O-_e<=7*24*60*60*1e3;case"month":return O-_e<=30*24*60*60*1e3;case"3months":return O-_e<=90*24*60*60*1e3;default:return!0}})},Ot=(b,L)=>L==="all"?b:b.filter(O=>O.category&&O.category.toLowerCase()===L.toLowerCase()),gn=s.sort((b,L)=>new Date(b.date)-new Date(L.date)),ct=Ot(yn(gn,P),ke),pt=ct.map(b=>({...b,date:m(w(b.date))})),rn=["all",...new Set(s.map(b=>b.category).filter(Boolean))];y.useEffect(()=>{console.log("Loaded from Goal.jsx component"),ge.get("http://localhost:5001/goals").then(b=>{const L=b.data.map(O=>({...O,progress:O.saved/O.target*100}));j(L)}).catch(b=>{console.error("Error fetching goals:",b)})},[]),y.useEffect(()=>{console.log("Loaded from Budget.jsx component"),ge.get("http://localhost:5001/budgets").then(b=>{const L=b.data.map(O=>({...O,date:w(O.date)}));I(L)}).catch(b=>{console.error("Error fetching budgets:",b)})},[]),y.useEffect(()=>{console.log("Loaded from Balance.jsx component"),ge.get("http://localhost:5001/balance").then(b=>{if(Array.isArray(b.data)){const L=b.data.map(O=>({...O,total:O.cash_on_hand+O.bank_account_balance+O.savings,id:O.id}));if(K(L),L.length>0){const O=L[0];T(O.cash_on_hand),k(O.bank_account_balance),A(O.savings)}}else if(b.data&&typeof b.data=="object"){const L={...b.data,total:b.data.cash_on_hand+b.data.bank_account_balance+b.data.savings};K([L]),T(L.cash_on_hand),k(L.bank_account_balance),A(L.savings)}else console.error("Fetched data is not an array or object:",b.data)}).catch(b=>{console.error("Error fetching balances:",b)})},[]),y.useEffect(()=>{console.log("TRANSACTIONS COMPONENT"),console.log("Fetching transactions..."),ge.get("http://127.0.0.1:5001/transactions").then(b=>{console.log("Fetched transactions:",b.data),q(b.data)}).catch(b=>console.log("Error fetching transactions",b))},[]),y.useEffect(()=>{ge.get("http://localhost:5001/investments").then(b=>{console.log("Fetched from Investments:",b.data),M(b.data),At(b.data)}).catch(b=>console.log("Error fetching investments",b))},[]);const At=b=>{const L=b.reduce((O,Y)=>O+Y.total_price,0);we(L)};y.useEffect(()=>{At(R)},[R]);const qt=b=>{if(!R||!R[b]){console.error("Investment not found");return}const L=R[b].id;ge.delete(`http://localhost:5001/investments/${L}`).then(O=>{if(O.status===204){const Y=R.filter((ye,_e)=>_e!==b);M(Y)}else console.error("Failed to delete the investment")}).catch(O=>{console.error("Error:",O)})},H=b=>{ve(b),E(R[b].amount)},X=b=>{const L=[...R],O=L[b],Y=parseFloat(Oe);isNaN(Y)?console.error("Invalid amount:",Oe):(O.amount=Y,O.pricePerUnit?O.total_price=Y*O.pricePerUnit:console.error("pricePerUnit is not defined for investment:",O),ge.put(`http://localhost:5001/investments/${O.id}`,{amount:O.amount,totalPrice:O.total_price}).then(ye=>{M(L),ve(null),E("")}).catch(ye=>{console.error("Error updating investment:",ye)}))},ce=()=>{ve(null),E("")},Be=(()=>{const b=pt.map(Y=>Y.date),L=pt.map(Y=>parseFloat(Y.amount)),O={labels:b,datasets:[{label:"Transaction Amount ($)",data:L,borderColor:o?"rgba(255, 193, 7, 1)":"rgba(54, 162, 235, 1)",backgroundColor:o?"rgba(255, 193, 7, 0.2)":"rgba(54, 162, 235, 0.2)",borderWidth:3,pointRadius:6,pointHoverRadius:8,pointBackgroundColor:o?"rgba(255, 193, 7, 1)":"rgba(54, 162, 235, 1)",pointBorderColor:"#fff",pointBorderWidth:2,tension:.4,fill:Q==="line"}]};if(Q==="bar")O.datasets[0].backgroundColor=L.map((Y,ye)=>`hsla(${ye*137.5%360}, 70%, 60%, 0.8)`),O.datasets[0].borderColor=L.map((Y,ye)=>`hsla(${ye*137.5%360}, 70%, 50%, 1)`);else if(Q==="doughnut"){const Y={};return pt.forEach(ye=>{const _e=ye.category||"Uncategorized";Y[_e]=(Y[_e]||0)+parseFloat(ye.amount)}),{labels:Object.keys(Y),datasets:[{label:"Amount by Category ($)",data:Object.values(Y),backgroundColor:Object.keys(Y).map((ye,_e)=>`hsla(${_e*137.5%360}, 70%, 60%, 0.8)`),borderColor:Object.keys(Y).map((ye,_e)=>`hsla(${_e*137.5%360}, 70%, 50%, 1)`),borderWidth:2,hoverOffset:4}]}}return O})(),We=(()=>{const b={responsive:!0,maintainAspectRatio:!1,animation:{duration:oe?1e3:0,easing:"easeInOutQuart"},interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!0,position:"top",labels:{color:o?"#fff":"#000",usePointStyle:!0,padding:20,font:{size:12,weight:"bold"}}},tooltip:{backgroundColor:o?"rgba(51, 51, 51, 0.9)":"rgba(255, 255, 255, 0.9)",titleColor:o?"#fff":"#000",bodyColor:o?"#fff":"#000",borderColor:o?"#ffc107":"#007bff",borderWidth:1,cornerRadius:8,displayColors:!0,callbacks:{title:function(L){return Q==="doughnut"?"Category Breakdown":`Date: ${L[0].label}`},label:function(L){if(Q==="doughnut"){const O=L.dataset.data.reduce((ye,_e)=>ye+_e,0),Y=(L.raw/O*100).toFixed(1);return`${L.label}: $${L.raw.toFixed(2)} (${Y}%)`}else{const O=pt[L.dataIndex];return[`Amount: $${L.raw}`,`Description: ${(O==null?void 0:O.description)||"No Description"}`,`Category: ${(O==null?void 0:O.category)||"Uncategorized"}`]}}}}},onClick:(L,O)=>{if(O.length>0){const Y=O[0].index;if(Q!=="doughnut"){const ye=pt[Y];console.log("Clicked transaction:",ye)}}}};return Q!=="doughnut"&&(b.scales={x:{title:{display:!0,text:"Date",color:o?"#fff":"#000",font:{size:14,weight:"bold"}},ticks:{color:o?"#fff":"#000",maxTicksLimit:10},grid:{color:o?"rgba(255, 255, 255, 0.1)":"rgba(0, 0, 0, 0.1)"}},y:{title:{display:!0,text:"Amount ($)",color:o?"#fff":"#000",font:{size:14,weight:"bold"}},ticks:{color:o?"#fff":"#000",callback:function(L){return"$"+L.toFixed(2)}},grid:{color:o?"rgba(255, 255, 255, 0.1)":"rgba(0, 0, 0, 0.1)"}}}),b})(),He={labels:["Budget","Balance","Goals Saved","Investments","X-penses"],datasets:[{label:"Financial Overview ($)",data:[v,i,ft,pe,r],backgroundColor:["rgba(40, 167, 69, 0.8)","rgba(23, 162, 184, 0.8)","rgba(255, 193, 7, 0.8)","rgba(108, 117, 125, 0.8)","rgba(220, 53, 69, 0.8)"],borderColor:["rgba(40, 167, 69, 1)","rgba(23, 162, 184, 1)","rgba(255, 193, 7, 1)","rgba(108, 117, 125, 1)","rgba(220, 53, 69, 1)"],borderWidth:2,hoverOffset:10}]},Ft={responsive:!0,maintainAspectRatio:!1,animation:{duration:re?1200:0,easing:"easeInOutBounce"},plugins:{legend:{display:!0,position:"bottom",labels:{color:o?"#fff":"#000",usePointStyle:!0,padding:15,font:{size:11,weight:"bold"}}},tooltip:{backgroundColor:o?"rgba(51, 51, 51, 0.9)":"rgba(255, 255, 255, 0.9)",titleColor:o?"#fff":"#000",bodyColor:o?"#fff":"#000",borderColor:o?"#ffc107":"#007bff",borderWidth:2,cornerRadius:8,callbacks:{label:function(b){const L=mt,O=L!==0?(b.raw/Math.abs(L)*100).toFixed(1):"0.0";return`${b.label}: $${b.raw.toFixed(2)} (${O}%)`}}}},onClick:(b,L)=>{if(L.length>0){const O=L[0].index;le(["Budget","Balance","Goals Saved","Investments","X-penses"][O])}}},St=b=>({Budget:"#28a745",Balance:"#17a2b8","X-penses":"#dc3545","Goals (saved)":"#ffc107",Investments:"#6c757d","Overview Total":o?"#ffffff":"#000000"})[b]||(o?"#ffffff":"#000000"),an=b=>({Budget:"💰",Balance:"💳","X-penses":"💸","Goals (saved)":"🎯",Investments:"📈","Overview Total":"📊"})[b]||"📋",Yt=(b,L)=>b>=100?"#28a745":b>=75?"#17a2b8":b>=50?"#ffc107":b>=25?"#fd7e14":"#dc3545",wn=(b,L)=>b>=100?"🎉":b>=75?"🔥":b>=50?"⭐":b>=25?"📈":"🚀",Fn=b=>b>=100?"Completed! 🎉":b>=75?"Almost there! 🔥":b>=50?"Halfway! ⭐":b>=25?"Good start! 📈":"Just started 🚀",Jn={labels:g.map(b=>b.name),datasets:[{label:"Goals Progress (%)",data:g.map(b=>b.saved/b.target*100),backgroundColor:g.map((b,L)=>{const O=b.saved/b.target*100;return Yt(O)+"80"}),borderColor:g.map((b,L)=>{const O=b.saved/b.target*100;return Yt(O)}),borderWidth:2,hoverOffset:8}]},In={responsive:!0,maintainAspectRatio:!1,animation:{duration:J?1500:0,easing:"easeInOutElastic"},plugins:{legend:{display:!0,position:"bottom",labels:{color:o?"#fff":"#000",usePointStyle:!0,padding:12,font:{size:10,weight:"bold"}}},tooltip:{backgroundColor:o?"rgba(51, 51, 51, 0.9)":"rgba(255, 255, 255, 0.9)",titleColor:o?"#fff":"#000",bodyColor:o?"#fff":"#000",borderColor:o?"#ffc107":"#007bff",borderWidth:2,cornerRadius:8,callbacks:{label:function(b){const L=g[b.dataIndex];return[`Progress: ${b.raw.toFixed(1)}%`,`Saved: $${L.saved.toFixed(2)}`,`Target: $${L.target.toFixed(2)}`,`Remaining: $${(L.target-L.saved).toFixed(2)}`]}}}},onClick:(b,L)=>{if(L.length>0){const O=L[0].index,Y=g[O];$e((ue==null?void 0:ue.id)===Y.id?null:Y)}}},sn=(b,L)=>{const O={bitcoin:"#f7931a",btc:"#f7931a",ethereum:"#627eea",eth:"#627eea",usdc:"#2775ca",xrp:"#23292f",ripple:"#23292f",cardano:"#0033ad",ada:"#0033ad",solana:"#9945ff",sol:"#9945ff"},Y=b.name.toLowerCase();for(const _e in O)if(Y.includes(_e))return O[_e];const ye=["#28a745","#17a2b8","#ffc107","#fd7e14","#dc3545","#6f42c1","#e83e8c","#20c997"];return ye[L%ye.length]},Vt=b=>{const L=b.name.toLowerCase(),O={bitcoin:"₿",btc:"₿",ethereum:"Ξ",eth:"Ξ",usdc:"💵",xrp:"🌊",ripple:"🌊",cardano:"🎴",ada:"🎴",solana:"☀️",sol:"☀️"};for(const Y in O)if(L.includes(Y))return O[Y];return"🪙"},on=b=>Math.random()*20-10,Mt=b=>b>5?{label:"Strong Gain! 🚀",class:"success"}:b>0?{label:"Gaining 📈",class:"success"}:b>-5?{label:"Stable 📊",class:"warning"}:{label:"Down 📉",class:"danger"},Xn={labels:R.map(b=>b.name),datasets:[{label:"Investment Value ($)",data:R.map(b=>b.total_price),backgroundColor:R.map((b,L)=>sn(b,L)+"80"),borderColor:R.map((b,L)=>sn(b,L)),borderWidth:3,hoverOffset:12,hoverBorderWidth:4}]},jn={responsive:!0,maintainAspectRatio:!1,animation:{duration:lt?1800:0,easing:"easeInOutBack"},plugins:{legend:{display:!0,position:"bottom",labels:{color:o?"#fff":"#000",usePointStyle:!0,padding:15,font:{size:11,weight:"bold"},generateLabels:function(b){return Dc.defaults.plugins.legend.labels.generateLabels.call(this,b).map((Y,ye)=>{const _e=R[ye];return Y.text=`${Vt(_e)} ${Y.text}`,Y})}}},tooltip:{backgroundColor:o?"rgba(51, 51, 51, 0.9)":"rgba(255, 255, 255, 0.9)",titleColor:o?"#fff":"#000",bodyColor:o?"#fff":"#000",borderColor:o?"#ffc107":"#007bff",borderWidth:2,cornerRadius:10,callbacks:{title:function(b){const L=R[b[0].dataIndex];return`${Vt(L)} ${L.name}`},label:function(b){var Y;const L=R[b.dataIndex],O=on();return[`Value: $${b.raw.toFixed(2)}`,`Amount: ${L.amount}`,`Price per unit: $${((Y=L.pricePerUnit)==null?void 0:Y.toFixed(2))||"N/A"}`,`Performance: ${O.toFixed(2)}%`,`Status: ${Mt(O).label}`]}}}},onClick:(b,L)=>{if(L.length>0){const O=L[0].index,Y=R[O];dt((Ie==null?void 0:Ie.id)===Y.id?null:Y)}}};return n.jsxs("div",{className:`container-fluid ${o?"dark-mode":"light-mode"}`,children:[n.jsx("style",{children:`
        .dashboard-header {
          text-align: center;
          margin-bottom: 30px;
          padding: 30px;
 ...
 */var M1=Kr.exports,Uc;function K1(){return Uc||(Uc=1,function(s,i){(function(){var r,o="4.17.21",c=200,d="Unsupported core-js use. Try https://npms.io/search?q=ponyfill.",u="Expected a function",m="Invalid `variable` option passed into `_.template`",g="__lodash_hash_undefined__",j=500,v="__lodash_placeholder__",w=1,I=2,K=4,T=1,k=2,A=1,q=2,V=4,R=8,M=16,ne=32,pe=64,we=128,be=256,ve=512,Oe=30,E="...",Q=800,se=16,P=1,Z=2,oe=3,Te=1/0,ke=9007199254740991,Ne=17976931348623157e292,D=NaN,le=4294967295,fe=le-1,G=le>>>1,re=[["ary",we],["bind",A],["bindKey",q],["curry",R],["curryRight",M],["flip",ve],["partial",ne],["partialRight",pe],["rearg",be]],ie="[object Arguments]",ue="[object Array]",$e="[object AsyncFunction]",Ge="[object Boolean]",ee="[object Date]",J="[object DOMException]",Ae="[object Error]",ze="[object Function]",Pt="[object GeneratorFunction]",Ie="[object Map]",dt="[object Number]",Ze="[object Null]",ut="[object Object]",lt="[object Promise]",On="[object Proxy]",Ke="[object RegExp]",Je="[object Set]",ft="[object String]",mt="[object Symbol]",yn="[object Undefined]",Ot="[object WeakMap]",gn="[object WeakSet]",ct="[object ArrayBuffer]",pt="[object DataView]",rn="[object Float32Array]",At="[object Float64Array]",qt="[object Int8Array]",H="[object Int16Array]",X="[object Int32Array]",ce="[object Uint8Array]",je="[object Uint8ClampedArray]",Be="[object Uint16Array]",tt="[object Uint32Array]",We=/\b__p \+= '';/g,He=/\b(__p \+=) '' \+/g,Ft=/(__e\(.*?\)|\b__t\)) \+\n'';/g,St=/&(?:amp|lt|gt|quot|#39);/g,an=/[&<>"']/g,Yt=RegExp(St.source),wn=RegExp(an.source),Fn=/<%-([\s\S]+?)%>/g,Jn=/<%([\s\S]+?)%>/g,In=/<%=([\s\S]+?)%>/g,sn=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,Vt=/^\w*$/,on=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,Mt=/[\\^$.*+?()[\]{}|]/g,Xn=RegExp(Mt.source),jn=/^\s+/,It=/\s/,b=/\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/,L=/\{\n\/\* \[wrapped with (.+)\] \*/,O=/,? & /,Y=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g,ye=/[()=,{}\[\]\/\s]/,_e=/\\(\\)?/g,qe=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,_=/\w*$/,Lt=/^[-+]0x[0-9a-f]+$/i,ln=/^0b[01]+$/i,Ws=/^\[object .+?Constructor\]$/,di=/^0o[0-7]+$/i,$d=/^(?:0|[1-9]\d*)$/,Pd=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,ta=/($^)/,Od=/['\n\r\u2028\u2029\\]/g,na="\\ud800-\\udfff",Fd="\\u0300-\\u036f",Id="\\ufe20-\\ufe2f",Ld="\\u20d0-\\u20ff",Hs=Fd+Id+Ld,Gs="\\u2700-\\u27bf",qs="a-z\\xdf-\\xf6\\xf8-\\xff",Ud="\\xac\\xb1\\xd7\\xf7",Dd="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",Bd="\\u2000-\\u206f",zd=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",Ys="A-Z\\xc0-\\xd6\\xd8-\\xde",Vs="\\ufe0e\\ufe0f",Ms=Ud+Dd+Bd+zd,ui="['’]",Wd="["+na+"]",Ks="["+Ms+"]",ra="["+Hs+"]",Js="\\d+",Hd="["+Gs+"]",Xs="["+qs+"]",Zs="[^"+na+Ms+Js+Gs+qs+Ys+"]",fi="\\ud83c[\\udffb-\\udfff]",Gd="(?:"+ra+"|"+fi+")",Qs="[^"+na+"]",pi="(?:\\ud83c[\\udde6-\\uddff]){2}",hi="[\\ud800-\\udbff][\\udc00-\\udfff]",fr="["+Ys+"]",eo="\\u200d",to="(?:"+Xs+"|"+Zs+")",qd="(?:"+fr+"|"+Zs+")",no="(?:"+ui+"(?:d|ll|m|re|s|t|ve))?",ro="(?:"+ui+"(?:D|LL|M|RE|S|T|VE))?",ao=Gd+"?",io="["+Vs+"]?",Yd="(?:"+eo+"(?:"+[Qs,pi,hi].join("|")+")"+io+ao+")*",Vd="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",Md="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",so=io+ao+Yd,Kd="(?:"+[Hd,pi,hi].join("|")+")"+so,Jd="(?:"+[Qs+ra+"?",ra,pi,hi,Wd].join("|")+")",Xd=RegExp(ui,"g"),Zd=RegExp(ra,"g"),gi=RegExp(fi+"(?="+fi+")|"+Jd+so,"g"),Qd=RegExp([fr+"?"+Xs+"+"+no+"(?="+[Ks,fr,"$"].join("|")+")",qd+"+"+ro+"(?="+[Ks,fr+to,"$"].join("|")+")",fr+"?"+to+"+"+no,fr+"+"+ro,Md,Vd,Js,Kd].join("|"),"g"),eu=RegExp("["+eo+na+Hs+Vs+"]"),tu=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/,nu=["Array","Buffer","DataView","Date","Error","Float32Array","Float64Array","Function","Int8Array","Int16Array","Int32Array","Map","Math","Object","Promise","RegExp","Set","String","Symbol","TypeError","Uint8Array","Uint8ClampedArray","Uint16Array","Uint32Array","WeakMap","_","clearTimeout","isFinite","parseInt","setTimeout"],ru=-1,et={};et[rn]=et[At]=et[qt]=et[H]=et[X]=et[ce]=et[je]=et[Be]=et[tt]=!0,et[ie]=et[ue]=et[ct]=et[Ge]=et[pt]=et[ee]=et[Ae]=et[ze]=et[Ie]=et[dt]=et[ut]=et[Ke]=et[Je]=et[ft]=et[Ot]=!1;var Qe={};Qe[ie]=Qe[ue]=Qe[ct]=Qe[pt]=Qe[Ge]=Qe[ee]=Qe[rn]=Qe[At]=Qe[qt]=Qe[H]=Qe[X]=Qe[Ie]=Qe[dt]=Qe[ut]=Qe[Ke]=Qe[Je]=Qe[ft]=Qe[mt]=Qe[ce]=Qe[je]=Qe[Be]=Qe[tt]=!0,Qe[Ae]=Qe[ze]=Qe[Ot]=!1;var au={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},iu={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},su={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'"},ou={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"},lu=parseFloat,cu=parseInt,oo=typeof Ha=="object"&&Ha&&Ha.Object===Object&&Ha,du=typeof self=="object"&&self&&self.Object===Object&&self,bt=oo||du||Function("return this")(),mi=i&&!i.nodeType&&i,Zn=mi&&!0&&s&&!s.nodeType&&s,lo=Zn&&Zn.exports===mi,xi=lo&&oo.process,Kt=function(){try{var N=Zn&&Zn.require&&Zn.require("util").types;return N||xi&&xi.binding&&xi.binding("util")}catch{}}(),co=Kt&&Kt.isArrayBuffer,uo=Kt&&Kt.isDate,fo=Kt&&Kt.isMap,po=Kt&&Kt.isRegExp,ho=Kt&&Kt.isSet,go=Kt&&Kt.isTypedArray;function Ut(N,U,$){switch($.length){case 0:return N.call(U);case 1:return N.call(U,$[0]);case 2:return N.call(U,$[0],$[1]);case 3:return N.call(U,$[0],$[1],$[2])}return N.apply(U,$)}function uu(N,U,$,ae){for(var Se=-1,Ye=N==null?0:N.length;++Se<Ye;){var ht=N[Se];U(ae,ht,$(ht),N)}return ae}function Jt(N,U){for(var $=-1,ae=N==null?0:N.length;++$<ae&&U(N[$],$,N)!==!1;);return N}function fu(N,U){for(var $=N==null?0:N.length;$--&&U(N[$],$,N)!==!1;);return N}function mo(N,U){for(var $=-1,ae=N==null?0:N.length;++$<ae;)if(!U(N[$],$,N))return!1;return!0}function Ln(N,U){for(var $=-1,ae=N==null?0:N.length,Se=0,Ye=[];++$<ae;){var ht=N[$];U(ht,$,N)&&(Ye[Se++]=ht)}return Ye}function aa(N,U){var $=N==null?0:N.length;return!!$&&pr(N,U,0)>-1}function bi(N,U,$){for(var ae=-1,Se=N==null?0:N.length;++ae<Se;)if($(U,N[ae]))return!0;return!1}function nt(N,U){for(var $=-1,ae=N==null?0:N.length,Se=Array(ae);++$<ae;)Se[$]=U(N[$],$,N);return Se}function Un(N,U){for(var $=-1,ae=U.length,Se=N.length;++$<ae;)N[Se+$]=U[$];return N}function vi(N,U,$,ae){var Se=-1,Ye=N==null?0:N.length;for(ae&&Ye&&($=N[++Se]);++Se<Ye;)$=U($,N[Se],Se,N);return $}function pu(N,U,$,ae){var Se=N==null?0:N.length;for(ae&&Se&&($=N[--Se]);Se--;)$=U($,N[Se],Se,N);return $}function yi(N,U){for(var $=-1,ae=N==null?0:N.length;++$<ae;)if(U(N[$],$,N))return!0;return!1}var hu=wi("length");function gu(N){return N.split("")}function mu(N){return N.match(Y)||[]}function xo(N,U,$){var ae;return $(N,function(Se,Ye,ht){if(U(Se,Ye,ht))return ae=Ye,!1}),ae}function ia(N,U,$,ae){for(var Se=N.length,Ye=$+(ae?1:-1);ae?Ye--:++Ye<Se;)if(U(N[Ye],Ye,N))return Ye;return-1}function pr(N,U,$){return U===U?Eu(N,U,$):ia(N,bo,$)}function xu(N,U,$,ae){for(var Se=$-1,Ye=N.length;++Se<Ye;)if(ae(N[Se],U))return Se;return-1}function bo(N){return N!==N}function vo(N,U){var $=N==null?0:N.length;return $?Si(N,U)/$:D}function wi(N){return function(U){return U==null?r:U[N]}}function ji(N){return function(U){return N==null?r:N[U]}}function yo(N,U,$,ae,Se){return Se(N,function(Ye,ht,Xe){$=ae?(ae=!1,Ye):U($,Ye,ht,Xe)}),$}function bu(N,U){var $=N.length;for(N.sort(U);$--;)N[$]=N[$].value;return N}function Si(N,U){for(var $,ae=-1,Se=N.length;++ae<Se;){var Ye=U(N[ae]);Ye!==r&&($=$===r?Ye:$+Ye)}return $}function Ni(N,U){for(var $=-1,ae=Array(N);++$<N;)ae[$]=U($);return ae}function vu(N,U){return nt(U,function($){return[$,N[$]]})}function wo(N){return N&&N.slice(0,_o(N)+1).replace(jn,"")}function Dt(N){return function(U){return N(U)}}function _i(N,U){return nt(U,function($){return N[$]})}function $r(N,U){return N.has(U)}function jo(N,U){for(var $=-1,ae=N.length;++$<ae&&pr(U,N[$],0)>-1;);return $}function So(N,U){for(var $=N.length;$--&&pr(U,N[$],0)>-1;);return $}function yu(N,U){for(var $=N.length,ae=0;$--;)N[$]===U&&++ae;return ae}var wu=ji(au),ju=ji(iu);function Su(N){return"\\"+ou[N]}function Nu(N,U){return N==null?r:N[U]}function hr(N){return eu.test(N)}function _u(N){return tu.test(N)}function Cu(N){for(var U,$=[];!(U=N.next()).done;)$.push(U.value);return $}function Ci(N){var U=-1,$=Array(N.size);return N.forEach(function(ae,Se){$[++U]=[Se,ae]}),$}function No(N,U){return function($){return N(U($))}}function Dn(N,U){for(var $=-1,ae=N.length,Se=0,Ye=[];++$<ae;){var ht=N[$];(ht===U||ht===v)&&(N[$]=v,Ye[Se++]=$)}return Ye}function sa(N){var U=-1,$=Array(N.size);return N.forEach(function(ae){$[++U]=ae}),$}function Au(N){var U=-1,$=Array(N.size);return N.forEach(function(ae){$[++U]=[ae,ae]}),$}function Eu(N,U,$){for(var ae=$-1,Se=N.length;++ae<Se;)if(N[ae]===U)return ae;return-1}function Tu(N,U,$){for(var ae=$+1;ae--;)if(N[ae]===U)return ae;return ae}function gr(N){return hr(N)?ku(N):hu(N)}function cn(N){return hr(N)?$u(N):gu(N)}function _o(N){for(var U=N.length;U--&&It.test(N.charAt(U)););return U}var Ru=ji(su);function ku(N){for(var U=gi.lastIndex=0;gi.test(N);)++U;return U}function $u(N){return N.match(gi)||[]}function Pu(N){return N.match(Qd)||[]}var Ou=function N(U){U=U==null?bt:mr.defaults(bt.Object(),U,mr.pick(bt,nu));var $=U.Array,ae=U.Date,Se=U.Error,Ye=U.Function,ht=U.Math,Xe=U.Object,Ai=U.RegExp,Fu=U.String,Xt=U.TypeError,oa=$.prototype,Iu=Ye.prototype,xr=Xe.prototype,la=U["__core-js_shared__"],ca=Iu.toString,Me=xr.hasOwnProperty,Lu=0,Co=function(){var e=/[^.]+$/.exec(la&&la.keys&&la.keys.IE_PROTO||"");return e?"Symbol(src)_1."+e:""}(),da=xr.toString,Uu=ca.call(Xe),Du=bt._,Bu=Ai("^"+ca.call(Me).replace(Mt,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),ua=lo?U.Buffer:r,Bn=U.Symbol,fa=U.Uint8Array,Ao=ua?ua.allocUnsafe:r,pa=No(Xe.getPrototypeOf,Xe),Eo=Xe.create,To=xr.propertyIsEnumerable,ha=oa.splice,Ro=Bn?Bn.isConcatSpreadable:r,Pr=Bn?Bn.iterator:r,Qn=Bn?Bn.toStringTag:r,ga=function(){try{var e=ar(Xe,"defineProperty");return e({},"",{}),e}catch{}}(),zu=U.clearTimeout!==bt.clearTimeout&&U.clearTimeout,Wu=ae&&ae.now!==bt.Date.now&&ae.now,Hu=U.setTimeout!==bt.setTimeout&&U.setTimeout,ma=ht.ceil,xa=ht.floor,Ei=Xe.getOwnPropertySymbols,Gu=ua?ua.isBuffer:r,ko=U.isFinite,qu=oa.join,Yu=No(Xe.keys,Xe),gt=ht.max,yt=ht.min,Vu=ae.now,Mu=U.parseInt,$o=ht.random,Ku=oa.reverse,Ti=ar(U,"DataView"),Or=ar(U,"Map"),Ri=ar(U,"Promise"),br=ar(U,"Set"),Fr=ar(U,"WeakMap"),Ir=ar(Xe,"create"),ba=Fr&&new Fr,vr={},Ju=ir(Ti),Xu=ir(Or),Zu=ir(Ri),Qu=ir(br),ef=ir(Fr),va=Bn?Bn.prototype:r,Lr=va?va.valueOf:r,Po=va?va.toString:r;function p(e){if(it(e)&&!Ce(e)&&!(e instanceof Ue)){if(e instanceof Zt)return e;if(Me.call(e,"__wrapped__"))return Ol(e)}return new Zt(e)}var yr=function(){function e(){}return function(t){if(!rt(t))return{};if(Eo)return Eo(t);e.prototype=t;var a=new e;return e.prototype=r,a}}();function ya(){}function Zt(e,t){this.__wrapped__=e,this.__actions__=[],this.__chain__=!!t,this.__index__=0,this.__values__=r}p.templateSettings={escape:Fn,evaluate:Jn,interpolate:In,variable:"",imports:{_:p}},p.prototype=ya.prototype,p.prototype.constructor=p,Zt.prototype=yr(ya.prototype),Zt.prototype.constructor=Zt;function Ue(e){this.__wrapped__=e,this.__actions__=[],this.__dir__=1,this.__filtered__=!1,this.__iteratees__=[],this.__takeCount__=le,this.__views__=[]}function tf(){var e=new Ue(this.__wrapped__);return e.__actions__=Et(this.__actions__),e.__dir__=this.__dir__,e.__filtered__=this.__filtered__,e.__iteratees__=Et(this.__iteratees__),e.__takeCount__=this.__takeCount__,e.__views__=Et(this.__views__),e}function nf(){if(this.__filtered__){var e=new Ue(this);e.__dir__=-1,e.__filtered__=!0}else e=this.clone(),e.__dir__*=-1;return e}function rf(){var e=this.__wrapped__.value(),t=this.__dir__,a=Ce(e),l=t<0,f=a?e.length:0,h=mp(0,f,this.__views__),x=h.start,S=h.end,C=S-x,B=l?S:x-1,z=this.__iteratees__,W=z.length,te=0,de=yt(C,this.__takeCount__);if(!a||!l&&f==C&&de==C)return rl(e,this.__actions__);var me=[];e:for(;C--&&te<de;){B+=t;for(var Pe=-1,xe=e[B];++Pe<W;){var Le=z[Pe],De=Le.iteratee,Wt=Le.type,Ct=De(xe);if(Wt==Z)xe=Ct;else if(!Ct){if(Wt==P)continue e;break e}}me[te++]=xe}return me}Ue.prototype=yr(ya.prototype),Ue.prototype.constructor=Ue;function er(e){var t=-1,a=e==null?0:e.length;for(this.clear();++t<a;){var l=e[t];this.set(l[0],l[1])}}function af(){this.__data__=Ir?Ir(null):{},this.size=0}function sf(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}function of(e){var t=this.__data__;if(Ir){var a=t[e];return a===g?r:a}return Me.call(t,e)?t[e]:r}function lf(e){var t=this.__data__;return Ir?t[e]!==r:Me.call(t,e)}function cf(e,t){var a=this.__data__;return this.size+=this.has(e)?0:1,a[e]=Ir&&t===r?g:t,this}er.prototype.clear=af,er.prototype.delete=sf,er.prototype.get=of,er.prototype.has=lf,er.prototype.set=cf;function Sn(e){var t=-1,a=e==null?0:e.length;for(this.clear();++t<a;){var l=e[t];this.set(l[0],l[1])}}function df(){this.__data__=[],this.size=0}function uf(e){var t=this.__data__,a=wa(t,e);if(a<0)return!1;var l=t.length-1;return a==l?t.pop():ha.call(t,a,1),--this.size,!0}function ff(e){var t=this.__data__,a=wa(t,e);return a<0?r:t[a][1]}function pf(e){return wa(this.__data__,e)>-1}function hf(e,t){var a=this.__data__,l=wa(a,e);return l<0?(++this.size,a.push([e,t])):a[l][1]=t,this}Sn.prototype.clear=df,Sn.prototype.delete=uf,Sn.prototype.get=ff,Sn.prototype.has=pf,Sn.prototype.set=hf;function Nn(e){var t=-1,a=e==null?0:e.length;for(this.clear();++t<a;){var l=e[t];this.set(l[0],l[1])}}function gf(){this.size=0,this.__data__={hash:new er,map:new(Or||Sn),string:new er}}function mf(e){var t=Pa(this,e).delete(e);return this.size-=t?1:0,t}function xf(e){return Pa(this,e).get(e)}function bf(e){return Pa(this,e).has(e)}function vf(e,t){var a=Pa(this,e),l=a.size;return a.set(e,t),this.size+=a.size==l?0:1,this}Nn.prototype.clear=gf,Nn.prototype.delete=mf,Nn.prototype.get=xf,Nn.prototype.has=bf,Nn.prototype.set=vf;function tr(e){var t=-1,a=e==null?0:e.length;for(this.__data__=new Nn;++t<a;)this.add(e[t])}function yf(e){return this.__data__.set(e,g),this}function wf(e){return this.__data__.has(e)}tr.prototype.add=tr.prototype.push=yf,tr.prototype.has=wf;function dn(e){var t=this.__data__=new Sn(e);this.size=t.size}function jf(){this.__data__=new Sn,this.size=0}function Sf(e){var t=this.__data__,a=t.delete(e);return this.size=t.size,a}function Nf(e){return this.__data__.get(e)}function _f(e){return this.__data__.has(e)}function Cf(e,t){var a=this.__data__;if(a instanceof Sn){var l=a.__data__;if(!Or||l.length<c-1)return l.push([e,t]),this.size=++a.size,this;a=this.__data__=new Nn(l)}return a.set(e,t),this.size=a.size,this}dn.prototype.clear=jf,dn.prototype.delete=Sf,dn.prototype.get=Nf,dn.prototype.has=_f,dn.prototype.set=Cf;function Oo(e,t){var a=Ce(e),l=!a&&sr(e),f=!a&&!l&&qn(e),h=!a&&!l&&!f&&Nr(e),x=a||l||f||h,S=x?Ni(e.length,Fu):[],C=S.length;for(var B in e)(t||Me.call(e,B))&&!(x&&(B=="length"||f&&(B=="offset"||B=="parent")||h&&(B=="buffer"||B=="byteLength"||B=="byteOffset")||En(B,C)))&&S.push(B);return S}function Fo(e){var t=e.length;return t?e[zi(0,t-1)]:r}function Af(e,t){return Oa(Et(e),nr(t,0,e.length))}function Ef(e){return Oa(Et(e))}function ki(e,t,a){(a!==r&&!un(e[t],a)||a===r&&!(t in e))&&_n(e,t,a)}function Ur(e,t,a){var l=e[t];(!(Me.call(e,t)&&un(l,a))||a===r&&!(t in e))&&_n(e,t,a)}function wa(e,t){for(var a=e.length;a--;)if(un(e[a][0],t))return a;return-1}function Tf(e,t,a,l){return zn(e,function(f,h,x){t(l,f,a(f),x)}),l}function Io(e,t){return e&&xn(t,xt(t),e)}function Rf(e,t){return e&&xn(t,Rt(t),e)}function _n(e,t,a){t=="__proto__"&&ga?ga(e,t,{configurable:!0,enumerable:!0,value:a,writable:!0}):e[t]=a}function $i(e,t){for(var a=-1,l=t.length,f=$(l),h=e==null;++a<l;)f[a]=h?r:fs(e,t[a]);return f}function nr(e,t,a){return e===e&&(a!==r&&(e=e<=a?e:a),t!==r&&(e=e>=t?e:t)),e}function Qt(e,t,a,l,f,h){var x,S=t&w,C=t&I,B=t&K;if(a&&(x=f?a(e,l,f,h):a(e)),x!==r)return x;if(!rt(e))return e;var z=Ce(e);if(z){if(x=bp(e),!S)return Et(e,x)}else{var W=wt(e),te=W==ze||W==Pt;if(qn(e))return sl(e,S);if(W==ut||W==ie||te&&!f){if(x=C||te?{}:_l(e),!S)return C?op(e,Rf(x,e)):sp(e,Io(x,e))}else{if(!Qe[W])return f?e:{};x=vp(e,W,S)}}h||(h=new dn);var de=h.get(e);if(de)return de;h.set(e,x),ec(e)?e.forEach(function(xe){x.add(Qt(xe,t,a,xe,e,h))}):Zl(e)&&e.forEach(function(xe,Le){x.set(Le,Qt(xe,t,a,Le,e,h))});var me=B?C?Zi:Xi:C?Rt:xt,Pe=z?r:me(e);return Jt(Pe||e,function(xe,Le){Pe&&(Le=xe,xe=e[Le]),Ur(x,Le,Qt(xe,t,a,Le,e,h))}),x}function kf(e){var t=xt(e);return function(a){return Lo(a,e,t)}}function Lo(e,t,a){var l=a.length;if(e==null)return!l;for(e=Xe(e);l--;){var f=a[l],h=t[f],x=e[f];if(x===r&&!(f in e)||!h(x))return!1}return!0}function Uo(e,t,a){if(typeof e!="function")throw new Xt(u);return qr(function(){e.apply(r,a)},t)}function Dr(e,t,a,l){var f=-1,h=aa,x=!0,S=e.length,C=[],B=t.length;if(!S)return C;a&&(t=nt(t,Dt(a))),l?(h=bi,x=!1):t.length>=c&&(h=$r,x=!1,t=new tr(t));e:for(;++f<S;){var z=e[f],W=a==null?z:a(z);if(z=l||z!==0?z:0,x&&W===W){for(var te=B;te--;)if(t[te]===W)continue e;C.push(z)}else h(t,W,l)||C.push(z)}return C}var zn=ul(mn),Do=ul(Oi,!0);function $f(e,t){var a=!0;return zn(e,function(l,f,h){return a=!!t(l,f,h),a}),a}function ja(e,t,a){for(var l=-1,f=e.length;++l<f;){var h=e[l],x=t(h);if(x!=null&&(S===r?x===x&&!zt(x):a(x,S)))var S=x,C=h}return C}function Pf(e,t,a,l){var f=e.length;for(a=Re(a),a<0&&(a=-a>f?0:f+a),l=l===r||l>f?f:Re(l),l<0&&(l+=f),l=a>l?0:nc(l);a<l;)e[a++]=t;return e}function Bo(e,t){var a=[];return zn(e,function(l,f,h){t(l,f,h)&&a.push(l)}),a}function vt(e,t,a,l,f){var h=-1,x=e.length;for(a||(a=wp),f||(f=[]);++h<x;){var S=e[h];t>0&&a(S)?t>1?vt(S,t-1,a,l,f):Un(f,S):l||(f[f.length]=S)}return f}var Pi=fl(),zo=fl(!0);function mn(e,t){return e&&Pi(e,t,xt)}function Oi(e,t){return e&&zo(e,t,xt)}function Sa(e,t){return Ln(t,function(a){return Tn(e[a])})}function rr(e,t){t=Hn(t,e);for(var a=0,l=t.length;e!=null&&a<l;)e=e[bn(t[a++])];return a&&a==l?e:r}function Wo(e,t,a){var l=t(e);return Ce(e)?l:Un(l,a(e))}function Nt(e){return e==null?e===r?yn:Ze:Qn&&Qn in Xe(e)?gp(e):Ep(e)}function Fi(e,t){return e>t}function Of(e,t){return e!=null&&Me.call(e,t)}function Ff(e,t){return e!=null&&t in Xe(e)}function If(e,t,a){return e>=yt(t,a)&&e<gt(t,a)}function Ii(e,t,a){for(var l=a?bi:aa,f=e[0].length,h=e.length,x=h,S=$(h),C=1/0,B=[];x--;){var z=e[x];x&&t&&(z=nt(z,Dt(t))),C=yt(z.length,C),S[x]=!a&&(t||f>=120&&z.length>=120)?new tr(x&&z):r}z=e[0];var W=-1,te=S[0];e:for(;++W<f&&B.length<C;){var de=z[W],me=t?t(de):de;if(de=a||de!==0?de:0,!(te?$r(te,me):l(B,me,a))){for(x=h;--x;){var Pe=S[x];if(!(Pe?$r(Pe,me):l(e[x],me,a)))continue e}te&&te.push(me),B.push(de)}}return B}function Lf(e,t,a,l){return mn(e,function(f,h,x){t(l,a(f),h,x)}),l}function Br(e,t,a){t=Hn(t,e),e=Tl(e,t);var l=e==null?e:e[bn(tn(t))];return l==null?r:Ut(l,e,a)}function Ho(e){return it(e)&&Nt(e)==ie}function Uf(e){return it(e)&&Nt(e)==ct}function Df(e){return it(e)&&Nt(e)==ee}function zr(e,t,a,l,f){return e===t?!0:e==null||t==null||!it(e)&&!it(t)?e!==e&&t!==t:Bf(e,t,a,l,zr,f)}function Bf(e,t,a,l,f,h){var x=Ce(e),S=Ce(t),C=x?ue:wt(e),B=S?ue:wt(t);C=C==ie?ut:C,B=B==ie?ut:B;var z=C==ut,W=B==ut,te=C==B;if(te&&qn(e)){if(!qn(t))return!1;x=!0,z=!1}if(te&&!z)return h||(h=new dn),x||Nr(e)?jl(e,t,a,l,f,h):pp(e,t,C,a,l,f,h);if(!(a&T)){var de=z&&Me.call(e,"__wrapped__"),me=W&&Me.call(t,"__wrapped__");if(de||me){var Pe=de?e.value():e,xe=me?t.value():t;return h||(h=new dn),f(Pe,xe,a,l,h)}}return te?(h||(h=new dn),hp(e,t,a,l,f,h)):!1}function zf(e){return it(e)&&wt(e)==Ie}function Li(e,t,a,l){var f=a.length,h=f,x=!l;if(e==null)return!h;for(e=Xe(e);f--;){var S=a[f];if(x&&S[2]?S[1]!==e[S[0]]:!(S[0]in e))return!1}for(;++f<h;){S=a[f];var C=S[0],B=e[C],z=S[1];if(x&&S[2]){if(B===r&&!(C in e))return!1}else{var W=new dn;if(l)var te=l(B,z,C,e,t,W);if(!(te===r?zr(z,B,T|k,l,W):te))return!1}}return!0}function Go(e){if(!rt(e)||Sp(e))return!1;var t=Tn(e)?Bu:Ws;return t.test(ir(e))}function Wf(e){return it(e)&&Nt(e)==Ke}function Hf(e){return it(e)&&wt(e)==Je}function Gf(e){return it(e)&&Ba(e.length)&&!!et[Nt(e)]}function qo(e){return typeof e=="function"?e:e==null?kt:typeof e=="object"?Ce(e)?Mo(e[0],e[1]):Vo(e):pc(e)}function Ui(e){if(!Gr(e))return Yu(e);var t=[];for(var a in Xe(e))Me.call(e,a)&&a!="constructor"&&t.push(a);return t}function qf(e){if(!rt(e))return Ap(e);var t=Gr(e),a=[];for(var l in e)l=="constructor"&&(t||!Me.call(e,l))||a.push(l);return a}function Di(e,t){return e<t}function Yo(e,t){var a=-1,l=Tt(e)?$(e.length):[];return zn(e,function(f,h,x){l[++a]=t(f,h,x)}),l}function Vo(e){var t=es(e);return t.length==1&&t[0][2]?Al(t[0][0],t[0][1]):function(a){return a===e||Li(a,e,t)}}function Mo(e,t){return ns(e)&&Cl(t)?Al(bn(e),t):function(a){var l=fs(a,e);return l===r&&l===t?ps(a,e):zr(t,l,T|k)}}function Na(e,t,a,l,f){e!==t&&Pi(t,function(h,x){if(f||(f=new dn),rt(h))Yf(e,t,x,a,Na,l,f);else{var S=l?l(as(e,x),h,x+"",e,t,f):r;S===r&&(S=h),ki(e,x,S)}},Rt)}function Yf(e,t,a,l,f,h,x){var S=as(e,a),C=as(t,a),B=x.get(C);if(B){ki(e,a,B);return}var z=h?h(S,C,a+"",e,t,x):r,W=z===r;if(W){var te=Ce(C),de=!te&&qn(C),me=!te&&!de&&Nr(C);z=C,te||de||me?Ce(S)?z=S:st(S)?z=Et(S):de?(W=!1,z=sl(C,!0)):me?(W=!1,z=ol(C,!0)):z=[]:Yr(C)||sr(C)?(z=S,sr(S)?z=rc(S):(!rt(S)||Tn(S))&&(z=_l(C))):W=!1}W&&(x.set(C,z),f(z,C,l,h,x),x.delete(C)),ki(e,a,z)}function Ko(e,t){var a=e.length;if(a)return t+=t<0?a:0,En(t,a)?e[t]:r}function Jo(e,t,a){t.length?t=nt(t,function(h){return Ce(h)?function(x){return rr(x,h.length===1?h[0]:h)}:h}):t=[kt];var l=-1;t=nt(t,Dt(he()));var f=Yo(e,function(h,x,S){var C=nt(t,function(B){return B(h)});return{criteria:C,index:++l,value:h}});return bu(f,function(h,x){return ip(h,x,a)})}function Vf(e,t){return Xo(e,t,function(a,l){return ps(e,l)})}function Xo(e,t,a){for(var l=-1,f=t.length,h={};++l<f;){var x=t[l],S=rr(e,x);a(S,x)&&Wr(h,Hn(x,e),S)}return h}function Mf(e){return function(t){return rr(t,e)}}function Bi(e,t,a,l){var f=l?xu:pr,h=-1,x=t.length,S=e;for(e===t&&(t=Et(t)),a&&(S=nt(e,Dt(a)));++h<x;)for(var C=0,B=t[h],z=a?a(B):B;(C=f(S,z,C,l))>-1;)S!==e&&ha.call(S,C,1),ha.call(e,C,1);return e}function Zo(e,t){for(var a=e?t.length:0,l=a-1;a--;){var f=t[a];if(a==l||f!==h){var h=f;En(f)?ha.call(e,f,1):Gi(e,f)}}return e}function zi(e,t){return e+xa($o()*(t-e+1))}function Kf(e,t,a,l){for(var f=-1,h=gt(ma((t-e)/(a||1)),0),x=$(h);h--;)x[l?h:++f]=e,e+=a;return x}function Wi(e,t){var a="";if(!e||t<1||t>ke)return a;do t%2&&(a+=e),t=xa(t/2),t&&(e+=e);while(t);return a}function Fe(e,t){return is(El(e,t,kt),e+"")}function Jf(e){return Fo(_r(e))}function Xf(e,t){var a=_r(e);return Oa(a,nr(t,0,a.length))}function Wr(e,t,a,l){if(!rt(e))return e;t=Hn(t,e);for(var f=-1,h=t.length,x=h-1,S=e;S!=null&&++f<h;){var C=bn(t[f]),B=a;if(C==="__proto__"||C==="constructor"||C==="prototype")return e;if(f!=x){var z=S[C];B=l?l(z,C,S):r,B===r&&(B=rt(z)?z:En(t[f+1])?[]:{})}Ur(S,C,B),S=S[C]}return e}var Qo=ba?function(e,t){return ba.set(e,t),e}:kt,Zf=ga?function(e,t){return ga(e,"toString",{configurable:!0,enumerable:!1,value:gs(t),writable:!0})}:kt;function Qf(e){return Oa(_r(e))}function en(e,t,a){var l=-1,f=e.length;t<0&&(t=-t>f?0:f+t),a=a>f?f:a,a<0&&(a+=f),f=t>a?0:a-t>>>0,t>>>=0;for(var h=$(f);++l<f;)h[l]=e[l+t];return h}function ep(e,t){var a;return zn(e,function(l,f,h){return a=t(l,f,h),!a}),!!a}function _a(e,t,a){var l=0,f=e==null?l:e.length;if(typeof t=="number"&&t===t&&f<=G){for(;l<f;){var h=l+f>>>1,x=e[h];x!==null&&!zt(x)&&(a?x<=t:x<t)?l=h+1:f=h}return f}return Hi(e,t,kt,a)}function Hi(e,t,a,l){var f=0,h=e==null?0:e.length;if(h===0)return 0;t=a(t);for(var x=t!==t,S=t===null,C=zt(t),B=t===r;f<h;){var z=xa((f+h)/2),W=a(e[z]),te=W!==r,de=W===null,me=W===W,Pe=zt(W);if(x)var xe=l||me;else B?xe=me&&(l||te):S?xe=me&&te&&(l||!de):C?xe=me&&te&&!de&&(l||!Pe):de||Pe?xe=!1:xe=l?W<=t:W<t;xe?f=z+1:h=z}return yt(h,fe)}function el(e,t){for(var a=-1,l=e.length,f=0,h=[];++a<l;){var x=e[a],S=t?t(x):x;if(!a||!un(S,C)){var C=S;h[f++]=x===0?0:x}}return h}function tl(e){return typeof e=="number"?e:zt(e)?D:+e}function Bt(e){if(typeof e=="string")return e;if(Ce(e))return nt(e,Bt)+"";if(zt(e))return Po?Po.call(e):"";var t=e+"";return t=="0"&&1/e==-Te?"-0":t}function Wn(e,t,a){var l=-1,f=aa,h=e.length,x=!0,S=[],C=S;if(a)x=!1,f=bi;else if(h>=c){var B=t?null:up(e);if(B)return sa(B);x=!1,f=$r,C=new tr}else C=t?[]:S;e:for(;++l<h;){var z=e[l],W=t?t(z):z;if(z=a||z!==0?z:0,x&&W===W){for(var te=C.length;te--;)if(C[te]===W)continue e;t&&C.push(W),S.push(z)}else f(C,W,a)||(C!==S&&C.push(W),S.push(z))}return S}function Gi(e,t){return t=Hn(t,e),e=Tl(e,t),e==null||delete e[bn(tn(t))]}function nl(e,t,a,l){return Wr(e,t,a(rr(e,t)),l)}function Ca(e,t,a,l){for(var f=e.length,h=l?f:-1;(l?h--:++h<f)&&t(e[h],h,e););return a?en(e,l?0:h,l?h+1:f):en(e,l?h+1:0,l?f:h)}function rl(e,t){var a=e;return a instanceof Ue&&(a=a.value()),vi(t,function(l,f){return f.func.apply(f.thisArg,Un([l],f.args))},a)}function qi(e,t,a){var l=e.length;if(l<2)return l?Wn(e[0]):[];for(var f=-1,h=$(l);++f<l;)for(var x=e[f],S=-1;++S<l;)S!=f&&(h[f]=Dr(h[f]||x,e[S],t,a));return Wn(vt(h,1),t,a)}function al(e,t,a){for(var l=-1,f=e.length,h=t.length,x={};++l<f;){var S=l<h?t[l]:r;a(x,e[l],S)}return x}function Yi(e){return st(e)?e:[]}function Vi(e){return typeof e=="function"?e:kt}function Hn(e,t){return Ce(e)?e:ns(e,t)?[e]:Pl(Ve(e))}var tp=Fe;function Gn(e,t,a){var l=e.length;return a=a===r?l:a,!t&&a>=l?e:en(e,t,a)}var il=zu||function(e){return bt.clearTimeout(e)};function sl(e,t){if(t)return e.slice();var a=e.length,l=Ao?Ao(a):new e.constructor(a);return e.copy(l),l}function Mi(e){var t=new e.constructor(e.byteLength);return new fa(t).set(new fa(e)),t}function np(e,t){var a=t?Mi(e.buffer):e.buffer;return new e.constructor(a,e.byteOffset,e.byteLength)}function rp(e){var t=new e.constructor(e.source,_.exec(e));return t.lastIndex=e.lastIndex,t}function ap(e){return Lr?Xe(Lr.call(e)):{}}function ol(e,t){var a=t?Mi(e.buffer):e.buffer;return new e.constructor(a,e.byteOffset,e.length)}function ll(e,t){if(e!==t){var a=e!==r,l=e===null,f=e===e,h=zt(e),x=t!==r,S=t===null,C=t===t,B=zt(t);if(!S&&!B&&!h&&e>t||h&&x&&C&&!S&&!B||l&&x&&C||!a&&C||!f)return 1;if(!l&&!h&&!B&&e<t||B&&a&&f&&!l&&!h||S&&a&&f||!x&&f||!C)return-1}return 0}function ip(e,t,a){for(var l=-1,f=e.criteria,h=t.criteria,x=f.length,S=a.length;++l<x;){var C=ll(f[l],h[l]);if(C){if(l>=S)return C;var B=a[l];return C*(B=="desc"?-1:1)}}return e.index-t.index}function cl(e,t,a,l){for(var f=-1,h=e.length,x=a.length,S=-1,C=t.length,B=gt(h-x,0),z=$(C+B),W=!l;++S<C;)z[S]=t[S];for(;++f<x;)(W||f<h)&&(z[a[f]]=e[f]);for(;B--;)z[S++]=e[f++];return z}function dl(e,t,a,l){for(var f=-1,h=e.length,x=-1,S=a.length,C=-1,B=t.length,z=gt(h-S,0),W=$(z+B),te=!l;++f<z;)W[f]=e[f];for(var de=f;++C<B;)W[de+C]=t[C];for(;++x<S;)(te||f<h)&&(W[de+a[x]]=e[f++]);return W}function Et(e,t){var a=-1,l=e.length;for(t||(t=$(l));++a<l;)t[a]=e[a];return t}function xn(e,t,a,l){var f=!a;a||(a={});for(var h=-1,x=t.length;++h<x;){var S=t[h],C=l?l(a[S],e[S],S,a,e):r;C===r&&(C=e[S]),f?_n(a,S,C):Ur(a,S,C)}return a}function sp(e,t){return xn(e,ts(e),t)}function op(e,t){return xn(e,Sl(e),t)}function Aa(e,t){return function(a,l){var f=Ce(a)?uu:Tf,h=t?t():{};return f(a,e,he(l,2),h)}}function wr(e){return Fe(function(t,a){var l=-1,f=a.length,h=f>1?a[f-1]:r,x=f>2?a[2]:r;for(h=e.length>3&&typeof h=="function"?(f--,h):r,x&&_t(a[0],a[1],x)&&(h=f<3?r:h,f=1),t=Xe(t);++l<f;){var S=a[l];S&&e(t,S,l,h)}return t})}function ul(e,t){return function(a,l){if(a==null)return a;if(!Tt(a))return e(a,l);for(var f=a.length,h=t?f:-1,x=Xe(a);(t?h--:++h<f)&&l(x[h],h,x)!==!1;);return a}}function fl(e){return function(t,a,l){for(var f=-1,h=Xe(t),x=l(t),S=x.length;S--;){var C=x[e?S:++f];if(a(h[C],C,h)===!1)break}return t}}function lp(e,t,a){var l=t&A,f=Hr(e);function h(){var x=this&&this!==bt&&this instanceof h?f:e;return x.apply(l?a:this,arguments)}return h}function pl(e){return function(t){t=Ve(t);var a=hr(t)?cn(t):r,l=a?a[0]:t.charAt(0),f=a?Gn(a,1).join(""):t.slice(1);return l[e]()+f}}function jr(e){return function(t){return vi(uc(dc(t).replace(Xd,"")),e,"")}}function Hr(e){return function(){var t=arguments;switch(t.length){case 0:return new e;case 1:return new e(t[0]);case 2:return new e(t[0],t[1]);case 3:return new e(t[0],t[1],t[2]);case 4:return new e(t[0],t[1],t[2],t[3]);case 5:return new e(t[0],t[1],t[2],t[3],t[4]);case 6:return new e(t[0],t[1],t[2],t[3],t[4],t[5]);case 7:return new e(t[0],t[1],t[2],t[3],t[4],t[5],t[6])}var a=yr(e.prototype),l=e.apply(a,t);return rt(l)?l:a}}function cp(e,t,a){var l=Hr(e);function f(){for(var h=arguments.length,x=$(h),S=h,C=Sr(f);S--;)x[S]=arguments[S];var B=h<3&&x[0]!==C&&x[h-1]!==C?[]:Dn(x,C);if(h-=B.length,h<a)return bl(e,t,Ea,f.placeholder,r,x,B,r,r,a-h);var z=this&&this!==bt&&this instanceof f?l:e;return Ut(z,this,x)}return f}function hl(e){return function(t,a,l){var f=Xe(t);if(!Tt(t)){var h=he(a,3);t=xt(t),a=function(S){return h(f[S],S,f)}}var x=e(t,a,l);return x>-1?f[h?t[x]:x]:r}}function gl(e){return An(function(t){var a=t.length,l=a,f=Zt.prototype.thru;for(e&&t.reverse();l--;){var h=t[l];if(typeof h!="function")throw new Xt(u);if(f&&!x&&$a(h)=="wrapper")var x=new Zt([],!0)}for(l=x?l:a;++l<a;){h=t[l];var S=$a(h),C=S=="wrapper"?Qi(h):r;C&&rs(C[0])&&C[1]==(we|R|ne|be)&&!C[4].length&&C[9]==1?x=x[$a(C[0])].apply(x,C[3]):x=h.length==1&&rs(h)?x[S]():x.thru(h)}return function(){var B=arguments,z=B[0];if(x&&B.length==1&&Ce(z))return x.plant(z).value();for(var W=0,te=a?t[W].apply(this,B):z;++W<a;)te=t[W].call(this,te);return te}})}function Ea(e,t,a,l,f,h,x,S,C,B){var z=t&we,W=t&A,te=t&q,de=t&(R|M),me=t&ve,Pe=te?r:Hr(e);function xe(){for(var Le=arguments.length,De=$(Le),Wt=Le;Wt--;)De[Wt]=arguments[Wt];if(de)var Ct=Sr(xe),Ht=yu(De,Ct);if(l&&(De=cl(De,l,f,de)),h&&(De=dl(De,h,x,de)),Le-=Ht,de&&Le<B){var ot=Dn(De,Ct);return bl(e,t,Ea,xe.placeholder,a,De,ot,S,C,B-Le)}var fn=W?a:this,kn=te?fn[e]:e;return Le=De.length,S?De=Tp(De,S):me&&Le>1&&De.reverse(),z&&C<Le&&(De.length=C),this&&this!==bt&&this instanceof xe&&(kn=Pe||Hr(kn)),kn.apply(fn,De)}return xe}function ml(e,t){return function(a,l){return Lf(a,e,t(l),{})}}function Ta(e,t){return function(a,l){var f;if(a===r&&l===r)return t;if(a!==r&&(f=a),l!==r){if(f===r)return l;typeof a=="string"||typeof l=="string"?(a=Bt(a),l=Bt(l)):(a=tl(a),l=tl(l)),f=e(a,l)}return f}}function Ki(e){return An(function(t){return t=nt(t,Dt(he())),Fe(function(a){var l=this;return e(t,function(f){return Ut(f,l,a)})})})}function Ra(e,t){t=t===r?" ":Bt(t);var a=t.length;if(a<2)return a?Wi(t,e):t;var l=Wi(t,ma(e/gr(t)));return hr(t)?Gn(cn(l),0,e).join(""):l.slice(0,e)}function dp(e,t,a,l){var f=t&A,h=Hr(e);function x(){for(var S=-1,C=arguments.length,B=-1,z=l.length,W=$(z+C),te=this&&this!==bt&&this instanceof x?h:e;++B<z;)W[B]=l[B];for(;C--;)W[B++]=arguments[++S];return Ut(te,f?a:this,W)}return x}function xl(e){return function(t,a,l){return l&&typeof l!="number"&&_t(t,a,l)&&(a=l=r),t=Rn(t),a===r?(a=t,t=0):a=Rn(a),l=l===r?t<a?1:-1:Rn(l),Kf(t,a,l,e)}}function ka(e){return function(t,a){return typeof t=="string"&&typeof a=="string"||(t=nn(t),a=nn(a)),e(t,a)}}function bl(e,t,a,l,f,h,x,S,C,B){var z=t&R,W=z?x:r,te=z?r:x,de=z?h:r,me=z?r:h;t|=z?ne:pe,t&=~(z?pe:ne),t&V||(t&=~(A|q));var Pe=[e,t,f,de,W,me,te,S,C,B],xe=a.apply(r,Pe);return rs(e)&&Rl(xe,Pe),xe.placeholder=l,kl(xe,e,t)}function Ji(e){var t=ht[e];return function(a,l){if(a=nn(a),l=l==null?0:yt(Re(l),292),l&&ko(a)){var f=(Ve(a)+"e").split("e"),h=t(f[0]+"e"+(+f[1]+l));return f=(Ve(h)+"e").split("e"),+(f[0]+"e"+(+f[1]-l))}return t(a)}}var up=br&&1/sa(new br([,-0]))[1]==Te?function(e){return new br(e)}:bs;function vl(e){return function(t){var a=wt(t);return a==Ie?Ci(t):a==Je?Au(t):vu(t,e(t))}}function Cn(e,t,a,l,f,h,x,S){var C=t&q;if(!C&&typeof e!="function")throw new Xt(u);var B=l?l.length:0;if(B||(t&=~(ne|pe),l=f=r),x=x===r?x:gt(Re(x),0),S=S===r?S:Re(S),B-=f?f.length:0,t&pe){var z=l,W=f;l=f=r}var te=C?r:Qi(e),de=[e,t,a,l,f,z,W,h,x,S];if(te&&Cp(de,te),e=de[0],t=de[1],a=de[2],l=de[3],f=de[4],S=de[9]=de[9]===r?C?0:e.length:gt(de[9]-B,0),!S&&t&(R|M)&&(t&=~(R|M)),!t||t==A)var me=lp(e,t,a);else t==R||t==M?me=cp(e,t,S):(t==ne||t==(A|ne))&&!f.length?me=dp(e,t,a,l):me=Ea.apply(r,de);var Pe=te?Qo:Rl;return kl(Pe(me,de),e,t)}function yl(e,t,a,l){return e===r||un(e,xr[a])&&!Me.call(l,a)?t:e}function wl(e,t,a,l,f,h){return rt(e)&&rt(t)&&(h.set(t,e),Na(e,t,r,wl,h),h.delete(t)),e}function fp(e){return Yr(e)?r:e}function jl(e,t,a,l,f,h){var x=a&T,S=e.length,C=t.length;if(S!=C&&!(x&&C>S))return!1;var B=h.get(e),z=h.get(t);if(B&&z)return B==t&&z==e;var W=-1,te=!0,de=a&k?new tr:r;for(h.set(e,t),h.set(t,e);++W<S;){var me=e[W],Pe=t[W];if(l)var xe=x?l(Pe,me,W,t,e,h):l(me,Pe,W,e,t,h);if(xe!==r){if(xe)continue;te=!1;break}if(de){if(!yi(t,function(Le,De){if(!$r(de,De)&&(me===Le||f(me,Le,a,l,h)))return de.push(De)})){te=!1;break}}else if(!(me===Pe||f(me,Pe,a,l,h))){te=!1;break}}return h.delete(e),h.delete(t),te}function pp(e,t,a,l,f,h,x){switch(a){case pt:if(e.byteLength!=t.byteLength||e.byteOffset!=t.byteOffset)return!1;e=e.buffer,t=t.buffer;case ct:return!(e.byteLength!=t.byteLength||!h(new fa(e),new fa(t)));case Ge:case ee:case dt:return un(+e,+t);case Ae:return e.name==t.name&&e.message==t.message;case Ke:case ft:return e==t+"";case Ie:var S=Ci;case Je:var C=l&T;if(S||(S=sa),e.size!=t.size&&!C)return!1;var B=x.get(e);if(B)return B==t;l|=k,x.set(e,t);var z=jl(S(e),S(t),l,f,h,x);return x.delete(e),z;case mt:if(Lr)return Lr.call(e)==Lr.call(t)}return!1}function hp(e,t,a,l,f,h){var x=a&T,S=Xi(e),C=S.length,B=Xi(t),z=B.length;if(C!=z&&!x)return!1;for(var W=C;W--;){var te=S[W];if(!(x?te in t:Me.call(t,te)))return!1}var de=h.get(e),me=h.get(t);if(de&&me)return de==t&&me==e;var Pe=!0;h.set(e,t),h.set(t,e);for(var xe=x;++W<C;){te=S[W];var Le=e[te],De=t[te];if(l)var Wt=x?l(De,Le,te,t,e,h):l(Le,De,te,e,t,h);if(!(Wt===r?Le===De||f(Le,De,a,l,h):Wt)){Pe=!1;break}xe||(xe=te=="constructor")}if(Pe&&!xe){var Ct=e.constructor,Ht=t.constructor;Ct!=Ht&&"constructor"in e&&"constructor"in t&&!(typeof Ct=="function"&&Ct instanceof Ct&&typeof Ht=="function"&&Ht instanceof Ht)&&(Pe=!1)}return h.delete(e),h.delete(t),Pe}function An(e){return is(El(e,r,Ll),e+"")}function Xi(e){return Wo(e,xt,ts)}function Zi(e){return Wo(e,Rt,Sl)}var Qi=ba?function(e){return ba.get(e)}:bs;function $a(e){for(var t=e.name+"",a=vr[t],l=Me.call(vr,t)?a.length:0;l--;){var f=a[l],h=f.func;if(h==null||h==e)return f.name}return t}function Sr(e){var t=Me.call(p,"placeholder")?p:e;return t.placeholder}function he(){var e=p.iteratee||ms;return e=e===ms?qo:e,arguments.length?e(arguments[0],arguments[1]):e}function Pa(e,t){var a=e.__data__;return jp(t)?a[typeof t=="string"?"string":"hash"]:a.map}function es(e){for(var t=xt(e),a=t.length;a--;){var l=t[a],f=e[l];t[a]=[l,f,Cl(f)]}return t}function ar(e,t){var a=Nu(e,t);return Go(a)?a:r}function gp(e){var t=Me.call(e,Qn),a=e[Qn];try{e[Qn]=r;var l=!0}catch{}var f=da.call(e);return l&&(t?e[Qn]=a:delete e[Qn]),f}var ts=Ei?function(e){return e==null?[]:(e=Xe(e),Ln(Ei(e),function(t){return To.call(e,t)}))}:vs,Sl=Ei?function(e){for(var t=[];e;)Un(t,ts(e)),e=pa(e);return t}:vs,wt=Nt;(Ti&&wt(new Ti(new ArrayBuffer(1)))!=pt||Or&&wt(new Or)!=Ie||Ri&&wt(Ri.resolve())!=lt||br&&wt(new br)!=Je||Fr&&wt(new Fr)!=Ot)&&(wt=function(e){var t=Nt(e),a=t==ut?e.constructor:r,l=a?ir(a):"";if(l)switch(l){case Ju:return pt;case Xu:return Ie;case Zu:return lt;case Qu:return Je;case ef:return Ot}return t});function mp(e,t,a){for(var l=-1,f=a.length;++l<f;){var h=a[l],x=h.size;switch(h.type){case"drop":e+=x;break;case"dropRight":t-=x;break;case"take":t=yt(t,e+x);break;case"takeRight":e=gt(e,t-x);break}}return{start:e,end:t}}function xp(e){var t=e.match(L);return t?t[1].split(O):[]}function Nl(e,t,a){t=Hn(t,e);for(var l=-1,f=t.length,h=!1;++l<f;){var x=bn(t[l]);if(!(h=e!=null&&a(e,x)))break;e=e[x]}return h||++l!=f?h:(f=e==null?0:e.length,!!f&&Ba(f)&&En(x,f)&&(Ce(e)||sr(e)))}function bp(e){var t=e.length,a=new e.constructor(t);return t&&typeof e[0]=="string"&&Me.call(e,"index")&&(a.index=e.index,a.input=e.input),a}function _l(e){return typeof e.constructor=="function"&&!Gr(e)?yr(pa(e)):{}}function vp(e,t,a){var l=e.constructor;switch(t){case ct:return Mi(e);case Ge:case ee:return new l(+e);case pt:return np(e,a);case rn:case At:case qt:case H:case X:case ce:case je:case Be:case tt:return ol(e,a);case Ie:return new l;case dt:case ft:return new l(e);case Ke:return rp(e);case Je:return new l;case mt:return ap(e)}}function yp(e,t){var a=t.length;if(!a)return e;var l=a-1;return t[l]=(a>1?"& ":"")+t[l],t=t.join(a>2?", ":" "),e.replace(b,`{
/* [wrapped with `+t+`] */
`)}function wp(e){return Ce(e)||sr(e)||!!(Ro&&e&&e[Ro])}function En(e,t){var a=typeof e;return t=t??ke,!!t&&(a=="number"||a!="symbol"&&$d.test(e))&&e>-1&&e%1==0&&e<t}function _t(e,t,a){if(!rt(a))return!1;var l=typeof t;return(l=="number"?Tt(a)&&En(t,a.length):l=="string"&&t in a)?un(a[t],e):!1}function ns(e,t){if(Ce(e))return!1;var a=typeof e;return a=="number"||a=="symbol"||a=="boolean"||e==null||zt(e)?!0:Vt.test(e)||!sn.test(e)||t!=null&&e in Xe(t)}function jp(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}function rs(e){var t=$a(e),a=p[t];if(typeof a!="function"||!(t in Ue.prototype))return!1;if(e===a)return!0;var l=Qi(a);return!!l&&e===l[0]}function Sp(e){return!!Co&&Co in e}var Np=la?Tn:ys;function Gr(e){var t=e&&e.constructor,a=typeof t=="function"&&t.prototype||xr;return e===a}function Cl(e){return e===e&&!rt(e)}function Al(e,t){return function(a){return a==null?!1:a[e]===t&&(t!==r||e in Xe(a))}}function _p(e){var t=Ua(e,function(l){return a.size===j&&a.clear(),l}),a=t.cache;return t}function Cp(e,t){var a=e[1],l=t[1],f=a|l,h=f<(A|q|we),x=l==we&&a==R||l==we&&a==be&&e[7].length<=t[8]||l==(we|be)&&t[7].length<=t[8]&&a==R;if(!(h||x))return e;l&A&&(e[2]=t[2],f|=a&A?0:V);var S=t[3];if(S){var C=e[3];e[3]=C?cl(C,S,t[4]):S,e[4]=C?Dn(e[3],v):t[4]}return S=t[5],S&&(C=e[5],e[5]=C?dl(C,S,t[6]):S,e[6]=C?Dn(e[5],v):t[6]),S=t[7],S&&(e[7]=S),l&we&&(e[8]=e[8]==null?t[8]:yt(e[8],t[8])),e[9]==null&&(e[9]=t[9]),e[0]=t[0],e[1]=f,e}function Ap(e){var t=[];if(e!=null)for(var a in Xe(e))t.push(a);return t}function Ep(e){return da.call(e)}function El(e,t,a){return t=gt(t===r?e.length-1:t,0),function(){for(var l=arguments,f=-1,h=gt(l.length-t,0),x=$(h);++f<h;)x[f]=l[t+f];f=-1;for(var S=$(t+1);++f<t;)S[f]=l[f];return S[t]=a(x),Ut(e,this,S)}}function Tl(e,t){return t.length<2?e:rr(e,en(t,0,-1))}function Tp(e,t){for(var a=e.length,l=yt(t.length,a),f=Et(e);l--;){var h=t[l];e[l]=En(h,a)?f[h]:r}return e}function as(e,t){if(!(t==="constructor"&&typeof e[t]=="function")&&t!="__proto__")return e[t]}var Rl=$l(Qo),qr=Hu||function(e,t){return bt.setTimeout(e,t)},is=$l(Zf);function kl(e,t,a){var l=t+"";return is(e,yp(l,Rp(xp(l),a)))}function $l(e){var t=0,a=0;return function(){var l=Vu(),f=se-(l-a);if(a=l,f>0){if(++t>=Q)return arguments[0]}else t=0;return e.apply(r,arguments)}}function Oa(e,t){var a=-1,l=e.length,f=l-1;for(t=t===r?l:t;++a<t;){var h=zi(a,f),x=e[h];e[h]=e[a],e[a]=x}return e.length=t,e}var Pl=_p(function(e){var t=[];return e.charCodeAt(0)===46&&t.push(""),e.replace(on,function(a,l,f,h){t.push(f?h.replace(_e,"$1"):l||a)}),t});function bn(e){if(typeof e=="string"||zt(e))return e;var t=e+"";return t=="0"&&1/e==-Te?"-0":t}function ir(e){if(e!=null){try{return ca.call(e)}catch{}try{return e+""}catch{}}return""}function Rp(e,t){return Jt(re,function(a){var l="_."+a[0];t&a[1]&&!aa(e,l)&&e.push(l)}),e.sort()}function Ol(e){if(e instanceof Ue)return e.clone();var t=new Zt(e.__wrapped__,e.__chain__);return t.__actions__=Et(e.__actions__),t.__index__=e.__index__,t.__values__=e.__values__,t}function kp(e,t,a){(a?_t(e,t,a):t===r)?t=1:t=gt(Re(t),0);var l=e==null?0:e.length;if(!l||t<1)return[];for(var f=0,h=0,x=$(ma(l/t));f<l;)x[h++]=en(e,f,f+=t);return x}function $p(e){for(var t=-1,a=e==null?0:e.length,l=0,f=[];++t<a;){var h=e[t];h&&(f[l++]=h)}return f}function Pp(){var e=arguments.length;if(!e)return[];for(var t=$(e-1),a=arguments[0],l=e;l--;)t[l-1]=arguments[l];return Un(Ce(a)?Et(a):[a],vt(t,1))}var Op=Fe(function(e,t){return st(e)?Dr(e,vt(t,1,st,!0)):[]}),Fp=Fe(function(e,t){var a=tn(t);return st(a)&&(a=r),st(e)?Dr(e,vt(t,1,st,!0),he(a,2)):[]}),Ip=Fe(function(e,t){var a=tn(t);return st(a)&&(a=r),st(e)?Dr(e,vt(t,1,st,!0),r,a):[]});function Lp(e,t,a){var l=e==null?0:e.length;return l?(t=a||t===r?1:Re(t),en(e,t<0?0:t,l)):[]}function Up(e,t,a){var l=e==null?0:e.length;return l?(t=a||t===r?1:Re(t),t=l-t,en(e,0,t<0?0:t)):[]}function Dp(e,t){return e&&e.length?Ca(e,he(t,3),!0,!0):[]}function Bp(e,t){return e&&e.length?Ca(e,he(t,3),!0):[]}function zp(e,t,a,l){var f=e==null?0:e.length;return f?(a&&typeof a!="number"&&_t(e,t,a)&&(a=0,l=f),Pf(e,t,a,l)):[]}function Fl(e,t,a){var l=e==null?0:e.length;if(!l)return-1;var f=a==null?0:Re(a);return f<0&&(f=gt(l+f,0)),ia(e,he(t,3),f)}function Il(e,t,a){var l=e==null?0:e.length;if(!l)return-1;var f=l-1;return a!==r&&(f=Re(a),f=a<0?gt(l+f,0):yt(f,l-1)),ia(e,he(t,3),f,!0)}function Ll(e){var t=e==null?0:e.length;return t?vt(e,1):[]}function Wp(e){var t=e==null?0:e.length;return t?vt(e,Te):[]}function Hp(e,t){var a=e==null?0:e.length;return a?(t=t===r?1:Re(t),vt(e,t)):[]}function Gp(e){for(var t=-1,a=e==null?0:e.length,l={};++t<a;){var f=e[t];l[f[0]]=f[1]}return l}function Ul(e){return e&&e.length?e[0]:r}function qp(e,t,a){var l=e==null?0:e.length;if(!l)return-1;var f=a==null?0:Re(a);return f<0&&(f=gt(l+f,0)),pr(e,t,f)}function Yp(e){var t=e==null?0:e.length;return t?en(e,0,-1):[]}var Vp=Fe(function(e){var t=nt(e,Yi);return t.length&&t[0]===e[0]?Ii(t):[]}),Mp=Fe(function(e){var t=tn(e),a=nt(e,Yi);return t===tn(a)?t=r:a.pop(),a.length&&a[0]===e[0]?Ii(a,he(t,2)):[]}),Kp=Fe(function(e){var t=tn(e),a=nt(e,Yi);return t=typeof t=="function"?t:r,t&&a.pop(),a.length&&a[0]===e[0]?Ii(a,r,t):[]});function Jp(e,t){return e==null?"":qu.call(e,t)}function tn(e){var t=e==null?0:e.length;return t?e[t-1]:r}function Xp(e,t,a){var l=e==null?0:e.length;if(!l)return-1;var f=l;return a!==r&&(f=Re(a),f=f<0?gt(l+f,0):yt(f,l-1)),t===t?Tu(e,t,f):ia(e,bo,f,!0)}function Zp(e,t){return e&&e.length?Ko(e,Re(t)):r}var Qp=Fe(Dl);function Dl(e,t){return e&&e.length&&t&&t.length?Bi(e,t):e}function eh(e,t,a){return e&&e.length&&t&&t.length?Bi(e,t,he(a,2)):e}function th(e,t,a){return e&&e.length&&t&&t.length?Bi(e,t,r,a):e}var nh=An(function(e,t){var a=e==null?0:e.length,l=$i(e,t);return Zo(e,nt(t,function(f){return En(f,a)?+f:f}).sort(ll)),l});function rh(e,t){var a=[];if(!(e&&e.length))return a;var l=-1,f=[],h=e.length;for(t=he(t,3);++l<h;){var x=e[l];t(x,l,e)&&(a.push(x),f.push(l))}return Zo(e,f),a}function ss(e){return e==null?e:Ku.call(e)}function ah(e,t,a){var l=e==null?0:e.length;return l?(a&&typeof a!="number"&&_t(e,t,a)?(t=0,a=l):(t=t==null?0:Re(t),a=a===r?l:Re(a)),en(e,t,a)):[]}function ih(e,t){return _a(e,t)}function sh(e,t,a){return Hi(e,t,he(a,2))}function oh(e,t){var a=e==null?0:e.length;if(a){var l=_a(e,t);if(l<a&&un(e[l],t))return l}return-1}function lh(e,t){return _a(e,t,!0)}function ch(e,t,a){return Hi(e,t,he(a,2),!0)}function dh(e,t){var a=e==null?0:e.length;if(a){var l=_a(e,t,!0)-1;if(un(e[l],t))return l}return-1}function uh(e){return e&&e.length?el(e):[]}function fh(e,t){return e&&e.length?el(e,he(t,2)):[]}function ph(e){var t=e==null?0:e.length;return t?en(e,1,t):[]}function hh(e,t,a){return e&&e.length?(t=a||t===r?1:Re(t),en(e,0,t<0?0:t)):[]}function gh(e,t,a){var l=e==null?0:e.length;return l?(t=a||t===r?1:Re(t),t=l-t,en(e,t<0?0:t,l)):[]}function mh(e,t){return e&&e.length?Ca(e,he(t,3),!1,!0):[]}function xh(e,t){return e&&e.length?Ca(e,he(t,3)):[]}var bh=Fe(function(e){return Wn(vt(e,1,st,!0))}),vh=Fe(function(e){var t=tn(e);return st(t)&&(t=r),Wn(vt(e,1,st,!0),he(t,2))}),yh=Fe(function(e){var t=tn(e);return t=typeof t=="function"?t:r,Wn(vt(e,1,st,!0),r,t)});function wh(e){return e&&e.length?Wn(e):[]}function jh(e,t){return e&&e.length?Wn(e,he(t,2)):[]}function Sh(e,t){return t=typeof t=="function"?t:r,e&&e.length?Wn(e,r,t):[]}function os(e){if(!(e&&e.length))return[];var t=0;return e=Ln(e,function(a){if(st(a))return t=gt(a.length,t),!0}),Ni(t,function(a){return nt(e,wi(a))})}function Bl(e,t){if(!(e&&e.length))return[];var a=os(e);return t==null?a:nt(a,function(l){return Ut(t,r,l)})}var Nh=Fe(function(e,t){return st(e)?Dr(e,t):[]}),_h=Fe(function(e){return qi(Ln(e,st))}),Ch=Fe(function(e){var t=tn(e);return st(t)&&(t=r),qi(Ln(e,st),he(t,2))}),Ah=Fe(function(e){var t=tn(e);return t=typeof t=="function"?t:r,qi(Ln(e,st),r,t)}),Eh=Fe(os);function Th(e,t){return al(e||[],t||[],Ur)}function Rh(e,t){return al(e||[],t||[],Wr)}var kh=Fe(function(e){var t=e.length,a=t>1?e[t-1]:r;return a=typeof a=="function"?(e.pop(),a):r,Bl(e,a)});function zl(e){var t=p(e);return t.__chain__=!0,t}function $h(e,t){return t(e),e}function Fa(e,t){return t(e)}var Ph=An(function(e){var t=e.length,a=t?e[0]:0,l=this.__wrapped__,f=function(h){return $i(h,e)};return t>1||this.__actions__.length||!(l instanceof Ue)||!En(a)?this.thru(f):(l=l.slice(a,+a+(t?1:0)),l.__actions__.push({func:Fa,args:[f],thisArg:r}),new Zt(l,this.__chain__).thru(function(h){return t&&!h.length&&h.push(r),h}))});function Oh(){return zl(this)}function Fh(){return new Zt(this.value(),this.__chain__)}function Ih(){this.__values__===r&&(this.__values__=tc(this.value()));var e=this.__index__>=this.__values__.length,t=e?r:this.__values__[this.__index__++];return{done:e,value:t}}function Lh(){return this}function Uh(e){for(var t,a=this;a instanceof ya;){var l=Ol(a);l.__index__=0,l.__values__=r,t?f.__wrapped__=l:t=l;var f=l;a=a.__wrapped__}return f.__wrapped__=e,t}function Dh(){var e=this.__wrapped__;if(e instanceof Ue){var t=e;return this.__actions__.length&&(t=new Ue(this)),t=t.reverse(),t.__actions__.push({func:Fa,args:[ss],thisArg:r}),new Zt(t,this.__chain__)}return this.thru(ss)}function Bh(){return rl(this.__wrapped__,this.__actions__)}var zh=Aa(function(e,t,a){Me.call(e,a)?++e[a]:_n(e,a,1)});function Wh(e,t,a){var l=Ce(e)?mo:$f;return a&&_t(e,t,a)&&(t=r),l(e,he(t,3))}function Hh(e,t){var a=Ce(e)?Ln:Bo;return a(e,he(t,3))}var Gh=hl(Fl),qh=hl(Il);function Yh(e,t){return vt(Ia(e,t),1)}function Vh(e,t){return vt(Ia(e,t),Te)}function Mh(e,t,a){return a=a===r?1:Re(a),vt(Ia(e,t),a)}function Wl(e,t){var a=Ce(e)?Jt:zn;return a(e,he(t,3))}function Hl(e,t){var a=Ce(e)?fu:Do;return a(e,he(t,3))}var Kh=Aa(function(e,t,a){Me.call(e,a)?e[a].push(t):_n(e,a,[t])});function Jh(e,t,a,l){e=Tt(e)?e:_r(e),a=a&&!l?Re(a):0;var f=e.length;return a<0&&(a=gt(f+a,0)),za(e)?a<=f&&e.indexOf(t,a)>-1:!!f&&pr(e,t,a)>-1}var Xh=Fe(function(e,t,a){var l=-1,f=typeof t=="function",h=Tt(e)?$(e.length):[];return zn(e,function(x){h[++l]=f?Ut(t,x,a):Br(x,t,a)}),h}),Zh=Aa(function(e,t,a){_n(e,a,t)});function Ia(e,t){var a=Ce(e)?nt:Yo;return a(e,he(t,3))}function Qh(e,t,a,l){return e==null?[]:(Ce(t)||(t=t==null?[]:[t]),a=l?r:a,Ce(a)||(a=a==null?[]:[a]),Jo(e,t,a))}var eg=Aa(function(e,t,a){e[a?0:1].push(t)},function(){return[[],[]]});function tg(e,t,a){var l=Ce(e)?vi:yo,f=arguments.length<3;return l(e,he(t,4),a,f,zn)}function ng(e,t,a){var l=Ce(e)?pu:yo,f=arguments.length<3;return l(e,he(t,4),a,f,Do)}function rg(e,t){var a=Ce(e)?Ln:Bo;return a(e,Da(he(t,3)))}function ag(e){var t=Ce(e)?Fo:Jf;return t(e)}function ig(e,t,a){(a?_t(e,t,a):t===r)?t=1:t=Re(t);var l=Ce(e)?Af:Xf;return l(e,t)}function sg(e){var t=Ce(e)?Ef:Qf;return t(e)}function og(e){if(e==null)return 0;if(Tt(e))return za(e)?gr(e):e.length;var t=wt(e);return t==Ie||t==Je?e.size:Ui(e).length}function lg(e,t,a){var l=Ce(e)?yi:ep;return a&&_t(e,t,a)&&(t=r),l(e,he(t,3))}var cg=Fe(function(e,t){if(e==null)return[];var a=t.length;return a>1&&_t(e,t[0],t[1])?t=[]:a>2&&_t(t[0],t[1],t[2])&&(t=[t[0]]),Jo(e,vt(t,1),[])}),La=Wu||function(){return bt.Date.now()};function dg(e,t){if(typeof t!="function")throw new Xt(u);return e=Re(e),function(){if(--e<1)return t.apply(this,arguments)}}function Gl(e,t,a){return t=a?r:t,t=e&&t==null?e.length:t,Cn(e,we,r,r,r,r,t)}function ql(e,t){var a;if(typeof t!="function")throw new Xt(u);return e=Re(e),function(){return--e>0&&(a=t.apply(this,arguments)),e<=1&&(t=r),a}}var ls=Fe(function(e,t,a){var l=A;if(a.length){var f=Dn(a,Sr(ls));l|=ne}return Cn(e,l,t,a,f)}),Yl=Fe(function(e,t,a){var l=A|q;if(a.length){var f=Dn(a,Sr(Yl));l|=ne}return Cn(t,l,e,a,f)});function Vl(e,t,a){t=a?r:t;var l=Cn(e,R,r,r,r,r,r,t);return l.placeholder=Vl.placeholder,l}function Ml(e,t,a){t=a?r:t;var l=Cn(e,M,r,r,r,r,r,t);return l.placeholder=Ml.placeholder,l}function Kl(e,t,a){var l,f,h,x,S,C,B=0,z=!1,W=!1,te=!0;if(typeof e!="function")throw new Xt(u);t=nn(t)||0,rt(a)&&(z=!!a.leading,W="maxWait"in a,h=W?gt(nn(a.maxWait)||0,t):h,te="trailing"in a?!!a.trailing:te);function de(ot){var fn=l,kn=f;return l=f=r,B=ot,x=e.apply(kn,fn),x}function me(ot){return B=ot,S=qr(Le,t),z?de(ot):x}function Pe(ot){var fn=ot-C,kn=ot-B,hc=t-fn;return W?yt(hc,h-kn):hc}function xe(ot){var fn=ot-C,kn=ot-B;return C===r||fn>=t||fn<0||W&&kn>=h}function Le(){var ot=La();if(xe(ot))return De(ot);S=qr(Le,Pe(ot))}function De(ot){return S=r,te&&l?de(ot):(l=f=r,x)}function Wt(){S!==r&&il(S),B=0,l=C=f=S=r}function Ct(){return S===r?x:De(La())}function Ht(){var ot=La(),fn=xe(ot);if(l=arguments,f=this,C=ot,fn){if(S===r)return me(C);if(W)return il(S),S=qr(Le,t),de(C)}return S===r&&(S=qr(Le,t)),x}return Ht.cancel=Wt,Ht.flush=Ct,Ht}var ug=Fe(function(e,t){return Uo(e,1,t)}),fg=Fe(function(e,t,a){return Uo(e,nn(t)||0,a)});function pg(e){return Cn(e,ve)}function Ua(e,t){if(typeof e!="function"||t!=null&&typeof t!="function")throw new Xt(u);var a=function(){var l=arguments,f=t?t.apply(this,l):l[0],h=a.cache;if(h.has(f))return h.get(f);var x=e.apply(this,l);return a.cache=h.set(f,x)||h,x};return a.cache=new(Ua.Cache||Nn),a}Ua.Cache=Nn;function Da(e){if(typeof e!="function")throw new Xt(u);return function(){var t=arguments;switch(t.length){case 0:return!e.call(this);case 1:return!e.call(this,t[0]);case 2:return!e.call(this,t[0],t[1]);case 3:return!e.call(this,t[0],t[1],t[2])}return!e.apply(this,t)}}function hg(e){return ql(2,e)}var gg=tp(function(e,t){t=t.length==1&&Ce(t[0])?nt(t[0],Dt(he())):nt(vt(t,1),Dt(he()));var a=t.length;return Fe(function(l){for(var f=-1,h=yt(l.length,a);++f<h;)l[f]=t[f].call(this,l[f]);return Ut(e,this,l)})}),cs=Fe(function(e,t){var a=Dn(t,Sr(cs));return Cn(e,ne,r,t,a)}),Jl=Fe(function(e,t){var a=Dn(t,Sr(Jl));return Cn(e,pe,r,t,a)}),mg=An(function(e,t){return Cn(e,be,r,r,r,t)});function xg(e,t){if(typeof e!="function")throw new Xt(u);return t=t===r?t:Re(t),Fe(e,t)}function bg(e,t){if(typeof e!="function")throw new Xt(u);return t=t==null?0:gt(Re(t),0),Fe(function(a){var l=a[t],f=Gn(a,0,t);return l&&Un(f,l),Ut(e,this,f)})}function vg(e,t,a){var l=!0,f=!0;if(typeof e!="function")throw new Xt(u);return rt(a)&&(l="leading"in a?!!a.leading:l,f="trailing"in a?!!a.trailing:f),Kl(e,t,{leading:l,maxWait:t,trailing:f})}function yg(e){return Gl(e,1)}function wg(e,t){return cs(Vi(t),e)}function jg(){if(!arguments.length)return[];var e=arguments[0];return Ce(e)?e:[e]}function Sg(e){return Qt(e,K)}function Ng(e,t){return t=typeof t=="function"?t:r,Qt(e,K,t)}function _g(e){return Qt(e,w|K)}function Cg(e,t){return t=typeof t=="function"?t:r,Qt(e,w|K,t)}function Ag(e,t){return t==null||Lo(e,t,xt(t))}function un(e,t){return e===t||e!==e&&t!==t}var Eg=ka(Fi),Tg=ka(function(e,t){return e>=t}),sr=Ho(function(){return arguments}())?Ho:function(e){return it(e)&&Me.call(e,"callee")&&!To.call(e,"callee")},Ce=$.isArray,Rg=co?Dt(co):Uf;function Tt(e){return e!=null&&Ba(e.length)&&!Tn(e)}function st(e){return it(e)&&Tt(e)}function kg(e){return e===!0||e===!1||it(e)&&Nt(e)==Ge}var qn=Gu||ys,$g=uo?Dt(uo):Df;function Pg(e){return it(e)&&e.nodeType===1&&!Yr(e)}function Og(e){if(e==null)return!0;if(Tt(e)&&(Ce(e)||typeof e=="string"||typeof e.splice=="function"||qn(e)||Nr(e)||sr(e)))return!e.length;var t=wt(e);if(t==Ie||t==Je)return!e.size;if(Gr(e))return!Ui(e).length;for(var a in e)if(Me.call(e,a))return!1;return!0}function Fg(e,t){return zr(e,t)}function Ig(e,t,a){a=typeof a=="function"?a:r;var l=a?a(e,t):r;return l===r?zr(e,t,r,a):!!l}function ds(e){if(!it(e))return!1;var t=Nt(e);return t==Ae||t==J||typeof e.message=="string"&&typeof e.name=="string"&&!Yr(e)}function Lg(e){return typeof e=="number"&&ko(e)}function Tn(e){if(!rt(e))return!1;var t=Nt(e);return t==ze||t==Pt||t==$e||t==On}function Xl(e){return typeof e=="number"&&e==Re(e)}function Ba(e){return typeof e=="number"&&e>-1&&e%1==0&&e<=ke}function rt(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}function it(e){return e!=null&&typeof e=="object"}var Zl=fo?Dt(fo):zf;function Ug(e,t){return e===t||Li(e,t,es(t))}function Dg(e,t,a){return a=typeof a=="function"?a:r,Li(e,t,es(t),a)}function Bg(e){return Ql(e)&&e!=+e}function zg(e){if(Np(e))throw new Se(d);return Go(e)}function Wg(e){return e===null}function Hg(e){return e==null}function Ql(e){return typeof e=="number"||it(e)&&Nt(e)==dt}function Yr(e){if(!it(e)||Nt(e)!=ut)return!1;var t=pa(e);if(t===null)return!0;var a=Me.call(t,"constructor")&&t.constructor;return typeof a=="function"&&a instanceof a&&ca.call(a)==Uu}var us=po?Dt(po):Wf;function Gg(e){return Xl(e)&&e>=-ke&&e<=ke}var ec=ho?Dt(ho):Hf;function za(e){return typeof e=="string"||!Ce(e)&&it(e)&&Nt(e)==ft}function zt(e){return typeof e=="symbol"||it(e)&&Nt(e)==mt}var Nr=go?Dt(go):Gf;function qg(e){return e===r}function Yg(e){return it(e)&&wt(e)==Ot}function Vg(e){return it(e)&&Nt(e)==gn}var Mg=ka(Di),Kg=ka(function(e,t){return e<=t});function tc(e){if(!e)return[];if(Tt(e))return za(e)?cn(e):Et(e);if(Pr&&e[Pr])return Cu(e[Pr]());var t=wt(e),a=t==Ie?Ci:t==Je?sa:_r;return a(e)}function Rn(e){if(!e)return e===0?e:0;if(e=nn(e),e===Te||e===-Te){var t=e<0?-1:1;return t*Ne}return e===e?e:0}function Re(e){var t=Rn(e),a=t%1;return t===t?a?t-a:t:0}function nc(e){return e?nr(Re(e),0,le):0}function nn(e){if(typeof e=="number")return e;if(zt(e))return D;if(rt(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=rt(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=wo(e);var a=ln.test(e);return a||di.test(e)?cu(e.slice(2),a?2:8):Lt.test(e)?D:+e}function rc(e){return xn(e,Rt(e))}function Jg(e){return e?nr(Re(e),-ke,ke):e===0?e:0}function Ve(e){return e==null?"":Bt(e)}var Xg=wr(function(e,t){if(Gr(t)||Tt(t)){xn(t,xt(t),e);return}for(var a in t)Me.call(t,a)&&Ur(e,a,t[a])}),ac=wr(function(e,t){xn(t,Rt(t),e)}),Wa=wr(function(e,t,a,l){xn(t,Rt(t),e,l)}),Zg=wr(function(e,t,a,l){xn(t,xt(t),e,l)}),Qg=An($i);function e0(e,t){var a=yr(e);return t==null?a:Io(a,t)}var t0=Fe(function(e,t){e=Xe(e);var a=-1,l=t.length,f=l>2?t[2]:r;for(f&&_t(t[0],t[1],f)&&(l=1);++a<l;)for(var h=t[a],x=Rt(h),S=-1,C=x.length;++S<C;){var B=x[S],z=e[B];(z===r||un(z,xr[B])&&!Me.call(e,B))&&(e[B]=h[B])}return e}),n0=Fe(function(e){return e.push(r,wl),Ut(ic,r,e)});function r0(e,t){return xo(e,he(t,3),mn)}function a0(e,t){return xo(e,he(t,3),Oi)}function i0(e,t){return e==null?e:Pi(e,he(t,3),Rt)}function s0(e,t){return e==null?e:zo(e,he(t,3),Rt)}function o0(e,t){return e&&mn(e,he(t,3))}function l0(e,t){return e&&Oi(e,he(t,3))}function c0(e){return e==null?[]:Sa(e,xt(e))}function d0(e){return e==null?[]:Sa(e,Rt(e))}function fs(e,t,a){var l=e==null?r:rr(e,t);return l===r?a:l}function u0(e,t){return e!=null&&Nl(e,t,Of)}function ps(e,t){return e!=null&&Nl(e,t,Ff)}var f0=ml(function(e,t,a){t!=null&&typeof t.toString!="function"&&(t=da.call(t)),e[t]=a},gs(kt)),p0=ml(function(e,t,a){t!=null&&typeof t.toString!="function"&&(t=da.call(t)),Me.call(e,t)?e[t].push(a):e[t]=[a]},he),h0=Fe(Br);function xt(e){return Tt(e)?Oo(e):Ui(e)}function Rt(e){return Tt(e)?Oo(e,!0):qf(e)}function g0(e,t){var a={};return t=he(t,3),mn(e,function(l,f,h){_n(a,t(l,f,h),l)}),a}function m0(e,t){var a={};return t=he(t,3),mn(e,function(l,f,h){_n(a,f,t(l,f,h))}),a}var x0=wr(function(e,t,a){Na(e,t,a)}),ic=wr(function(e,t,a,l){Na(e,t,a,l)}),b0=An(function(e,t){var a={};if(e==null)return a;var l=!1;t=nt(t,function(h){return h=Hn(h,e),l||(l=h.length>1),h}),xn(e,Zi(e),a),l&&(a=Qt(a,w|I|K,fp));for(var f=t.length;f--;)Gi(a,t[f]);return a});function v0(e,t){return sc(e,Da(he(t)))}var y0=An(function(e,t){return e==null?{}:Vf(e,t)});function sc(e,t){if(e==null)return{};var a=nt(Zi(e),function(l){return[l]});return t=he(t),Xo(e,a,function(l,f){return t(l,f[0])})}function w0(e,t,a){t=Hn(t,e);var l=-1,f=t.length;for(f||(f=1,e=r);++l<f;){var h=e==null?r:e[bn(t[l])];h===r&&(l=f,h=a),e=Tn(h)?h.call(e):h}return e}function j0(e,t,a){return e==null?e:Wr(e,t,a)}function S0(e,t,a,l){return l=typeof l=="function"?l:r,e==null?e:Wr(e,t,a,l)}var oc=vl(xt),lc=vl(Rt);function N0(e,t,a){var l=Ce(e),f=l||qn(e)||Nr(e);if(t=he(t,4),a==null){var h=e&&e.constructor;f?a=l?new h:[]:rt(e)?a=Tn(h)?yr(pa(e)):{}:a={}}return(f?Jt:mn)(e,function(x,S,C){return t(a,x,S,C)}),a}function _0(e,t){return e==null?!0:Gi(e,t)}function C0(e,t,a){return e==null?e:nl(e,t,Vi(a))}function A0(e,t,a,l){return l=typeof l=="function"?l:r,e==null?e:nl(e,t,Vi(a),l)}function _r(e){return e==null?[]:_i(e,xt(e))}function E0(e){return e==null?[]:_i(e,Rt(e))}function T0(e,t,a){return a===r&&(a=t,t=r),a!==r&&(a=nn(a),a=a===a?a:0),t!==r&&(t=nn(t),t=t===t?t:0),nr(nn(e),t,a)}function R0(e,t,a){return t=Rn(t),a===r?(a=t,t=0):a=Rn(a),e=nn(e),If(e,t,a)}function k0(e,t,a){if(a&&typeof a!="boolean"&&_t(e,t,a)&&(t=a=r),a===r&&(typeof t=="boolean"?(a=t,t=r):typeof e=="boolean"&&(a=e,e=r)),e===r&&t===r?(e=0,t=1):(e=Rn(e),t===r?(t=e,e=0):t=Rn(t)),e>t){var l=e;e=t,t=l}if(a||e%1||t%1){var f=$o();return yt(e+f*(t-e+lu("1e-"+((f+"").length-1))),t)}return zi(e,t)}var $0=jr(function(e,t,a){return t=t.toLowerCase(),e+(a?cc(t):t)});function cc(e){return hs(Ve(e).toLowerCase())}function dc(e){return e=Ve(e),e&&e.replace(Pd,wu).replace(Zd,"")}function P0(e,t,a){e=Ve(e),t=Bt(t);var l=e.length;a=a===r?l:nr(Re(a),0,l);var f=a;return a-=t.length,a>=0&&e.slice(a,f)==t}function O0(e){return e=Ve(e),e&&wn.test(e)?e.replace(an,ju):e}function F0(e){return e=Ve(e),e&&Xn.test(e)?e.replace(Mt,"\\$&"):e}var I0=jr(function(e,t,a){return e+(a?"-":"")+t.toLowerCase()}),L0=jr(function(e,t,a){return e+(a?" ":"")+t.toLowerCase()}),U0=pl("toLowerCase");function D0(e,t,a){e=Ve(e),t=Re(t);var l=t?gr(e):0;if(!t||l>=t)return e;var f=(t-l)/2;return Ra(xa(f),a)+e+Ra(ma(f),a)}function B0(e,t,a){e=Ve(e),t=Re(t);var l=t?gr(e):0;return t&&l<t?e+Ra(t-l,a):e}function z0(e,t,a){e=Ve(e),t=Re(t);var l=t?gr(e):0;return t&&l<t?Ra(t-l,a)+e:e}function W0(e,t,a){return a||t==null?t=0:t&&(t=+t),Mu(Ve(e).replace(jn,""),t||0)}function H0(e,t,a){return(a?_t(e,t,a):t===r)?t=1:t=Re(t),Wi(Ve(e),t)}function G0(){var e=arguments,t=Ve(e[0]);return e.length<3?t:t.replace(e[1],e[2])}var q0=jr(function(e,t,a){return e+(a?"_":"")+t.toLowerCase()});function Y0(e,t,a){return a&&typeof a!="number"&&_t(e,t,a)&&(t=a=r),a=a===r?le:a>>>0,a?(e=Ve(e),e&&(typeof t=="string"||t!=null&&!us(t))&&(t=Bt(t),!t&&hr(e))?Gn(cn(e),0,a):e.split(t,a)):[]}var V0=jr(function(e,t,a){return e+(a?" ":"")+hs(t)});function M0(e,t,a){return e=Ve(e),a=a==null?0:nr(Re(a),0,e.length),t=Bt(t),e.slice(a,a+t.length)==t}function K0(e,t,a){var l=p.templateSettings;a&&_t(e,t,a)&&(t=r),e=Ve(e),t=Wa({},t,l,yl);var f=Wa({},t.imports,l.imports,yl),h=xt(f),x=_i(f,h),S,C,B=0,z=t.interpolate||ta,W="__p += '",te=Ai((t.escape||ta).source+"|"+z.source+"|"+(z===In?qe:ta).source+"|"+(t.evaluate||ta).source+"|$","g"),de="//# sourceURL="+(Me.call(t,"sourceURL")?(t.sourceURL+"").replace(/\s/g," "):"lodash.templateSources["+ ++ru+"]")+`
`;e.replace(te,function(xe,Le,De,Wt,Ct,Ht){return De||(De=Wt),W+=e.slice(B,Ht).replace(Od,Su),Le&&(S=!0,W+=`' +
__e(`+Le+`) +
'`),Ct&&(C=!0,W+=`';
`+Ct+`;
__p += '`),De&&(W+=`' +
...
`:`;
`)+W+`return __p
}`;var Pe=fc(function(){return Ye(h,de+"return "+W).apply(r,x)});if(Pe.source=W,ds(Pe))throw Pe;return Pe}function J0(e){return Ve(e).toLowerCase()}function X0(e){return Ve(e).toUpperCase()}function Z0(e,t,a){if(e=Ve(e),e&&(a||t===r))return wo(e);if(!e||!(t=Bt(t)))return e;var l=cn(e),f=cn(t),h=jo(l,f),x=So(l,f)+1;return Gn(l,h,x).join("")}function Q0(e,t,a){if(e=Ve(e),e&&(a||t===r))return e.slice(0,_o(e)+1);if(!e||!(t=Bt(t)))return e;var l=cn(e),f=So(l,cn(t))+1;return Gn(l,0,f).join("")}function em(e,t,a){if(e=Ve(e),e&&(a||t===r))return e.replace(jn,"");if(!e||!(t=Bt(t)))return e;var l=cn(e),f=jo(l,cn(t));return Gn(l,f).join("")}function tm(e,t){var a=Oe,l=E;if(rt(t)){var f="separator"in t?t.separator:f;a="length"in t?Re(t.length):a,l="omission"in t?Bt(t.omission):l}e=Ve(e);var h=e.length;if(hr(e)){var x=cn(e);h=x.length}if(a>=h)return e;var S=a-gr(l);if(S<1)return l;var C=x?Gn(x,0,S).join(""):e.slice(0,S);if(f===r)return C+l;if(x&&(S+=C.length-S),us(f)){if(e.slice(S).search(f)){var B,z=C;for(f.global||(f=Ai(f.source,Ve(_.exec(f))+"g")),f.lastIndex=0;B=f.exec(z);)var W=B.index;C=C.slice(0,W===r?S:W)}}else if(e.indexOf(Bt(f),S)!=S){var te=C.lastIndexOf(f);te>-1&&(C=C.slice(0,te))}return C+l}function nm(e){return e=Ve(e),e&&Yt.test(e)?e.replace(St,Ru):e}var rm=jr(function(e,t,a){return e+(a?" ":"")+t.toUpperCase()}),hs=pl("toUpperCase");function uc(e,t,a){return e=Ve(e),t=a?r:t,t===r?_u(e)?Pu(e):mu(e):e.match(t)||[]}var fc=Fe(function(e,t){try{return Ut(e,r,t)}catch(a){return ds(a)?a:new Se(a)}}),am=An(function(e,t){return Jt(t,function(a){a=bn(a),_n(e,a,ls(e[a],e))}),e});function im(e){var t=e==null?0:e.length,a=he();return e=t?nt(e,function(l){if(typeof l[1]!="function")throw new Xt(u);return[a(l[0]),l[1]]}):[],Fe(function(l){for(var f=-1;++f<t;){var h=e[f];if(Ut(h[0],this,l))return Ut(h[1],this,l)}})}function sm(e){return kf(Qt(e,w))}function gs(e){return function(){return e}}function om(e,t){return e==null||e!==e?t:e}var lm=gl(),cm=gl(!0);function kt(e){return e}function ms(e){return qo(typeof e=="function"?e:Qt(e,w))}function dm(e){return Vo(Qt(e,w))}function um(e,t){return Mo(e,Qt(t,w))}var fm=Fe(function(e,t){return function(a){return Br(a,e,t)}}),pm=Fe(function(e,t){return function(a){return Br(e,a,t)}});function xs(e,t,a){var l=xt(t),f=Sa(t,l);a==null&&!(rt(t)&&(f.length||!l.length))&&(a=t,t=e,e=this,f=Sa(t,xt(t)));var h=!(rt(a)&&"chain"in a)||!!a.chain,x=Tn(e);return Jt(f,function(S){var C=t[S];e[S]=C,x&&(e.prototype[S]=function(){var B=this.__chain__;if(h||B){var z=e(this.__wrapped__),W=z.__actions__=Et(this.__actions__);return W.push({func:C,args:arguments,thisArg:e}),z.__chain__=B,z}return C.apply(e,Un([this.value()],arguments))})}),e}function hm(){return bt._===this&&(bt._=Du),this}function bs(){}function gm(e){return e=Re(e),Fe(function(t){return Ko(t,e)})}var mm=Ki(nt),xm=Ki(mo),bm=Ki(yi);function pc(e){return ns(e)?wi(bn(e)):Mf(e)}function vm(e){return function(t){return e==null?r:rr(e,t)}}var ym=xl(),wm=xl(!0);function vs(){return[]}function ys(){return!1}function jm(){return{}}function Sm(){return""}function Nm(){return!0}function _m(e,t){if(e=Re(e),e<1||e>ke)return[];var a=le,l=yt(e,le);t=he(t),e-=le;for(var f=Ni(l,t);++a<e;)t(a);return f}function Cm(e){return Ce(e)?nt(e,bn):zt(e)?[e]:Et(Pl(Ve(e)))}function Am(e){var t=++Lu;return Ve(e)+t}var Em=Ta(function(e,t){return e+t},0),Tm=Ji("ceil"),Rm=Ta(function(e,t){return e/t},1),km=Ji("floor");function $m(e){return e&&e.length?ja(e,kt,Fi):r}function Pm(e,t){return e&&e.length?ja(e,he(t,2),Fi):r}function Om(e){return vo(e,kt)}function Fm(e,t){return vo(e,he(t,2))}function Im(e){return e&&e.length?ja(e,kt,Di):r}function Lm(e,t){return e&&e.length?ja(e,he(t,2),Di):r}var Um=Ta(function(e,t){return e*t},1),Dm=Ji("round"),Bm=Ta(function(e,t){return e-t},0);function zm(e){return e&&e.length?Si(e,kt):0}function Wm(e,t){return e&&e.length?Si(e,he(t,2)):0}return p.after=dg,p.ary=Gl,p.assign=Xg,p.assignIn=ac,p.assignInWith=Wa,p.assignWith=Zg,p.at=Qg,p.before=ql,p.bind=ls,p.bindAll=am,p.bindKey=Yl,p.castArray=jg,p.chain=zl,p.chunk=kp,p.compact=$p,p.concat=Pp,p.cond=im,p.conforms=sm,p.constant=gs,p.countBy=zh,p.create=e0,p.curry=Vl,p.curryRight=Ml,p.debounce=Kl,p.defaults=t0,p.defaultsDeep=n0,p.defer=ug,p.delay=fg,p.difference=Op,p.differenceBy=Fp,p.differenceWith=Ip,p.drop=Lp,p.dropRight=Up,p.dropRightWhile=Dp,p.dropWhile=Bp,p.fill=zp,p.filter=Hh,p.flatMap=Yh,p.flatMapDeep=Vh,p.flatMapDepth=Mh,p.flatten=Ll,p.flattenDeep=Wp,p.flattenDepth=Hp,p.flip=pg,p.flow=lm,p.flowRight=cm,p.fromPairs=Gp,p.functions=c0,p.functionsIn=d0,p.groupBy=Kh,p.initial=Yp,p.intersection=Vp,p.intersectionBy=Mp,p.intersectionWith=Kp,p.invert=f0,p.invertBy=p0,p.invokeMap=Xh,p.iteratee=ms,p.keyBy=Zh,p.keys=xt,p.keysIn=Rt,p.map=Ia,p.mapKeys=g0,p.mapValues=m0,p.matches=dm,p.matchesProperty=um,p.memoize=Ua,p.merge=x0,p.mergeWith=ic,p.method=fm,p.methodOf=pm,p.mixin=xs,p.negate=Da,p.nthArg=gm,p.omit=b0,p.omitBy=v0,p.once=hg,p.orderBy=Qh,p.over=mm,p.overArgs=gg,p.overEvery=xm,p.overSome=bm,p.partial=cs,p.partialRight=Jl,p.partition=eg,p.pick=y0,p.pickBy=sc,p.property=pc,p.propertyOf=vm,p.pull=Qp,p.pullAll=Dl,p.pullAllBy=eh,p.pullAllWith=th,p.pullAt=nh,p.range=ym,p.rangeRight=wm,p.rearg=mg,p.reject=rg,p.remove=rh,p.rest=xg,p.reverse=ss,p.sampleSize=ig,p.set=j0,p.setWith=S0,p.shuffle=sg,p.slice=ah,p.sortBy=cg,p.sortedUniq=uh,p.sortedUniqBy=fh,p.split=Y0,p.spread=bg,p.tail=ph,p.take=hh,p.takeRight=gh,p.takeRightWhile=mh,p.takeWhile=xh,p.tap=$h,p.throttle=vg,p.thru=Fa,p.toArray=tc,p.toPairs=oc,p.toPairsIn=lc,p.toPath=Cm,p.toPlainObject=rc,p.transform=N0,p.unary=yg,p.union=bh,p.unionBy=vh,p.unionWith=yh,p.uniq=wh,p.uniqBy=jh,p.uniqWith=Sh,p.unset=_0,p.unzip=os,p.unzipWith=Bl,p.update=C0,p.updateWith=A0,p.values=_r,p.valuesIn=E0,p.without=Nh,p.words=uc,p.wrap=wg,p.xor=_h,p.xorBy=Ch,p.xorWith=Ah,p.zip=Eh,p.zipObject=Th,p.zipObjectDeep=Rh,p.zipWith=kh,p.entries=oc,p.entriesIn=lc,p.extend=ac,p.extendWith=Wa,xs(p,p),p.add=Em,p.attempt=fc,p.camelCase=$0,p.capitalize=cc,p.ceil=Tm,p.clamp=T0,p.clone=Sg,p.cloneDeep=_g,p.cloneDeepWith=Cg,p.cloneWith=Ng,p.conformsTo=Ag,p.deburr=dc,p.defaultTo=om,p.divide=Rm,p.endsWith=P0,p.eq=un,p.escape=O0,p.escapeRegExp=F0,p.every=Wh,p.find=Gh,p.findIndex=Fl,p.findKey=r0,p.findLast=qh,p.findLastIndex=Il,p.findLastKey=a0,p.floor=km,p.forEach=Wl,p.forEachRight=Hl,p.forIn=i0,p.forInRight=s0,p.forOwn=o0,p.forOwnRight=l0,p.get=fs,p.gt=Eg,p.gte=Tg,p.has=u0,p.hasIn=ps,p.head=Ul,p.identity=kt,p.includes=Jh,p.indexOf=qp,p.inRange=R0,p.invoke=h0,p.isArguments=sr,p.isArray=Ce,p.isArrayBuffer=Rg,p.isArrayLike=Tt,p.isArrayLikeObject=st,p.isBoolean=kg,p.isBuffer=qn,p.isDate=$g,p.isElement=Pg,p.isEmpty=Og,p.isEqual=Fg,p.isEqualWith=Ig,p.isError=ds,p.isFinite=Lg,p.isFunction=Tn,p.isInteger=Xl,p.isLength=Ba,p.isMap=Zl,p.isMatch=Ug,p.isMatchWith=Dg,p.isNaN=Bg,p.isNative=zg,p.isNil=Hg,p.isNull=Wg,p.isNumber=Ql,p.isObject=rt,p.isObjectLike=it,p.isPlainObject=Yr,p.isRegExp=us,p.isSafeInteger=Gg,p.isSet=ec,p.isString=za,p.isSymbol=zt,p.isTypedArray=Nr,p.isUndefined=qg,p.isWeakMap=Yg,p.isWeakSet=Vg,p.join=Jp,p.kebabCase=I0,p.last=tn,p.lastIndexOf=Xp,p.lowerCase=L0,p.lowerFirst=U0,p.lt=Mg,p.lte=Kg,p.max=$m,p.maxBy=Pm,p.mean=Om,p.meanBy=Fm,p.min=Im,p.minBy=Lm,p.stubArray=vs,p.stubFalse=ys,p.stubObject=jm,p.stubString=Sm,p.stubTrue=Nm,p.multiply=Um,p.nth=Zp,p.noConflict=hm,p.noop=bs,p.now=La,p.pad=D0,p.padEnd=B0,p.padStart=z0,p.parseInt=W0,p.random=k0,p.reduce=tg,p.reduceRight=ng,p.repeat=H0,p.replace=G0,p.result=w0,p.round=Dm,p.runInContext=N,p.sample=ag,p.size=og,p.snakeCase=q0,p.some=lg,p.sortedIndex=ih,p.sortedIndexBy=sh,p.sortedIndexOf=oh,p.sortedLastIndex=lh,p.sortedLastIndexBy=ch,p.sortedLastIndexOf=dh,p.startCase=V0,p.startsWith=M0,p.subtract=Bm,p.sum=zm,p.sumBy=Wm,p.template=K0,p.times=_m,p.toFinite=Rn,p.toInteger=Re,p.toLength=nc,p.toLower=J0,p.toNumber=nn,p.toSafeInteger=Jg,p.toString=Ve,p.toUpper=X0,p.trim=Z0,p.trimEnd=Q0,p.trimStart=em,p.truncate=tm,p.unescape=nm,p.uniqueId=Am,p.upperCase=rm,p.upperFirst=hs,p.each=Wl,p.eachRight=Hl,p.first=Ul,xs(p,function(){var e={};return mn(p,function(t,a){Me.call(p.prototype,a)||(e[a]=t)}),e}(),{chain:!1}),p.VERSION=o,Jt(["bind","bindKey","curry","curryRight","partial","partialRight"],function(e){p[e].placeholder=p}),Jt(["drop","take"],function(e,t){Ue.prototype[e]=function(a){a=a===r?1:gt(Re(a),0);var l=this.__filtered__&&!t?new Ue(this):this.clone();return l.__filtered__?l.__takeCount__=yt(a,l.__takeCount__):l.__views__.push({size:yt(a,le),type:e+(l.__dir__<0?"Right":"")}),l},Ue.prototype[e+"Right"]=function(a){return this.reverse()[e](a).reverse()}}),Jt(["filter","map","takeWhile"],function(e,t){var a=t+1,l=a==P||a==oe;Ue.prototype[e]=function(f){var h=this.clone();return h.__iteratees__.push({iteratee:he(f,3),type:a}),h.__filtered__=h.__filtered__||l,h}}),Jt(["head","last"],function(e,t){var a="take"+(t?"Right":"");Ue.prototype[e]=function(){return this[a](1).value()[0]}}),Jt(["initial","tail"],function(e,t){var a="drop"+(t?"":"Right");Ue.prototype[e]=function(){return this.__filtered__?new Ue(this):this[a](1)}}),Ue.prototype.compact=function(){return this.filter(kt)},Ue.prototype.find=function(e){return this.filter(e).head()},Ue.prototype.findLast=function(e){return this.reverse().find(e)},Ue.prototype.invokeMap=Fe(function(e,t){return typeof e=="function"?new Ue(this):this.map(function(a){return Br(a,e,t)})}),Ue.prototype.reject=function(e){return this.filter(Da(he(e)))},Ue.prototype.slice=function(e,t){e=Re(e);var a=this;return a.__filtered__&&(e>0||t<0)?new Ue(a):(e<0?a=a.takeRight(-e):e&&(a=a.drop(e)),t!==r&&(t=Re(t),a=t<0?a.dropRight(-t):a.take(t-e)),a)},Ue.prototype.takeRightWhile=function(e){return this.reverse().takeWhile(e).reverse()},Ue.prototype.toArray=function(){return this.take(le)},mn(Ue.prototype,function(e,t){var a=/^(?:filter|find|map|reject)|While$/.test(t),l=/^(?:head|last)$/.test(t),f=p[l?"take"+(t=="last"?"Right":""):t],h=l||/^find/.test(t);f&&(p.prototype[t]=function(){var x=this.__wrapped__,S=l?[1]:arguments,C=x instanceof Ue,B=S[0],z=C||Ce(x),W=function(Le){var De=f.apply(p,Un([Le],S));return l&&te?De[0]:De};z&&a&&typeof B=="function"&&B.length!=1&&(C=z=!1);var te=this.__chain__,de=!!this.__actions__.length,me=h&&!te,Pe=C&&!de;if(!h&&z){x=Pe?x:new Ue(this);var xe=e.apply(x,S);return xe.__actions__.push({func:Fa,args:[W],thisArg:r}),new Zt(xe,te)}return me&&Pe?e.apply(this,S):(xe=this.thru(W),me?l?xe.value()[0]:xe.value():xe)})}),Jt(["pop","push","shift","sort","splice","unshift"],function(e){var t=oa[e],a=/^(?:push|sort|unshift)$/.test(e)?"tap":"thru",l=/^(?:pop|shift)$/.test(e);p.prototype[e]=function(){var f=arguments;if(l&&!this.__chain__){var h=this.value();return t.apply(Ce(h)?h:[],f)}return this[a](function(x){return t.apply(Ce(x)?x:[],f)})}}),mn(Ue.prototype,function(e,t){var a=p[t];if(a){var l=a.name+"";Me.call(vr,l)||(vr[l]=[]),vr[l].push({name:t,func:a})}}),vr[Ea(r,q).name]=[{name:"wrapper",func:r}],Ue.prototype.clone=tf,Ue.prototype.reverse=nf,Ue.prototype.value=rf,p.prototype.at=Ph,p.prototype.chain=Oh,p.prototype.commit=Fh,p.prototype.next=Ih,p.prototype.plant=Uh,p.prototype.reverse=Dh,p.prototype.toJSON=p.prototype.valueOf=p.prototype.value=Bh,p.prototype.first=p.prototype.head,Pr&&(p.prototype[Pr]=Lh),p},mr=Ou();Zn?((Zn.exports=mr)._=mr,mi._=mr):bt._=mr}).call(M1)}(Kr,Kr.exports)),Kr.exports}var J1=K1();const X1="/x-pense-app/assets/bitcoin-DEGqceNT.png",Z1="/x-pense-app/assets/ethereum-CuEFbPJh.png",Q1="/x-pense-app/assets/usdc-LEAjTsRZ.png",ev=({darkMode:s,investments:i,setInvestments:r,amounts:o,setAmounts:c,marketCaps:d,setMarketCaps:u,formatCurrency:m,addedInvestments:g,setAddedInvestments:j})=>{const v=ur(),[w,I]=y.useState(!1),[K,T]=y.useState(""),[k,A]=y.useState({}),[q,V]=y.useState({}),[R,M]=y.useState(!1);y.useEffect(()=>{(async()=>{var Z,oe,Te,ke,Ne,D;try{I(!0);const le=await ge.get("https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd"),fe=await ge.get("https://api.coinbase.com/v2/prices/ETH-USD/spot"),G=await ge.get("https://api.coinbase.com/v2/prices/USDC-USD/spot"),re=((oe=(Z=le.data)==null?void 0:Z.bitcoin)==null?void 0:oe.usd)||0,ie=parseFloat((ke=(Te=fe.data)==null?void 0:Te.data)==null?void 0:ke.amount)||0,ue=parseFloat((D=(Ne=G.data)==null?void 0:Ne.data)==null?void 0:D.amount)||1,$e=i.reduce((J,Ae)=>(J[Ae.id]=Ae.pricePerUnit,J),{}),Ge=[{id:"bitcoin",name:"Bitcoin",type:"Cryptocurrency",pricePerUnit:re},{id:"ethereum",name:"Ethereum",type:"Cryptocurrency",pricePerUnit:ie},{id:"usd-coin",name:"USDC",type:"Stablecoin",pricePerUnit:ue}],ee={};Ge.forEach(J=>{const Ae=$e[J.id];Ae&&Ae!==J.pricePerUnit&&(ee[J.id]=J.pricePerUnit>Ae?"up":"down")}),A(ee),r(Ge),c(Ge.map(()=>0)),setTimeout(()=>A({}),3e3)}catch(le){console.error("Error fetching investments",le),T("❌ Failed to fetch live prices. Please try again."),setTimeout(()=>T(""),3e3)}finally{I(!1)}})()},[r,c]),y.useEffect(()=>{const P=async()=>{try{const Z=i.map(Te=>Te.id).join(","),oe=await ge.get("http://localhost:5001/api/coins/markets",{params:{ids:Z}});if(console.log("INVESTMENTS COMPONENTS"),console.log("Market cap response:",oe.data),Array.isArray(oe.data)){const Te=oe.data.reduce((ke,Ne)=>(ke[Ne.id]=Ne.market_cap,ke),{});console.log("Market cap data:",Te),u(Te)}else console.error("Expected an array but got:",oe.data)}catch(Z){console.error("Error fetching market cap data:",Z)}};i.length>0&&P()},[i]);const ne=J1.debounce((P,Z)=>{const oe=[...o],Te=parseFloat(Z);isNaN(Te)||(oe[P]=Te,c(oe))},300),pe=(P,Z)=>(P*Z).toFixed(2),we=async P=>{const Z=i[P],oe=o[P];if(!oe||oe<=0){T("⚠️ Please enter a valid amount greater than 0"),setTimeout(()=>T(""),3e3);return}I(!0);const Te=pe(oe,Z.pricePerUnit),ke={...Z,amount:oe,totalPrice:Te};try{const Ne=g.findIndex(le=>le.name===ke.name);if(Ne!==-1){const le=g[Ne],fe=le.amount+oe,G=pe(fe,Z.pricePerUnit),re=await ge.put(`http://localhost:5001/investments/${le.id}`,{amount:fe,totalPrice:G},{headers:{"Content-Type":"application/json"}}),ie=[...g];ie[Ne]={...le,amount:fe,totalPrice:G},j(ie),T(`💰 Updated ${Z.name} investment successfully!`)}else{const le=await ge.post("http://localhost:5001/investments",ke,{headers:{"Content-Type":"application/json"}});j([...g,ke]),T(`🚀 Added ${Z.name} investment successfully!`)}V({...q,[P]:!0}),setTimeout(()=>{V({...q,[P]:!1})},1e3);const D=[...o];D[P]=0,c(D),setTimeout(()=>T(""),3e3),setTimeout(()=>v("/dashboard"),2e3)}catch(Ne){console.error("Error adding/updating investment:",Ne),T("❌ Failed to add investment. Please try again."),setTimeout(()=>T(""),3e3)}finally{I(!1)}},be=P=>{var oe;const Z=[...o];Z[P]=0,c(Z),T(`🔄 Reset ${(oe=i[P])==null?void 0:oe.name} amount`),setTimeout(()=>T(""),2e3)},ve=async()=>{var P,Z,oe,Te,ke,Ne;M(!0);try{const D=await ge.get("https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd"),le=await ge.get("https://api.coinbase.com/v2/prices/ETH-USD/spot"),fe=await ge.get("https://api.coinbase.com/v2/prices/USDC-USD/spot"),G=((Z=(P=D.data)==null?void 0:P.bitcoin)==null?void 0:Z.usd)||0,re=parseFloat((Te=(oe=le.data)==null?void 0:oe.data)==null?void 0:Te.amount)||0,ie=parseFloat((Ne=(ke=fe.data)==null?void 0:ke.data)==null?void 0:Ne.amount)||1;r([{id:"bitcoin",name:"Bitcoin",type:"Cryptocurrency",pricePerUnit:G},{id:"ethereum",name:"Ethereum",type:"Cryptocurrency",pricePerUnit:re},{id:"usd-coin",name:"USDC",type:"Stablecoin",pricePerUnit:ie}]),T("🔄 Prices refreshed successfully!"),setTimeout(()=>T(""),3e3)}catch(D){console.error("Error refreshing prices:",D),T("❌ Failed to refresh prices. Please try again."),setTimeout(()=>T(""),3e3)}finally{M(!1)}},Oe=P=>{if(!P)return null;switch(P.toLowerCase()){case"bitcoin":return n.jsx("img",{src:X1,alt:"Bitcoin",className:"crypto-icon",style:{width:"24px",height:"24px"}});case"ethereum":return n.jsx("img",{src:Z1,alt:"Ethereum",className:"crypto-icon",style:{width:"24px",height:"24px"}});case"usdc":return n.jsx("img",{src:Q1,alt:"USDC",className:"crypto-icon",style:{width:"24px",height:"24px"}});default:return n.jsx("div",{className:"crypto-placeholder",children:"💰"})}},E=P=>P>=1e12?`${(P/1e12).toFixed(2)} Trillion`:P>=1e9?`${(P/1e9).toFixed(2)} Billion`:P.toLocaleString(),Q=P=>{const Z=k[P];return Z==="up"?"📈":Z==="down"?"📉":""},se=P=>{const Z=k[P];return Z==="up"?"price-up":Z==="down"?"price-down":""};return n.jsxs("div",{className:"investments-container",children:[n.jsx("style",{jsx:!0,children:`
            ...
            `}),n.jsxs("div",{className:"investments-header",children:[n.jsx("h5",{children:"🚀 Crypto Investments"}),n.jsx("p",{className:"investments-subtitle",children:"Invest in the future with real-time market data"})]}),K&&n.jsx("div",{className:"success-message",children:K}),n.jsxs("div",{className:"control-section",children:[n.jsxs("div",{className:"live-indicator",children:[n.jsx("span",{className:"live-badge",children:"Live"}),n.jsx("span",{children:"📊 Make Informed Decisions With Live Crypto Updates"})]}),n.jsxs("button",{className:"refresh-button",onClick:ve,disabled:R,children:[R?n.jsx("span",{className:"loading-spinner"}):"🔄",R?"Refreshing...":"Refresh Prices"]})]}),n.jsx("div",{className:"table-container",children:w&&i.length===0?n.jsxs("div",{className:"loading-container",children:[n.jsx("div",{className:"large-spinner"}),n.jsx("p",{children:"Loading investment data..."})]}):n.jsxs(n.Fragment,{children:[w&&n.jsx("div",{className:"loading-overlay",children:n.jsx("div",{className:"large-spinner"})}),n.jsxs("table",{className:"enhanced-table",children:[n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{children:"Name"}),n.jsx("th",{children:"Symbol"}),n.jsx("th",{children:"Type"}),n.jsx("th",{children:"Price"}),n.jsx("th",{children:"Market Cap"}),n.jsx("th",{children:"Amount"}),n.jsx("th",{children:"Actions"})]})}),n.jsx("tbody",{children:i.map((P,Z)=>n.jsxs("tr",{className:`table-row ${q[Z]?"animate":""}`,children:[n.jsxs("td",{className:"crypto-name-cell",children:[Oe(P.name),n.jsx("span",{children:P.name})]}),n.jsx("td",{children:n.jsx("span",{style:{fontWeight:"600",textTransform:"uppercase",fontSize:"0.9rem"},children:P.id==="bitcoin"?"BTC":P.id==="ethereum"?"ETH":P.id==="usd-coin"?"USDC":P.name.substring(0,3).toUpperCase()})}),n.jsx("td",{children:n.jsx("span",{className:`type-badge ${P.type==="Cryptocurrency"?"type-crypto":"type-stablecoin"}`,children:P.type==="Cryptocurrency"?"Crypto":"Stable"})}),n.jsxs("td",{className:`price-cell ${se(P.id)}`,children:[n.jsx("span",{children:m(P.pricePerUnit)}),n.jsx("span",{children:Q(P.id)})]}),n.jsx("td",{className:"market-cap-cell",children:d[P.id]?`$${E(d[P.id])}`:n.jsx("span",{style:{opacity:.7},children:"Loading..."})}),n.jsx("td",{children:n.jsx("input",{type:"number",className:"amount-input",value:o[Z]||"",placeholder:"0.00",name:`investment-amount-${Z}`,onChange:oe=>ne(Z,oe.target.value),step:"0.01",min:"0"})}),n.jsx("td",{children:n.jsxs("div",{className:"action-buttons",children:[n.jsxs("button",{className:"btn-modern btn-add",onClick:()=>we(Z),disabled:w||!o[Z]||o[Z]<=0,children:[w?n.jsx("span",{className:"loading-spinner"}):"💰","Add"]}),n.jsx("button",{className:"btn-modern btn-reset",onClick:()=>be(Z),disabled:w,children:"🔄 Reset"})]})})]},P.id))})]})]})})]})},tv="/x-pense-app/assets/intro_01-CLbcXq8c.mp3";function kd(){return n.jsx("footer",{className:"text-center my-5 footer fade-in",children:n.jsxs("p",{children:["©",new Date().getFullYear()," MarlonShade. All rights reserved."]})})}const nv=()=>{const s=ur(),i=()=>{const r=new Audio(tv);r.volume=.1,r.play().catch(o=>{console.error("Error playing audio",o)}),s("/dashboard")};return n.jsx("div",{className:"intro-margin",children:n.jsx("div",{className:"start-page-container",children:n.jsxs("div",{className:"start-page-content",children:[n.jsx("h1",{className:"intro metallic-shadow fade-in",children:"X-PENSE".split("").map((r,o)=>n.jsx("span",{className:`char char-${o}`,children:r},o))}),n.jsx("p",{className:"subtitle fade-in ",children:"Your Friendly Budget Tracker"}),n.jsx("button",{onClick:i,className:"btn-enhanced fade-in",children:"Get Started"}),n.jsx(kd,{})]})})})},rv=({darkMode:s})=>{const[i,r]=y.useState(""),[o,c]=y.useState(null),[d,u]=y.useState(lr.getStats()),m=()=>{if(i.trim()){const j=lr.categorizeTransaction(i);c(j)}},g=["STARBUCKS #1234 NEW YORK","SHELL GAS STATION #567","AMAZON.COM PURCHASE","WALMART SUPERCENTER #890","NETFLIX MONTHLY","ELECTRIC COMPANY BILL","CVS PHARMACY #123"];return n.jsxs("div",{className:"ai-demo-container",children:[n.jsx("style",{jsx:!0,children:`
        .ai-demo-container {
          max-width: 800px;
          margin: 20px auto;
          padding: 20px;
